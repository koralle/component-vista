...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/server-functions"
...
[## What are Server Functions?](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#what-are-server-functions)
...
[## Basic Usage](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#basic-usage)
...
[## Where to Call Server Functions](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#where-to-call-server-functions)
...
[## Parameters & Validation](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#parameters--validation)
...
[### Basic Parameters](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#basic-parameters)
...
[### Validation with Zod](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#validation-with-zod)
...
[### Form Data](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#form-data)
...
[## Error Handling & Redirects](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#error-handling--redirects)
...
[### Basic Errors](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#basic-errors)
...
[### Redirects](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#redirects)
...
[### Not Found](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#not-found)
...
[## Advanced Topics](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#advanced-topics)

For more advanced server function patterns and features, see these dedicated guides:

[### Server Context & Request Handling](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#server-context--request-handling)
...
[### Streaming](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#streaming)

Stream typed data from server functions to the client. See the [Streaming Data from Server Functions guide](https://tanstack.com/start/latest/docs/framework/react/guide/streaming-data-from-server-functions.html).

[### Raw Responses](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#raw-responses)

Return Response objects binary data, or custom content types.

[### Progressive Enhancement](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#progressive-enhancement)

Use server functions without JavaScript by leveraging the .url property with HTML forms.

[### Middleware](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#middleware)

Compose server functions with middleware for authentication, logging, and shared logic. See the [Middleware guide](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html).

[### Static Server Functions](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#static-server-functions)

Cache server function results at build time for static generation. See [Static Server Functions](https://tanstack.com/start/latest/docs/framework/react/guide/static-server-functions.html).

[### Request Cancellation](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#request-cancellation)

Handle request cancellation with AbortSignal for long-running operations.

[### Function ID generation for production build](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#function-id-generation-for-production-build)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/server-functions.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Environment Variables](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html)

[Static Server Functions](https://tanstack.com/start/latest/docs/framework/react/guide/static-server-functions.html)
