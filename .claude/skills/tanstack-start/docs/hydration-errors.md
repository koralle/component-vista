...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/hydration-errors"
...
[### Why it happens](https://tanstack.com/start/latest/docs/framework/react/guide/hydration-errors.html#why-it-happens)
...
[### Strategy 1 — Make server and client match](https://tanstack.com/start/latest/docs/framework/react/guide/hydration-errors.html#strategy-1--make-server-and-client-match)
...
[### Strategy 2 — Let the client tell you its environment](https://tanstack.com/start/latest/docs/framework/react/guide/hydration-errors.html#strategy-2--let-the-client-tell-you-its-environment)
...
[### Strategy 3 — Make it client-only](https://tanstack.com/start/latest/docs/framework/react/guide/hydration-errors.html#strategy-3--make-it-client-only)
...
[### Strategy 4 — Disable or limit SSR for the route](https://tanstack.com/start/latest/docs/framework/react/guide/hydration-errors.html#strategy-4--disable-or-limit-ssr-for-the-route)
...
[### Strategy 5 — Last resort suppression](https://tanstack.com/start/latest/docs/framework/react/guide/hydration-errors.html#strategy-5--last-resort-suppression)
...
[### Checklist](https://tanstack.com/start/latest/docs/framework/react/guide/hydration-errors.html#checklist)
...
See also: [Execution Model](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html), [Code Execution Patterns](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html), [Selective SSR](https://tanstack.com/start/latest/docs/framework/react/guide/selective-ssr.html), [Server Functions](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html)

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/hydration-errors.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Server Routes](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html)
