---
title: "Calling an external API using TanStack Start | TanStack Start React Docs"
source_url: "https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api"
...
[## What You'll Learn](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html#what-youll-learn)
...
[## Prerequisites](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html#prerequisites)

* Basic knowledge of React and TypeScript
* Node.js (v18+) and pnpm installed on your machine
* A TMDB API key (free at [themoviedb.org](https://www.themoviedb.org))

[## Nice to know](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html#nice-to-know)

* [TanStack Router](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts)

[## Setting up a TanStack Start Project](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html#setting-up-a-tanstack-start-project)
...
[## Understanding the Project Structure](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html#understanding-the-project-structure)
...
[## Step 1: Setup a .env file with TMDB\_AUTH\_TOKEN](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html#step-1-setup-a-env-file-with-tmdb_auth_token)
...
[## Step 2: Defining Data Types](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html#step-2-defining-data-types)
...
[## Step 3: Creating the Route with API Fetch Function](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html#step-3-creating-the-route-with-api-fetch-function)
...
* createServerFn() creates a server-only function that runs exclusively on the server, ensuring our TMDB\_AUTH\_TOKEN environment variable never gets exposed to the client. The server function makes an authenticated request to the TMDB API and returns the parsed JSON response.
...
[## Step 4: Building the Movie Components](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html#step-4-building-the-movie-components)
...
[## Step 5: Creating the MoviesPage Component](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html#step-5-creating-the-moviespage-component)
...
[### Understanding How It All Works Together](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html#understanding-how-it-all-works-together)
...
[## Step 6: Testing Your Application](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html#step-6-testing-your-application)
...
[## Conclusion](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html#conclusion)
