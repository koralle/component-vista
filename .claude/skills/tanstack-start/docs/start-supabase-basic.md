---
title: "Solid TanStack Start Start Supabase Basic Example | TanStack Start Docs"
source_url: "https://tanstack.com/start/latest/docs/framework/solid/examples/start-supabase-basic"
...
# Solid Example: Start Supabase Basic [Deploy to Cloudflare](https://deploy.workers.cloudflare.com/?url=https://github.com/tanstack/router/tree/main/examples/solid/start-supabase-basic)[Deploy with Netlify](https://app.netlify.com/start/deploy?repository=https://github.com/tanstack/router&create_from_path=examples/solid/start-supabase-basic) [Github](https://github.com/tanstack/router/tree/main/examples/solid/start-supabase-basic) [CodeSandbox](https://codesandbox.io/p/devbox/github/tanstack/router/tree/main/examples/solid/start-supabase-basic?embed=1&theme=dark&file=src/routes/__root.tsx)
...
[Basic + Convex + Better Auth](https://tanstack.com/start/latest/docs/framework/solid/examples/start-convex-better-auth.html)
