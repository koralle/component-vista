...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/server-routes"
...
[## Server Routes and App Routes](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#server-routes-and-app-routes)
...
[## File Route Conventions](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#file-route-conventions)
...
[## Unique Route Paths](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#unique-route-paths)
...
[## Escaped Matching](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#escaped-matching)
...
[## Pathless Layout Routes and Break-out Routes](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#pathless-layout-routes-and-break-out-routes)
...
[## Nested Directories vs File-names](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#nested-directories-vs-file-names)

In the examples above, you may have noticed that the file naming conventions are flexible and allow you to mix and match directories and file names. This is intentional and allows you to organize your Server routes in a way that makes sense for your application. You can read more about this in the [TanStack Router File-based Routing Guide](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing#s-or-s).

[## Handling Server Route Requests](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#handling-server-route-requests)
...
If you need to customize the server handler, you can do so by creating a custom handler and then passing the event to the start handler. See [The Server Entry Point](https://tanstack.com/start/latest/docs/framework/react/guide/server-entry-point.html).

[## Defining a Server Route](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#defining-a-server-route)
...
[## Defining Server Route Handlers](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#defining-server-route-handlers)
...
[### Simple handlers](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#simple-handlers)
...
[### Adding middleware to specific handlers](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#adding-middleware-to-specific-handlers)
...
[### Adding middleware to all handlers](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#adding-middleware-to-all-handlers)
...
[### Combining route-level and handler-specific middleware](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#combining-route-level-and-handler-specific-middleware)
...
[## Handler Context](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#handler-context)
...
[## Dynamic Path Params](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#dynamic-path-params)
...
[## Wildcard/Splat Param](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#wildcardsplat-param)
...
[## Handling requests with a body](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#handling-requests-with-a-body)
...
[## Responding with JSON](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#responding-with-json)
...
[## Using the json helper function](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#using-the-json-helper-function)
...
[## Responding with a status code](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#responding-with-a-status-code)
...
[## Setting headers in the response](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html#setting-headers-in-the-response)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/server-routes.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Error Boundaries](https://tanstack.com/start/latest/docs/framework/react/guide/error-boundaries.html)

[Hydration Errors](https://tanstack.com/start/latest/docs/framework/react/guide/hydration-errors.html)
