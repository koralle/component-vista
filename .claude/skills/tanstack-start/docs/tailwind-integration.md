...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration"
...
[## Tailwind CSS Version 4 (Latest)](https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration.html#tailwind-css-version-4-latest)
...
[### Install Tailwind CSS](https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration.html#install-tailwind-css)
...
[### Configure The Vite Plugin](https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration.html#configure-the-vite-plugin)
...
[### Import Tailwind in your CSS file](https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration.html#import-tailwind-in-your-css-file)
...
[## Import the CSS file in your \_\_root.tsx file](https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration.html#import-the-css-file-in-your-__roottsx-file)
...
[## Use Tailwind CSS anywhere in your project](https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration.html#use-tailwind-css-anywhere-in-your-project)
...
[## Tailwind CSS Version 3 (Legacy)](https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration.html#tailwind-css-version-3-legacy)

If you are want to use Tailwind CSS Version 3, you can use the following steps.

[### Install Tailwind CSS](https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration.html#install-tailwind-css-1)
...
[### Configure your template paths](https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration.html#configure-your-template-paths)
...
[### Add the Tailwind directives to your CSS file](https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration.html#add-the-tailwind-directives-to-your-css-file)
...
Jump to [Import the CSS file in your \_\_root.tsx file](https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration.html#import-the-css-file-in-your-__roottsx-file) to see how to import the CSS file in your \_\_root.tsx file.

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/tailwind-integration.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Path Aliases](https://tanstack.com/start/latest/docs/framework/react/guide/path-aliases.html)

[Basic](https://tanstack.com/start/latest/docs/framework/react/examples/start-basic.html)
