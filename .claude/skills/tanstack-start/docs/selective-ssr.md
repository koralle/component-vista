---
title: "Selective Server-Side Rendering (SSR) | TanStack Start React Docs"
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/selective-ssr"
...
[## What is Selective SSR?](https://tanstack.com/start/latest/docs/framework/react/guide/selective-ssr.html#what-is-selective-ssr)
...
[## How does this compare to SPA mode?](https://tanstack.com/start/latest/docs/framework/react/guide/selective-ssr.html#how-does-this-compare-to-spa-mode)

TanStack Start's [SPA mode](https://tanstack.com/start/latest/docs/framework/react/guide/spa-mode.html) completely disables server-side execution of beforeLoad and loader, as well as server-side rendering of route components. Selective SSR allows you to configure server-side handling on a per-route basis, either statically or dynamically.

[## Configuration](https://tanstack.com/start/latest/docs/framework/react/guide/selective-ssr.html#configuration)
...
[### ssr: true](https://tanstack.com/start/latest/docs/framework/react/guide/selective-ssr.html#ssr-true)
...
[### ssr: false](https://tanstack.com/start/latest/docs/framework/react/guide/selective-ssr.html#ssr-false)
...
[### ssr: 'data-only'](https://tanstack.com/start/latest/docs/framework/react/guide/selective-ssr.html#ssr-data-only)
...
[### Functional Form](https://tanstack.com/start/latest/docs/framework/react/guide/selective-ssr.html#functional-form)
...
[### Inheritance](https://tanstack.com/start/latest/docs/framework/react/guide/selective-ssr.html#inheritance)
...
[## Fallback Rendering](https://tanstack.com/start/latest/docs/framework/react/guide/selective-ssr.html#fallback-rendering)
...
[## How to disable SSR of the root route?](https://tanstack.com/start/latest/docs/framework/react/guide/selective-ssr.html#how-to-disable-ssr-of-the-root-route)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/selective-ssr.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Hydration Errors](https://tanstack.com/start/latest/docs/framework/react/guide/hydration-errors.html)

[SPA Mode](https://tanstack.com/start/latest/docs/framework/react/guide/spa-mode.html)
