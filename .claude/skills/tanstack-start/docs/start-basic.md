...
source_url: "https://tanstack.com/start/latest/docs/framework/react/examples/start-basic"
...
* [Overview
  ...
  react](https://tanstack.com/start/latest/docs.html)
* [Getting Started

  react](https://tanstack.com/start/latest/docs/framework/react/getting-started.html)
* [Quick Start

  react](https://tanstack.com/start/latest/docs/framework/react/quick-start.html)
* [Build from Scratch

  react](https://tanstack.com/start/latest/docs/framework/react/build-from-scratch.html)
* [Comparison

  react](https://tanstack.com/start/latest/docs/framework/react/comparison.html)
* [Migrate from Next.js

  react](https://tanstack.com/start/latest/docs/framework/react/migrate-from-next-js)

Guides

* [Routing

  react](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html)
* [Execution Model

  react](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html)
* [Code Execution Patterns

  react](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html)
* [Environment Variables

  react](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html)
* [Server Functions

  react](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html)
* [Static Server Functions

  react](https://tanstack.com/start/latest/docs/framework/react/guide/static-server-functions.html)
* [Environment Functions

  react](https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions.html)
* [Middleware

  react](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html)
* [Error Boundaries

  react](https://tanstack.com/start/latest/docs/framework/react/guide/error-boundaries.html)
* [Server Routes

  react](https://tanstack.com/start/latest/docs/framework/react/guide/server-routes.html)
* [Hydration Errors

  react](https://tanstack.com/start/latest/docs/framework/react/guide/hydration-errors.html)
* [Selective SSR

  react](https://tanstack.com/start/latest/docs/framework/react/guide/selective-ssr.html)
* [SPA Mode

  react](https://tanstack.com/start/latest/docs/framework/react/guide/spa-mode.html)
* [Static Prerendering

  react](https://tanstack.com/start/latest/docs/framework/react/guide/static-prerendering.html)
* [Incremental Static Regeneration (ISR)

  react](https://tanstack.com/start/latest/docs/framework/react/guide/isr.html)
* [Server Entry Point

  react](https://tanstack.com/start/latest/docs/framework/react/guide/server-entry-point.html)
* [Client Entry Point

  react](https://tanstack.com/start/latest/docs/framework/react/guide/client-entry-point.html)
* [Hosting

  react](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html)
* [Authentication Overview

  react](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html)
* [Authentication

  react](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html)
* [Databases

  react](https://tanstack.com/start/latest/docs/framework/react/guide/databases.html)
* [Observability

  react](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html)
* [Path Aliases

  react](https://tanstack.com/start/latest/docs/framework/react/guide/path-aliases.html)
* [Tailwind CSS Integration

  react](https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration.html)

Examples

* [Basic

  react](https://tanstack.com/start/latest/docs/framework/react/examples/start-basic.html)
* [Basic + React Query

  react](https://tanstack.com/start/latest/docs/framework/react/examples/start-basic-react-query)
* [Basic + Clerk Auth

  react](https://tanstack.com/start/latest/docs/framework/react/examples/start-clerk-basic)
* [Basic + DIY Auth

  react](https://tanstack.com/start/latest/docs/framework/react/examples/start-basic-auth.html)
* [Basic + Supabase Auth

  react](https://tanstack.com/start/latest/docs/framework/react/examples/start-supabase-basic)
* [Trellaux + Convex

  react](https://tanstack.com/start/latest/docs/framework/react/examples/start-convex-trellaux)
* [Trellaux

  react](https://tanstack.com/start/latest/docs/framework/react/examples/start-trellaux)
* [WorkOS

  react](https://tanstack.com/start/latest/docs/framework/react/examples/start-workos)
* [Material UI

  react](https://tanstack.com/start/latest/docs/framework/react/examples/start-material-ui)
* [Basic + Auth.js

  react](https://tanstack.com/start/latest/docs/framework/react/examples/start-basic-authjs)
* [Basic + Static rendering

  react](https://tanstack.com/start/latest/docs/framework/react/examples/start-basic-static)
* [Cloudflare Vite Plugin

  react](https://tanstack.com/start/latest/docs/framework/react/examples/start-basic-cloudflare)

Tutorials

* [Reading and Writing a File

  react](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html)
* [Fetching Data from External API

  react](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html)
...
# React Example: Start Basic [Deploy to Cloudflare](https://deploy.workers.cloudflare.com/?url=https://github.com/tanstack/router/tree/main/examples/react/start-basic)[Deploy with Netlify](https://app.netlify.com/start/deploy?repository=https://github.com/tanstack/router&create_from_path=examples/react/start-basic) [Github](https://github.com/tanstack/router/tree/main/examples/react/start-basic) [CodeSandbox](https://codesandbox.io/p/devbox/github/tanstack/router/tree/main/examples/react/start-basic?embed=1&theme=dark&file=src/routes/__root.tsx)
...
[Tailwind CSS Integration](https://tanstack.com/start/latest/docs/framework/react/guide/tailwind-integration.html)

[Basic + React Query](https://tanstack.com/start/latest/docs/framework/react/examples/start-basic-react-query)
