...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/execution-model"
...
[## Core Principle: Isomorphic by Default](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#core-principle-isomorphic-by-default)
...
[## The Execution Boundary](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#the-execution-boundary)

TanStack Start applications run in two environments:

[### Server Environment](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#server-environment)
...
[### Client Environment](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#client-environment)
...
[## Execution Control APIs](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#execution-control-apis)
[### Server-Only Execution](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#server-only-execution)
...
[### Client-Only Execution](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#client-only-execution)
...
[#### useHydrated Hook](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#usehydrated-hook)
...
[### Environment-Specific Implementations](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#environment-specific-implementations)
...
[## Architectural Patterns](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#architectural-patterns)
[### Progressive Enhancement](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#progressive-enhancement)
...
[### Environment-Aware Storage](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#environment-aware-storage)
...
[### RPC vs Direct Function Calls](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#rpc-vs-direct-function-calls)
...
[## Common Anti-Patterns](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#common-anti-patterns)
[### Environment Variable Exposure](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#environment-variable-exposure)
...
[### Incorrect Loader Assumptions](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#incorrect-loader-assumptions)
...
[### Hydration Mismatches](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#hydration-mismatches)
...
[## Manual vs API-Driven Environment Detection](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#manual-vs-api-driven-environment-detection)
...
[## Architecture Decision Framework](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#architecture-decision-framework)
...
[## Security Considerations](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#security-considerations)
[### Bundle Analysis](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#bundle-analysis)
...
[### Environment Variable Strategy](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#environment-variable-strategy)

* **Client-exposed**: Use VITE\_ prefix for client-accessible variables
* **Server-only**: Access via createServerOnlyFn() or createServerFn()
* **Never expose**: Database URLs, API keys, secrets

[### Error Boundaries](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html#error-boundaries)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/execution-model.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Routing](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html)
