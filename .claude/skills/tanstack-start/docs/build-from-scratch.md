...
source_url: "https://tanstack.com/start/latest/docs/framework/react/build-from-scratch"
...
If you chose to quick start with an example or cloned project, you can skip this guide and move on to the [Routing](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html) guide.
...
[## TypeScript Configuration](https://tanstack.com/start/latest/docs/framework/react/build-from-scratch.html#typescript-configuration)
...
[## Install Dependencies](https://tanstack.com/start/latest/docs/framework/react/build-from-scratch.html#install-dependencies)
...
[## Update Configuration Files](https://tanstack.com/start/latest/docs/framework/react/build-from-scratch.html#update-configuration-files)
...
[## Add the Basic Templating](https://tanstack.com/start/latest/docs/framework/react/build-from-scratch.html#add-the-basic-templating)
...
[## The Router Configuration](https://tanstack.com/start/latest/docs/framework/react/build-from-scratch.html#the-router-configuration)

This is the file that will dictate the behavior of TanStack Router used within Start. Here, you can configure everything
from the default [preloading functionality](https://tanstack.com/router/latest/docs/framework/react/guide/preloading) to [caching staleness](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading).
...
[## The Root of Your Application](https://tanstack.com/start/latest/docs/framework/react/build-from-scratch.html#the-root-of-your-application)
...
[## Writing Your First Route](https://tanstack.com/start/latest/docs/framework/react/build-from-scratch.html#writing-your-first-route)
...
You want to deploy your application? Check out the [hosting guide](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html).
...
[Comparison](https://tanstack.com/start/latest/docs/framework/react/comparison.html)
