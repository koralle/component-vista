...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/middleware"
...
[## What is Middleware?](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#what-is-middleware)
...
[### What kinds of things can I do with Middleware?](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#what-kinds-of-things-can-i-do-with-middleware)
...
[## Middleware Types](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#middleware-types)
...
[### Key Differences](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#key-differences)
...
[## Core Concepts](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#core-concepts)
[### Middleware Composition](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#middleware-composition)
...
[### Progressing the Middleware Chain](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#progressing-the-middleware-chain)
...
[## Request Middleware](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#request-middleware)
...
[### Available Methods](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#available-methods)
...
[### The .server method](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#the-server-method)
...
[### Using Request Middleware with Server Routes](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#using-request-middleware-with-server-routes)

You can use request middleware with server routes in two ways:

[#### All Server Route Methods](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#all-server-route-methods)
...
[#### Specific Server Route Methods](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#specific-server-route-methods)
...
[## Server Function Middleware](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#server-function-middleware)
...
[### Available Methods](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#available-methods-1)
...
[### The .client method](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#the-client-method)
...
[### The .inputValidator method](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#the-inputvalidator-method)
...
[### Using Server Function Middleware](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#using-server-function-middleware)
...
[## Context Management](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#context-management)
[### Providing Context via next](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#providing-context-via-next)
...
[### Sending Client Context to the Server](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#sending-client-context-to-the-server)
...
[#### Client-Sent Context Security](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#client-sent-context-security)
...
[### Sending Server Context to the Client](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#sending-server-context-to-the-client)
...
[## Global Middleware](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#global-middleware)
...
[### Global Request Middleware](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#global-request-middleware)
...
[### Global Server Function Middleware](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#global-server-function-middleware)
...
[### Global Middleware Type Safety](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#global-middleware-type-safety)
...
[### Middleware Execution Order](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#middleware-execution-order)
...
[## Request and Response Modification](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#request-and-response-modification)
[### Reading/Modifying the Server Response](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#readingmodifying-the-server-response)

Middleware that uses the server method executes in the same context as server functions, so you can follow the exact same [Server Function Context Utilities](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html#server-function-context) to read and modify anything about the request headers, status codes, etc.

[### Modifying the Client Request](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#modifying-the-client-request)
...
[## Environment and Performance](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#environment-and-performance)
[### Environment Tree Shaking](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html#environment-tree-shaking)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/middleware.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Environment Functions](https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions.html)

[Error Boundaries](https://tanstack.com/start/latest/docs/framework/react/guide/error-boundaries.html)
