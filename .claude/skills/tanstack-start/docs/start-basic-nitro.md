---
title: "Solid TanStack Start Start Basic Nitro Example | TanStack Start Docs"
source_url: "https://tanstack.com/start/latest/docs/framework/solid/examples/start-basic-nitro"
...
# Solid Example: Start Basic Nitro [Deploy to Cloudflare](https://deploy.workers.cloudflare.com/?url=https://github.com/tanstack/router/tree/main/examples/solid/start-basic-nitro)[Deploy with Netlify](https://app.netlify.com/start/deploy?repository=https://github.com/tanstack/router&create_from_path=examples/solid/start-basic-nitro) [Github](https://github.com/tanstack/router/tree/main/examples/solid/start-basic-nitro) [CodeSandbox](https://codesandbox.io/p/devbox/github/tanstack/router/tree/main/examples/solid/start-basic-nitro?embed=1&theme=dark&file=src/routes/__root.tsx)
