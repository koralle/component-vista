...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns"
...
This guide covers patterns for controlling where code runs in your TanStack Start application - server-only, client-only, or isomorphic (both environments). For foundational concepts, see the [Execution Model](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html) guide.

[## Quick Start](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html#quick-start)
...
[## Implementation Patterns](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html#implementation-patterns)
[### Progressive Enhancement](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html#progressive-enhancement)
...
[### Environment-Aware Storage](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html#environment-aware-storage)
...
[## Common Problems](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html#common-problems)
[### Environment Variable Exposure](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html#environment-variable-exposure)
...
[### Incorrect Loader Assumptions](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html#incorrect-loader-assumptions)
...
[### Hydration Mismatches](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html#hydration-mismatches)
...
[## Production Checklist](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html#production-checklist)
...
[## Related Resources](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html#related-resources)

* [Execution Model](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html) - Core concepts and architectural patterns
* [Server Functions](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html) - Deep dive into server function patterns
* [Environment Variables](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html) - Secure environment variable handling
* [Middleware](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html) - Server function middleware patterns

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/code-execution-patterns.md)
