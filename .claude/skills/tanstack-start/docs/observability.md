...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/observability"
...
[## Partner Solution: Sentry](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#partner-solution-sentry)
[![Sentry logo](https://raw.githubusercontent.com/tanstack/tanstack.com/main/src/images/sentry-wordmark-light.svg)](https://sentry.io?utm_source=tanstack)
...
[## Built-in Observability Patterns](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#built-in-observability-patterns)

TanStack Start's architecture provides several opportunities for built-in observability without external dependencies:

[### Server Function Logging](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#server-function-logging)
...
[### Request/Response Middleware](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#requestresponse-middleware)
...
[### Route Performance Monitoring](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#route-performance-monitoring)
...
[### Health Check Endpoints](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#health-check-endpoints)
...
[### Error Boundaries](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#error-boundaries)
...
[### Performance Metrics Collection](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#performance-metrics-collection)
...
[### Debug Headers for Development](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#debug-headers-for-development)
...
[### Environment-Specific Logging](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#environment-specific-logging)
...
const logger = createIsomorphicFn()
  .server((level: LogLevel, message: string, data?: any) => {
    ...
    if (process.env.NODE_ENV === 'development') {
      ...
      console[level](https://tanstack.com/start/latest/docs/framework/react/guide/`[${timestamp}] [${level.toUpperCase()}]`, message, data)
    } else {
  ...
  .client((level: LogLevel, message: string, data?: any) => {
    if (process.env.NODE_ENV === 'development') {
      console[level](https://tanstack.com/start/latest/docs/framework/react/guide/`[CLIENT] [${level.toUpperCase()}]`, message, data)
    } else {
...
[### Simple Error Reporting](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#simple-error-reporting)
...
[## External Observability Tools](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#external-observability-tools)

While TanStack Start provides built-in observability patterns, external tools offer more comprehensive monitoring:

[### Other Popular Tools](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#other-popular-tools)
...
[### New Relic Integration](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#new-relic-integration)
...
[#### SSR](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#ssr)
...
[#### Server Functions and Server Routes](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#server-functions-and-server-routes)
...
[#### SPA & Browser](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#spa--browser)
...
[### OpenTelemetry Integration (Experimental)](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#opentelemetry-integration-experimental)
...
[### Quick Integration Pattern](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#quick-integration-pattern)
...
[## Best Practices](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#best-practices)
[### Development vs Production](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#development-vs-production)
...
[### Performance Monitoring Checklist](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#performance-monitoring-checklist)
...
[### Security Considerations](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#security-considerations)
...
[## Future OpenTelemetry Support](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#future-opentelemetry-support)
...
[## Resources](https://tanstack.com/start/latest/docs/framework/react/guide/observability.html#resources)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/observability.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Databases](https://tanstack.com/start/latest/docs/framework/react/guide/databases.html)

[Path Aliases](https://tanstack.com/start/latest/docs/framework/react/guide/path-aliases.html)
