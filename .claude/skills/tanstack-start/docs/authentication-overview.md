...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview"
...
[## Authentication vs Authorization](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#authentication-vs-authorization)
...
[## Architecture Overview](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#architecture-overview)
[### Full-Stack Authentication Model](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#full-stack-authentication-model)
...
[### Session Management Patterns](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#session-management-patterns)
...
[### Route Protection Architecture](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#route-protection-architecture)
...
[### State Management Patterns](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#state-management-patterns)
...
[## Authentication Options](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#authentication-options)
[### 🏢 Partner Solutions](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#-partner-solutions)

* **[WorkOS](https://workos.com)**
* **[Clerk](https://clerk.dev)**

[### 🛠️ DIY Authentication](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#️-diy-authentication)
...
[### 🌐 Other Excellent Options](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#-other-excellent-options)
...
[## Partner Solutions](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#partner-solutions)
[### WorkOS - Enterprise Authentication](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#workos---enterprise-authentication)
[![WorkOS logo](https://raw.githubusercontent.com/tanstack/tanstack.com/main/src/images/workos-logo-light.svg)](https://workos.com/)
...
[### Clerk - Complete Authentication Platform](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#clerk---complete-authentication-platform)
[![Clerk logo](https://raw.githubusercontent.com/tanstack/tanstack.com/main/src/images/clerk-logo-light.svg)](https://go.clerk.com/wOwHtuJ)
...
[## Examples](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#examples)
...
[## Architecture Decision Guide](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#architecture-decision-guide)
[### Choosing an Authentication Approach](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#choosing-an-authentication-approach)
...
[### Security Considerations](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#security-considerations)
...
[## Next Steps](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#next-steps)

* **Partner solutions** → [Clerk](https://go.clerk.com/wOwHtuJ) or [WorkOS](https://workos.com/)
* **DIY implementation** → [Authentication Guide](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html)
* **Examples** → [Working implementations](https://github.com/TanStack/router/tree/main/examples/react)

[## Resources](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html#resources)

**Implementation Guides:**

* [Authentication Patterns](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html)
* [Router Authentication Guide](https://tanstack.com/router/latest/docs/framework/react/guide/authenticated-routes.md)

**Foundation Concepts:**

* [Execution Model](https://tanstack.com/start/latest/docs/framework/react/guide/execution-model.html)
* [Server Functions](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html)

**Step-by-Step Tutorials:**

* [Router How-to Guides](https://tanstack.com/router/latest/docs/framework/react/how-to/README.md#authentication)

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/authentication-overview.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Hosting](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html)

[Authentication](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html)
