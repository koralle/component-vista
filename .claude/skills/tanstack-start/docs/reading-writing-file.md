---
title: "Building a Full Stack DevJokes App with TanStack Start | TanStack Start React Docs"
source_url: "https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file"
...
[## What You'll Learn](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#what-youll-learn)
...
[## Prerequisites](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#prerequisites)

* Basic knowledge of React and TypeScript.
* Node.js and pnpm installed on your machine

[## Nice to know](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#nice-to-know)
...
[## Setting up a TanStack Start Project](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#setting-up-a-tanstack-start-project)
...
[## Understanding the project structure](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#understanding-the-project-structure)
...
2. src/routes/\_\_root.tsx - The root layout component where you can add global styles and components
...
[## Step 1: Reading Data From a File](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#step-1-reading-data-from-a-file)

Let's start by creating a file-based storage system for our jokes.

[### Step 1.1: Create a JSON File with Jokes](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#step-11-create-a-json-file-with-jokes)
...
[### Step 1.2: Create Types for Our Data](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#step-12-create-types-for-our-data)
...
[### Step 1.3: Create Server Functions to Read the File](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#step-13-create-server-functions-to-read-the-file)
...
[### Step 1.4: Consume Server Function on the Client Side](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#step-14-consume-server-function-on-the-client-side)
...
[## Step 2: Writing Data to a File](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#step-2-writing-data-to-a-file)
...
[### Step 2.1: Create Server Function to Write to the File](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#step-21-create-server-function-to-write-to-the-file)
...
[### Step 2.2: Adding a Form to Add Jokes to our JSON File](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#step-22-adding-a-form-to-add-jokes-to-our-json-file)
...
[### Step 2.3: Wire Up the Form to the Server Function](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#step-23-wire-up-the-form-to-the-server-function)
...
[## Understanding How It All Works Together](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#understanding-how-it-all-works-together)
...
[## How Data Flows Through the Application](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#how-data-flows-through-the-application)
[### Data Flow](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#data-flow)
...
[## Common Issues and Debugging](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#common-issues-and-debugging)

Here are some common issues you might encounter when building your TanStack Start application and how to resolve them:

[### Server Functions Not Working](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#server-functions-not-working)
...
[### Route Data Not Loading](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#route-data-not-loading)
...
[### Form Submission Issues](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#form-submission-issues)
...
[### File Reading/Writing Issues](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#file-readingwriting-issues)
...
[## Conclusion](https://tanstack.com/start/latest/docs/framework/react/tutorial/reading-writing-file.html#conclusion)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/tutorial/reading-writing-file.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Cloudflare Vite Plugin](https://tanstack.com/start/latest/docs/framework/react/examples/start-basic-cloudflare)

[Fetching Data from External API](https://tanstack.com/start/latest/docs/framework/react/tutorial/fetching-external-api.html)
