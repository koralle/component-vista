---
title: "Comparison | TanStack Start vs Next.js vs React Router | TanStack Start React Docs"
source_url: "https://tanstack.com/start/latest/docs/framework/react/comparison"
...
>
> [### [📖 TanStack Router Comparison vs React Router / Next.js →](https://tanstack.com/router/latest/docs/framework/react/comparison)](comparison.html#-tanstack-router-comparison-vs-react-router--nextjs-)
>
...
|  | TanStack Start | Next.js [*(Website)*](https://nextjs.org/) | React Router [*(Website)*](https://reactrouter.com/) |
| --- | --- | --- | --- |
| Github Repo / Stars |  |  |  |
| Bundle Size |  | ❓ | ❓ |
| -- | -- | -- | -- |
| **Routing Features** [*(See Full Comparison)*](https://tanstack.com/router/latest/docs/framework/react/comparison) | ✅ Built on TanStack Router | ✅ File-based App Router | ✅ File-based Nested Routes |
| -- | -- | -- | -- |
| **Full-Stack Features** | -- | -- | -- |
| SSR | ✅ | ✅ | ✅ |
| Streaming SSR | ✅ | ✅ | ✅ |
...
> **⚠️ Remember:** For detailed comparisons of **routing features** (type safety, search params, loaders, navigation, etc.), see the [**TanStack Router Comparison**](https://tanstack.com/router/latest/docs/framework/react/comparison). This page focuses on full-stack framework capabilities.

---

[## Key Philosophical Differences](https://tanstack.com/start/latest/docs/framework/react/comparison.html#key-philosophical-differences)
[### TanStack Start](https://tanstack.com/start/latest/docs/framework/react/comparison.html#tanstack-start)

**Philosophy**: Maximum developer freedom with best-in-class type safety.

* **Router-First**: Built on TanStack Router (see [full routing comparison](https://tanstack.com/router/latest/docs/framework/react/comparison))
...
[### Next.js](https://tanstack.com/start/latest/docs/framework/react/comparison.html#nextjs)
...
[### React Router (v7 Framework Mode)](https://tanstack.com/start/latest/docs/framework/react/comparison.html#react-router-v7-framework-mode)
...
[## When to Choose Each Framework](https://tanstack.com/start/latest/docs/framework/react/comparison.html#when-to-choose-each-framework)
[### Choose TanStack Start if you:](https://tanstack.com/start/latest/docs/framework/react/comparison.html#choose-tanstack-start-if-you)

* Want the absolute best type safety for routing (see [Router Comparison](https://tanstack.com/router/latest/docs/framework/react/comparison))
...
[### Choose Next.js if you:](https://tanstack.com/start/latest/docs/framework/react/comparison.html#choose-nextjs-if-you)
...
[### Choose React Router if you:](https://tanstack.com/start/latest/docs/framework/react/comparison.html#choose-react-router-if-you)
...
[## Feature Deep Dives](https://tanstack.com/start/latest/docs/framework/react/comparison.html#feature-deep-dives)
[### Built-in Client-Side Caching](https://tanstack.com/start/latest/docs/framework/react/comparison.html#built-in-client-side-caching)
...
[### Server Functions vs Server Actions](https://tanstack.com/start/latest/docs/framework/react/comparison.html#server-functions-vs-server-actions)
...
[### Middleware Architecture](https://tanstack.com/start/latest/docs/framework/react/comparison.html#middleware-architecture)
...
[### Deployment Flexibility](https://tanstack.com/start/latest/docs/framework/react/comparison.html#deployment-flexibility)
...
[## React Server Components (RSC)](https://tanstack.com/start/latest/docs/framework/react/comparison.html#react-server-components-rsc)
...
[## Performance Considerations](https://tanstack.com/start/latest/docs/framework/react/comparison.html#performance-considerations)
[### Production Performance](https://tanstack.com/start/latest/docs/framework/react/comparison.html#production-performance)
...
[### Development Performance](https://tanstack.com/start/latest/docs/framework/react/comparison.html#development-performance)
...
[## Community and Ecosystem](https://tanstack.com/start/latest/docs/framework/react/comparison.html#community-and-ecosystem)
...
[## Maturity](https://tanstack.com/start/latest/docs/framework/react/comparison.html#maturity)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/comparison.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Build from Scratch](https://tanstack.com/start/latest/docs/framework/react/build-from-scratch.html)
