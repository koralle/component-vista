...
source_url: "https://tanstack.com/start/latest/docs/framework/react/getting-started"
...
[## Migrate an existing project from another framework](https://tanstack.com/start/latest/docs/framework/react/getting-started.html#migrate-an-existing-project-from-another-framework)

* [Start a new project from scratch](https://tanstack.com/start/latest/docs/framework/react/getting-started.html#start-a-new-project-from-scratch) to quickly learn how Start works (see below)
* Refer to a migration guide for your specific framework:
  + [Next.js](https://tanstack.com/start/latest/docs/framework/react/migrate-from-next-js)
  + Remix 2 / React Router 7 "Framework Mode" (coming soon!)

[## Start a new project from scratch](https://tanstack.com/start/latest/docs/framework/react/getting-started.html#start-a-new-project-from-scratch)

Choose one of the following options to start building a *new* TanStack Start project:

* [TanStack Start CLI](https://tanstack.com/start/latest/docs/framework/react/quick-start.html) - Just run npm create @tanstack/start@latest. Local, fast, and optionally customizable
* [TanStack Builder](https://tanstack.com/start/latest/docs/framework/react/getting-started.html) (coming soon!) - A visual interface to configure new TanStack projects with a few clicks
* [Quick Start Examples](https://tanstack.com/start/latest/docs/framework/react/quick-start.html) Download or clone one of our official examples
* [Build a project from scratch](https://tanstack.com/start/latest/docs/framework/react/build-from-scratch.html) - A guide to building a TanStack Start project line-by-line, file-by-file.

[## Next Steps](https://tanstack.com/start/latest/docs/framework/react/getting-started.html#next-steps)

Unless you chose to build a project from scratch, you can now move on to the [Routing](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html) guide to learn how to use TanStack Start!

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/getting-started.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Overview](https://tanstack.com/start/latest/docs.html)

[Quick Start](https://tanstack.com/start/latest/docs/framework/react/quick-start.html)
