...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/authentication"
...
> **📋 Before You Start:** Check our [Authentication Overview](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html) for all available options including partner solutions and hosted services.

[## Authentication Approaches](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#authentication-approaches)
...
[## Core Concepts](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#core-concepts)
[### Authentication vs Authorization](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#authentication-vs-authorization)
...
[## Essential Building Blocks](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#essential-building-blocks)
[### 1. Server Functions for Authentication](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#1-server-functions-for-authentication)
...
[### 2. Session Management](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#2-session-management)
...
[### 3. Authentication Context](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#3-authentication-context)
...
[### 4. Route Protection](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#4-route-protection)
...
[## Implementation Patterns](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#implementation-patterns)
[### Basic Email/Password Authentication](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#basic-emailpassword-authentication)
...
[### Role-Based Access Control (RBAC)](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#role-based-access-control-rbac)
...
[### Social Authentication Integration](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#social-authentication-integration)
...
[### Password Reset Flow](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#password-reset-flow)
...
[## Security Best Practices](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#security-best-practices)
[### 1. Password Security](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#1-password-security)
...
[### 2. Session Security](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#2-session-security)
...
[### 3. Rate Limiting](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#3-rate-limiting)
...
[### 4. Input Validation](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#4-input-validation)
...
[## Testing Authentication](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#testing-authentication)
[### Unit Testing Server Functions](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#unit-testing-server-functions)
...
[### Integration Testing](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#integration-testing)
...
[## Common Patterns](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#common-patterns)
[### Loading States](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#loading-states)
...
[### Remember Me Functionality](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#remember-me-functionality)
...
[## Working Examples](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#working-examples)
...
[## Migration from Other Solutions](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#migration-from-other-solutions)
[### From Client-Side Auth](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#from-client-side-auth)
...
[### From Other Frameworks](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#from-other-frameworks)
...
[## Production Considerations](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#production-considerations)

When choosing your authentication approach, consider these factors:

[### Hosted vs DIY Comparison](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#hosted-vs-diy-comparison)
...
[### Security Considerations](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#security-considerations)
...
[## Next Steps](https://tanstack.com/start/latest/docs/framework/react/guide/authentication.html#next-steps)
...
For other authentication approaches, check the [Authentication Overview](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html). For specific integration help, explore our [working examples](https://github.com/TanStack/router/tree/main/examples/react).

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/authentication.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Authentication Overview](https://tanstack.com/start/latest/docs/framework/react/guide/authentication-overview.html)

[Databases](https://tanstack.com/start/latest/docs/framework/react/guide/databases.html)
