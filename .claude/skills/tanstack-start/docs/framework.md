...
source_url: "https://tanstack.com/start/latest/docs/framework"
...
# Supported TanStack Start Frameworks
...
React](framework/react/build-from-scratch.html)

`@tanstack/react-start`

[Full install instructions](https://tanstack.com/start/latest/docs/framework/react/build-from-scratch.html)
...
Solid](framework/solid/build-from-scratch.html)

`@tanstack/solid-start`

[Full install instructions](https://tanstack.com/start/latest/docs/framework/solid/build-from-scratch.html)

### Want to add support for another framework?

We'd love to help you create a framework adapter for TanStack Start. Join our community to discuss implementation details and get support.
