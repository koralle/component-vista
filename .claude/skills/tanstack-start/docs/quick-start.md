...
source_url: "https://tanstack.com/start/latest/docs/framework/react/quick-start"
...
[## Impatient?](https://tanstack.com/start/latest/docs/framework/react/quick-start.html#impatient)
...
Once you've cloned the example you want, head back to the [Routing](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html) guide to learn how to use TanStack Start!

[## Examples](https://tanstack.com/start/latest/docs/framework/react/quick-start.html#examples)
...
[### Stackblitz](https://tanstack.com/start/latest/docs/framework/react/quick-start.html#stackblitz)

Each example above has an embedded stackblitz preview to find the one that feels like a good starting point

[### Quick Deploy](https://tanstack.com/start/latest/docs/framework/react/quick-start.html#quick-deploy)
...
[### Manual Deploy](https://tanstack.com/start/latest/docs/framework/react/quick-start.html#manual-deploy)
...
Once you've clone or deployed an example, head back to the [Routing](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html) guide to learn how to use TanStack Start!

[## Other Router Examples](https://tanstack.com/start/latest/docs/framework/react/quick-start.html#other-router-examples)
...
[Getting Started](https://tanstack.com/start/latest/docs/framework/react/getting-started.html)
