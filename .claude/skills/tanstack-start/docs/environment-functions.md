...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions"
...
[## What Are Environment Functions?](https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions.html#what-are-environment-functions)
...
[## Isomorphic Functions](https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions.html#isomorphic-functions)
...
[### Complete Implementation](https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions.html#complete-implementation)
...
[### Partial Implementation (Server)](https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions.html#partial-implementation-server)
...
[### Partial Implementation (Client)](https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions.html#partial-implementation-client)
...
[### No Implementation](https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions.html#no-implementation)
...
[#### What is a no-op?](https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions.html#what-is-a-no-op)
...
[## envOnly Functions](https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions.html#envonly-functions)
...
[### createServerOnlyFn](https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions.html#createserveronlyfn)
...
[### createClientOnlyFn](https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions.html#createclientonlyfn)
...
[## Tree Shaking](https://tanstack.com/start/latest/docs/framework/react/guide/environment-functions.html#tree-shaking)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/environment-functions.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Static Server Functions](https://tanstack.com/start/latest/docs/framework/react/guide/static-server-functions.html)

[Middleware](https://tanstack.com/start/latest/docs/framework/react/guide/middleware.html)
