...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/hosting"
...
[## What should I use?](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#what-should-i-use)
...
[## Deployment](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#deployment)
...
* [cloudflare-workers](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#cloudflare-workers--official-partner): Deploy to Cloudflare Workers
* [netlify](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#netlify): Deploy to Netlify
* [nitro](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#nitro): Deploy using Nitro
* [vercel](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#vercel): Deploy to Vercel
* [railway](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#nodejs--railway--docker): Deploy to Railway
* [node-server](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#nodejs--railway--docker): Deploy to a Node.js server
* [bun](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#bun): Deploy to a Bun server
* [appwrite-sites](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#appwrite-sites): Deploy to Appwrite Sites
* ... and more to come!

[### Cloudflare Workers ⭐ *Official Partner*](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#cloudflare-workers--official-partner)
[![Cloudflare logo](https://raw.githubusercontent.com/tanstack/tanstack.com/main/src/images/cloudflare-black.svg)](https://www.cloudflare.com?utm_source=tanstack)
...
[### Netlify ⭐ *Official Partner*](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#netlify--official-partner)
[![Netlify logo](https://raw.githubusercontent.com/tanstack/tanstack.com/main/src/images/netlify-light.svg)](https://www.netlify.com?utm_source=tanstack)
[### Netlify](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#netlify)
...
[#### Manual configuration](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#manual-configuration)
...
[#### Other deployment methods](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#other-deployment-methods)
...
[### Nitro](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#nitro)
...
[### Vercel](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#vercel)

Follow the [Nitro](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#nitro) deployment instructions.
Deploy your application to Vercel using their one-click deployment process, and you're ready to go!

[### Node.js / Railway / Docker](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#nodejs--railway--docker)

Follow the [Nitro](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#nitro) deployment instructions. Use the node command to start your application from the server from the build output files.
...
[### Bun](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#bun)

Important

Currently, the Bun specific deployment guidelines only work with React 19. If you are using React 18, please refer to the [Node.js](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#nodejs--railway--docker) deployment guidelines.
...
[#### Production Server with Bun](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#production-server-with-bun)
...
| ASSET\_PRELOAD\_MAX\_SIZE | Maximum file size to preload into memory (bytes) | 5242880 (5MB) |
| ASSET\_PRELOAD\_INCLUDE\_PATTERNS | Comma-separated glob patterns for files to include | All files |
| ASSET\_PRELOAD\_EXCLUDE\_PATTERNS | Comma-separated glob patterns for files to exclude | None |
| ASSET\_PRELOAD\_VERBOSE\_LOGGING | Enable detailed logging | false |
| ASSET\_PRELOAD\_ENABLE\_ETAG | Enable ETag generation | true |
| ASSET\_PRELOAD\_ENABLE\_GZIP | Enable Gzip compression | true |
| ASSET\_PRELOAD\_GZIP\_MIN\_SIZE | Minimum file size for Gzip (bytes) | 1024 (1KB) |
| ASSET\_PRELOAD\_GZIP\_MIME\_TYPES | MIME types eligible for Gzip | text/,application/javascript,application/json,application/xml,image/svg+xml |
...
[### Appwrite Sites](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html#appwrite-sites)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/hosting.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Client Entry Point](https://tanstack.com/start/latest/docs/framework/react/guide/client-entry-point.html)
