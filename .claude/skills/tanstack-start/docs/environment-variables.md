...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables"
...
[## Quick Start](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#quick-start)
...
[## Environment Variable Contexts](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#environment-variable-contexts)
[### Server-Side Context (Server Functions & API Routes)](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#server-side-context-server-functions--api-routes)
...
[### Client-Side Context (Components & Client Code)](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#client-side-context-components--client-code)
...
[## Environment File Setup](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#environment-file-setup)
[### File Hierarchy (Loaded in Order)](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#file-hierarchy-loaded-in-order)
...
[### Example Setup](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#example-setup)
...
[## Common Patterns](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#common-patterns)
[### Database Configuration](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#database-configuration)
...
[### Authentication Provider Setup](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#authentication-provider-setup)
...
[### External API Integration](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#external-api-integration)
...
[### Feature Flags and Configuration](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#feature-flags-and-configuration)
...
[## Type Safety](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#type-safety)
[### TypeScript Declarations](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#typescript-declarations)
...
[### Runtime Validation](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#runtime-validation)
...
[## Security Best Practices](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#security-best-practices)
[### 1. Never Expose Secrets to Client](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#1-never-expose-secrets-to-client)
...
[### 2. Use Appropriate Prefixes](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#2-use-appropriate-prefixes)
...
[### 3. Validate Required Variables](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#3-validate-required-variables)
...
[## Production Checklist](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#production-checklist)

* All sensitive variables are server-only (no VITE\_ prefix)
* Client variables use VITE\_ prefix
...
[## Common Problems](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#common-problems)
[### Environment Variable is Undefined](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#environment-variable-is-undefined)

**Problem**: import.meta.env.MY\_VARIABLE returns undefined

**Solutions**:

1. **Add correct prefix**: Use VITE\_ prefix (e.g. VITE\_MY\_VARIABLE)
...
[### Runtime Client Environment Variables in Production](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#runtime-client-environment-variables-in-production)
...
[### Variable Not Updating](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#variable-not-updating)
...
[### TypeScript Errors](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#typescript-errors)

**Problem**: Property 'VITE\_MY\_VAR' does not exist on type 'ImportMetaEnv'
...
[### Security: Secret Exposed to Client](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#security-secret-exposed-to-client)
...
[### Build Errors in Production](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#build-errors-in-production)
...
[## Related Resources](https://tanstack.com/start/latest/docs/framework/react/guide/environment-variables.html#related-resources)

* [Code Execution Patterns](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html) - Learn about server vs client code execution
* [Server Functions](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html) - Learn more about server-side code
* [Hosting](https://tanstack.com/start/latest/docs/framework/react/guide/hosting.html) - Platform-specific environment variable configuration
* [Vite Environment Variables](https://vitejs.dev/guide/env-and-mode.html) - Official Vite documentation

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/environment-variables.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Code Execution Patterns](https://tanstack.com/start/latest/docs/framework/react/guide/code-execution-patterns.html)

[Server Functions](https://tanstack.com/start/latest/docs/framework/react/guide/server-functions.html)
