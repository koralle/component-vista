...
source_url: "https://tanstack.com/start/latest/docs/framework/react/guide/routing"
...
[## The Router](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html#the-router)
...
[## File-Based Routing](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html#file-based-routing)
...
[## The Root Route](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html#the-root-route)

The root route is the top-most route in the entire tree and encapsulates all other routes as children. It's found in the src/routes/\_\_root.tsx file and must be named \_\_root.tsx.
...
[## The HeadContent Component](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html#the-headcontent-component)
...
[## The Outlet Component](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html#the-outlet-component)
...
[## The Scripts Component](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html#the-scripts-component)
...
[## Route Tree Generation](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html#route-tree-generation)
...
[## Nested Routing](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html#nested-routing)
...
[## Types of Routes](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html#types-of-routes)
...
[## Route Tree Configuration](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html#route-tree-configuration)

The route tree is configured in the src/routes directory.

[## Creating File Routes](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html#creating-file-routes)
...
[## Defining Routes](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html#defining-routes)
...
[## This is just the "start"](https://tanstack.com/start/latest/docs/framework/react/guide/routing.html#this-is-just-the-start)

This has been just a high-level overview of how to configure routes using TanStack Router. For more detailed information, please refer to the [TanStack Router documentation](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing).

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/start/framework/react/guide/routing.md)
