...
source_url: "https://www.better-auth.com/docs/concepts/cli"
...
## [Generate](https://www.better-auth.com/docs/concepts/cli.html#generate)
...
### [Options](https://www.better-auth.com/docs/concepts/cli.html#options)
...
## [Migrate](https://www.better-auth.com/docs/concepts/cli.html#migrate)
...
### [Options](https://www.better-auth.com/docs/concepts/cli.html#options-1)
...
The migrate command automatically detects your configured `search_path` and creates tables in the correct schema. See the [PostgreSQL adapter documentation](https://www.better-auth.com/docs/adapters/postgresql.html#use-a-non-default-schema) for configuration details.

## [Init](https://www.better-auth.com/docs/concepts/cli.html#init)
...
### [Options](https://www.better-auth.com/docs/concepts/cli.html#options-2)
...
## [Info](https://www.better-auth.com/docs/concepts/cli.html#info)
...
### [Output](https://www.better-auth.com/docs/concepts/cli.html#output)
...
### [Options](https://www.better-auth.com/docs/concepts/cli.html#options-3)

* `--config` - Path to your Better Auth config file
* `--json` - Output as JSON for sharing or programmatic use

### [Examples](https://www.better-auth.com/docs/concepts/cli.html#examples)
...
## [Secret](https://www.better-auth.com/docs/concepts/cli.html#secret)
...
## [Common Issues](https://www.better-auth.com/docs/concepts/cli.html#common-issues)
...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/concepts/cli.mdx)

[Previous Page

API](https://www.better-auth.com/docs/concepts/api.html)[Next Page

Client](https://www.better-auth.com/docs/concepts/client.html)

### On this page

[Generate](https://www.better-auth.com/docs/concepts/cli.html#generate)[Options](https://www.better-auth.com/docs/concepts/cli.html#options)[Migrate](https://www.better-auth.com/docs/concepts/cli.html#migrate)[Options](https://www.better-auth.com/docs/concepts/cli.html#options-1)[Init](https://www.better-auth.com/docs/concepts/cli.html#init)[Options](https://www.better-auth.com/docs/concepts/cli.html#options-2)[Info](https://www.better-auth.com/docs/concepts/cli.html#info)[Output](https://www.better-auth.com/docs/concepts/cli.html#output)[Options](https://www.better-auth.com/docs/concepts/cli.html#options-3)[Examples](https://www.better-auth.com/docs/concepts/cli.html#examples)[Secret](https://www.better-auth.com/docs/concepts/cli.html#secret)[Common Issues](https://www.better-auth.com/docs/concepts/cli.html#common-issues)
