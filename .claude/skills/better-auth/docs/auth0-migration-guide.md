...
source_url: "https://www.better-auth.com/docs/guides/auth0-migration-guide"
...
This migration will invalidate all active sessions. This guide doesn't currently show you how to migrate Organizations but it should be possible with additional steps and the [Organization](https://www.better-auth.com/docs/plugins/organization.html) Plugin.

## [Before You Begin](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#before-you-begin)
...
### [Connect to your database](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#connect-to-your-database)
...
### [Enable Email and Password (Optional)](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#enable-email-and-password-optional)
...
### [Setup Social Providers (Optional)](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#setup-social-providers-optional)
...
### [Add Plugins (Optional)](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#add-plugins-optional)
...
### [Generate Schema](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#generate-schema)
...
### [Install Dependencies](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#install-dependencies)
...
### [Create the migration script](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#create-the-migration-script)
...
### [Run the migration](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#run-the-migration)
...
### [Change password hashing algorithm](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#change-password-hashing-algorithm)
...
### [Verify the migration](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#verify-the-migration)
...
### [Update your components](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#update-your-components)
...
### [Update the middleware](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#update-the-middleware)
...
### [Remove Auth0 Dependencies](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#remove-auth0-dependencies)
...
## [Additional Considerations](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#additional-considerations)

### [Password Migration](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#password-migration)
...
### [Role Mapping](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#role-mapping)
...
### [Rate Limiting](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#rate-limiting)
...
## [Wrapping Up](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#wrapping-up)
...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/guides/auth0-migration-guide.mdx)

[Previous Page

Auth.js Migration Guide](https://www.better-auth.com/docs/guides/next-auth-migration-guide.html)[Next Page

Clerk Migration Guide](https://www.better-auth.com/docs/guides/clerk-migration-guide.html)

### On this page

[Before You Begin](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#before-you-begin)[Connect to your database](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#connect-to-your-database)[Enable Email and Password (Optional)](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#enable-email-and-password-optional)[Setup Social Providers (Optional)](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#setup-social-providers-optional)[Add Plugins (Optional)](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#add-plugins-optional)[Generate Schema](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#generate-schema)[Install Dependencies](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#install-dependencies)[Create the migration script](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#create-the-migration-script)[Run the migration](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#run-the-migration)[Change password hashing algorithm](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#change-password-hashing-algorithm)[Verify the migration](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#verify-the-migration)[Update your components](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#update-your-components)[Update the middleware](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#update-the-middleware)[Remove Auth0 Dependencies](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#remove-auth0-dependencies)[Additional Considerations](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#additional-considerations)[Password Migration](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#password-migration)[Role Mapping](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#role-mapping)[Rate Limiting](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#rate-limiting)[Wrapping Up](https://www.better-auth.com/docs/guides/auth0-migration-guide.html#wrapping-up)
