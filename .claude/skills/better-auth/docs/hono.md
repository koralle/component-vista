...
source_url: "https://www.better-auth.com/docs/integrations/hono"
...
### [Mount the handler](https://www.better-auth.com/docs/integrations/hono.html#mount-the-handler)
...
### [Cors](https://www.better-auth.com/docs/integrations/hono.html#cors)
...
### [Middleware](https://www.better-auth.com/docs/integrations/hono.html#middleware)
...
### [Cross-Domain Cookies](https://www.better-auth.com/docs/integrations/hono.html#cross-domain-cookies)
...
### [Client-Side Configuration](https://www.better-auth.com/docs/integrations/hono.html#client-side-configuration)
...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/integrations/hono.mdx)

[Previous Page

Backend](https://www.better-auth.com/docs/integrations/hono.html)[Next Page

Fastify](https://www.better-auth.com/docs/integrations/fastify.html)

### On this page

[Mount the handler](https://www.better-auth.com/docs/integrations/hono.html#mount-the-handler)[Cors](https://www.better-auth.com/docs/integrations/hono.html#cors)[Middleware](https://www.better-auth.com/docs/integrations/hono.html#middleware)[Cross-Domain Cookies](https://www.better-auth.com/docs/integrations/hono.html#cross-domain-cookies)[Client-Side Configuration](https://www.better-auth.com/docs/integrations/hono.html#client-side-configuration)
