...
source_url: "https://www.better-auth.com/docs/adapters/drizzle"
...
## [Example Usage](https://www.better-auth.com/docs/adapters/drizzle.html#example-usage)
...
## [Schema generation & migration](https://www.better-auth.com/docs/adapters/drizzle.html#schema-generation--migration)
...
## [Joins (Experimental)](https://www.better-auth.com/docs/adapters/drizzle.html#joins-experimental)
...
## [Modifying Table Names](https://www.better-auth.com/docs/adapters/drizzle.html#modifying-table-names)
...
## [Modifying Field Names](https://www.better-auth.com/docs/adapters/drizzle.html#modifying-field-names)
...
## [Using Plural Table Names](https://www.better-auth.com/docs/adapters/drizzle.html#using-plural-table-names)
...
## [Additional Information](https://www.better-auth.com/docs/adapters/drizzle.html#additional-information)
...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/adapters/drizzle.mdx)

[Previous Page

Adapters](https://www.better-auth.com/docs/adapters/drizzle.html)[Next Page

Prisma](https://www.better-auth.com/docs/adapters/prisma.html)

### On this page

[Example Usage](https://www.better-auth.com/docs/adapters/drizzle.html#example-usage)[Schema generation & migration](https://www.better-auth.com/docs/adapters/drizzle.html#schema-generation--migration)[Joins (Experimental)](https://www.better-auth.com/docs/adapters/drizzle.html#joins-experimental)[Modifying Table Names](https://www.better-auth.com/docs/adapters/drizzle.html#modifying-table-names)[Modifying Field Names](https://www.better-auth.com/docs/adapters/drizzle.html#modifying-field-names)[Using Plural Table Names](https://www.better-auth.com/docs/adapters/drizzle.html#using-plural-table-names)[Additional Information](https://www.better-auth.com/docs/adapters/drizzle.html#additional-information)
