...
source_url: "https://www.better-auth.com/docs/concepts/email"
...
## [Email Verification](https://www.better-auth.com/docs/concepts/email.html#email-verification)
...
To use otp based email verification, check out the [OTP Verification](https://www.better-auth.com/docs/plugins/email-otp.html) guide.

### [Adding Email Verification to Your App](https://www.better-auth.com/docs/concepts/email.html#adding-email-verification-to-your-app)
...
### [Triggering Email Verification](https://www.better-auth.com/docs/concepts/email.html#triggering-email-verification)

You can initiate email verification in several ways:

#### [1. During Sign-up](https://www.better-auth.com/docs/concepts/email.html#1-during-sign-up)
...
#### [2. Require Email Verification](https://www.better-auth.com/docs/concepts/email.html#2-require-email-verification)
...
#### [3. Manually](https://www.better-auth.com/docs/concepts/email.html#3-manually)
...
### [Verifying the Email](https://www.better-auth.com/docs/concepts/email.html#verifying-the-email)
...
### [Auto Sign In After Verification](https://www.better-auth.com/docs/concepts/email.html#auto-sign-in-after-verification)
...
### [Callback after successful email verification](https://www.better-auth.com/docs/concepts/email.html#callback-after-successful-email-verification)
...
## [Password Reset Email](https://www.better-auth.com/docs/concepts/email.html#password-reset-email)
...
Check out the [Email and Password](https://www.better-auth.com/docs/authentication/email-password.html#forget-password) guide for more details on how to implement password reset in your app.
Also you can check out the [Otp verification](https://www.better-auth.com/docs/plugins/email-otp.html#reset-password) guide for how to implement password reset with OTP in your app.

[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/concepts/email.mdx)

[Previous Page

Database](https://www.better-auth.com/docs/concepts/database.html)[Next Page

Hooks](https://www.better-auth.com/docs/concepts/hooks.html)

### On this page

[Email Verification](https://www.better-auth.com/docs/concepts/email.html#email-verification)[Adding Email Verification to Your App](https://www.better-auth.com/docs/concepts/email.html#adding-email-verification-to-your-app)[Triggering Email Verification](https://www.better-auth.com/docs/concepts/email.html#triggering-email-verification)[1. During Sign-up](https://www.better-auth.com/docs/concepts/email.html#1-during-sign-up)[2. Require Email Verification](https://www.better-auth.com/docs/concepts/email.html#2-require-email-verification)[3. Manually](https://www.better-auth.com/docs/concepts/email.html#3-manually)[Verifying the Email](https://www.better-auth.com/docs/concepts/email.html#verifying-the-email)[Auto Sign In After Verification](https://www.better-auth.com/docs/concepts/email.html#auto-sign-in-after-verification)[Callback after successful email verification](https://www.better-auth.com/docs/concepts/email.html#callback-after-successful-email-verification)[Password Reset Email](https://www.better-auth.com/docs/concepts/email.html#password-reset-email)
