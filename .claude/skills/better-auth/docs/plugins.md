...
source_url: "https://www.better-auth.com/docs/concepts/plugins"
...
## [Using a Plugin](https://www.better-auth.com/docs/concepts/plugins.html#using-a-plugin)
...
## [Creating a Plugin](https://www.better-auth.com/docs/concepts/plugins.html#creating-a-plugin)
...
### [What can a plugin do?](https://www.better-auth.com/docs/concepts/plugins.html#what-can-a-plugin-do)
...
## [Create a Server plugin](https://www.better-auth.com/docs/concepts/plugins.html#create-a-server-plugin)
...
### [Endpoints](https://www.better-auth.com/docs/concepts/plugins.html#endpoints)
...
### [Schema](https://www.better-auth.com/docs/concepts/plugins.html#schema)
...
### [Hooks](https://www.better-auth.com/docs/concepts/plugins.html#hooks)
...
### [Middleware](https://www.better-auth.com/docs/concepts/plugins.html#middleware)
...
### [On Request & On Response](https://www.better-auth.com/docs/concepts/plugins.html#on-request--on-response)
...
#### [On Request](https://www.better-auth.com/docs/concepts/plugins.html#on-request)
...
#### [On Response](https://www.better-auth.com/docs/concepts/plugins.html#on-response)
...
### [Rate Limit](https://www.better-auth.com/docs/concepts/plugins.html#rate-limit)
...
### [Trusted origins](https://www.better-auth.com/docs/concepts/plugins.html#trusted-origins)
...
See the [trusted origins and security](https://www.better-auth.com/docs/reference/security.html#trusted-origins) docs for more info.

### [Server-plugin helper functions](https://www.better-auth.com/docs/concepts/plugins.html#server-plugin-helper-functions)

Some additional helper functions for creating server plugins.

#### [`getSessionFromCtx`](https://www.better-auth.com/docs/concepts/plugins.html#getsessionfromctx)
...
#### [`sessionMiddleware`](https://www.better-auth.com/docs/concepts/plugins.html#sessionmiddleware)
...
## [Creating a client plugin](https://www.better-auth.com/docs/concepts/plugins.html#creating-a-client-plugin)
...
### [Endpoint Interface](https://www.better-auth.com/docs/concepts/plugins.html#endpoint-interface)
...
### [Get actions](https://www.better-auth.com/docs/concepts/plugins.html#get-actions)
...
### [Get Atoms](https://www.better-auth.com/docs/concepts/plugins.html#get-atoms)
...
### [Path methods](https://www.better-auth.com/docs/concepts/plugins.html#path-methods)
...
### [Fetch plugins](https://www.better-auth.com/docs/concepts/plugins.html#fetch-plugins)
...
### [Atom Listeners](https://www.better-auth.com/docs/concepts/plugins.html#atom-listeners)
...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/concepts/plugins.mdx)

[Previous Page

Hooks](https://www.better-auth.com/docs/concepts/hooks.html)[Next Page

OAuth](https://www.better-auth.com/docs/concepts/oauth.html)

### On this page

[Using a Plugin](https://www.better-auth.com/docs/concepts/plugins.html#using-a-plugin)[Creating a Plugin](https://www.better-auth.com/docs/concepts/plugins.html#creating-a-plugin)[What can a plugin do?](https://www.better-auth.com/docs/concepts/plugins.html#what-can-a-plugin-do)[Create a Server plugin](https://www.better-auth.com/docs/concepts/plugins.html#create-a-server-plugin)[Endpoints](https://www.better-auth.com/docs/concepts/plugins.html#endpoints)[Schema](https://www.better-auth.com/docs/concepts/plugins.html#schema)[Hooks](https://www.better-auth.com/docs/concepts/plugins.html#hooks)[Middleware](https://www.better-auth.com/docs/concepts/plugins.html#middleware)[On Request & On Response](https://www.better-auth.com/docs/concepts/plugins.html#on-request--on-response)[On Request](https://www.better-auth.com/docs/concepts/plugins.html#on-request)[On Response](https://www.better-auth.com/docs/concepts/plugins.html#on-response)[Rate Limit](https://www.better-auth.com/docs/concepts/plugins.html#rate-limit)[Trusted origins](https://www.better-auth.com/docs/concepts/plugins.html#trusted-origins)[Server-plugin helper functions](https://www.better-auth.com/docs/concepts/plugins.html#server-plugin-helper-functions)[`getSessionFromCtx`](https://www.better-auth.com/docs/concepts/plugins.html#getsessionfromctx)[`sessionMiddleware`](https://www.better-auth.com/docs/concepts/plugins.html#sessionmiddleware)[Creating a client plugin](https://www.better-auth.com/docs/concepts/plugins.html#creating-a-client-plugin)[Endpoint Interface](https://www.better-auth.com/docs/concepts/plugins.html#endpoint-interface)[Get actions](https://www.better-auth.com/docs/concepts/plugins.html#get-actions)[Get Atoms](https://www.better-auth.com/docs/concepts/plugins.html#get-atoms)[Path methods](https://www.better-auth.com/docs/concepts/plugins.html#path-methods)[Fetch plugins](https://www.better-auth.com/docs/concepts/plugins.html#fetch-plugins)[Atom Listeners](https://www.better-auth.com/docs/concepts/plugins.html#atom-listeners)
