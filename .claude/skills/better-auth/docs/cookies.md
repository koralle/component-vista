...
source_url: "https://www.better-auth.com/docs/concepts/cookies"
...
### [Cookie Prefix](https://www.better-auth.com/docs/concepts/cookies.html#cookie-prefix)
...
### [Custom Cookies](https://www.better-auth.com/docs/concepts/cookies.html#custom-cookies)
...
### [Cross Subdomain Cookies](https://www.better-auth.com/docs/concepts/cookies.html#cross-subdomain-cookies)
...
### [Secure Cookies](https://www.better-auth.com/docs/concepts/cookies.html#secure-cookies)
...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/concepts/cookies.mdx)

[Previous Page

Client](https://www.better-auth.com/docs/concepts/client.html)[Next Page

Database](https://www.better-auth.com/docs/concepts/database.html)

### On this page

[Cookie Prefix](https://www.better-auth.com/docs/concepts/cookies.html#cookie-prefix)[Custom Cookies](https://www.better-auth.com/docs/concepts/cookies.html#custom-cookies)[Cross Subdomain Cookies](https://www.better-auth.com/docs/concepts/cookies.html#cross-subdomain-cookies)[Secure Cookies](https://www.better-auth.com/docs/concepts/cookies.html#secure-cookies)
