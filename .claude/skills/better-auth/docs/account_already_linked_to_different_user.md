---
title: "Account already linked to different user | Better Auth"
source_url: "https://www.better-auth.com/docs/errors/account_already_linked_to_different_user"
...
## [What is it?](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#what-is-it)
...
## [How to resolve](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#how-to-resolve)

### [Typical resolutions](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#typical-resolutions)
...
### [Common Causes](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#common-causes)
...
### [Safer patterns and prevention](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#safer-patterns-and-prevention)
...
### [Debug locally](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#debug-locally)
...
### [Provider considerations](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#provider-considerations)
...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/errors/account_already_linked_to_different_user.mdx)

### On this page

[What is it?](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#what-is-it)[How to resolve](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#how-to-resolve)[Typical resolutions](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#typical-resolutions)[Common Causes](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#common-causes)[Safer patterns and prevention](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#safer-patterns-and-prevention)[Debug locally](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#debug-locally)[Provider considerations](https://www.better-auth.com/docs/errors/account_already_linked_to_different_user.html#provider-considerations)
