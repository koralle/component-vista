...
source_url: "https://www.better-auth.com/docs/plugins/polar"
...
## [Features](https://www.better-auth.com/docs/plugins/polar.html#features)
...
## [Installation](https://www.better-auth.com/docs/plugins/polar.html#installation)

```
pnpm add better-auth @polar-sh/better-auth @polar-sh/sdk
```

## [Preparation](https://www.better-auth.com/docs/plugins/polar.html#preparation)
...
### [Configuring BetterAuth Server](https://www.better-auth.com/docs/plugins/polar.html#configuring-betterauth-server)
...
### [Configuring BetterAuth Client](https://www.better-auth.com/docs/plugins/polar.html#configuring-betterauth-client)
...
## [Configuration Options](https://www.better-auth.com/docs/plugins/polar.html#configuration-options)
...
### [Required Options](https://www.better-auth.com/docs/plugins/polar.html#required-options)

* `client`: Polar SDK client instance

### [Optional Options](https://www.better-auth.com/docs/plugins/polar.html#optional-options)
...
### [Customers](https://www.better-auth.com/docs/plugins/polar.html#customers)
...
## [Checkout Plugin](https://www.better-auth.com/docs/plugins/polar.html#checkout-plugin)
...
### [Organization Support](https://www.better-auth.com/docs/plugins/polar.html#organization-support)
...
## [Portal Plugin](https://www.better-auth.com/docs/plugins/polar.html#portal-plugin)
...
### [Customer Portal Management](https://www.better-auth.com/docs/plugins/polar.html#customer-portal-management)
...
### [Customer State](https://www.better-auth.com/docs/plugins/polar.html#customer-state)
...
### [Benefits, Orders & Subscriptions](https://www.better-auth.com/docs/plugins/polar.html#benefits-orders--subscriptions)
...
#### [Benefits](https://www.better-auth.com/docs/plugins/polar.html#benefits)
...
#### [Orders](https://www.better-auth.com/docs/plugins/polar.html#orders)
...
#### [Subscriptions](https://www.better-auth.com/docs/plugins/polar.html#subscriptions)
...
## [Usage Plugin](https://www.better-auth.com/docs/plugins/polar.html#usage-plugin)
...
### [Event Ingestion](https://www.better-auth.com/docs/plugins/polar.html#event-ingestion)
...
### [Customer Meters](https://www.better-auth.com/docs/plugins/polar.html#customer-meters)
...
## [Webhooks Plugin](https://www.better-auth.com/docs/plugins/polar.html#webhooks-plugin)
...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/plugins/polar.mdx)

[Previous Page

Stripe](https://www.better-auth.com/docs/plugins/stripe.html)[Next Page

Autumn Billing](https://www.better-auth.com/docs/plugins/autumn.html)

### On this page

[Features](https://www.better-auth.com/docs/plugins/polar.html#features)[Installation](https://www.better-auth.com/docs/plugins/polar.html#installation)[Preparation](https://www.better-auth.com/docs/plugins/polar.html#preparation)[Configuring BetterAuth Server](https://www.better-auth.com/docs/plugins/polar.html#configuring-betterauth-server)[Configuring BetterAuth Client](https://www.better-auth.com/docs/plugins/polar.html#configuring-betterauth-client)[Configuration Options](https://www.better-auth.com/docs/plugins/polar.html#configuration-options)[Required Options](https://www.better-auth.com/docs/plugins/polar.html#required-options)[Optional Options](https://www.better-auth.com/docs/plugins/polar.html#optional-options)[Customers](https://www.better-auth.com/docs/plugins/polar.html#customers)[Checkout Plugin](https://www.better-auth.com/docs/plugins/polar.html#checkout-plugin)[Organization Support](https://www.better-auth.com/docs/plugins/polar.html#organization-support)[Portal Plugin](https://www.better-auth.com/docs/plugins/polar.html#portal-plugin)[Customer Portal Management](https://www.better-auth.com/docs/plugins/polar.html#customer-portal-management)[Customer State](https://www.better-auth.com/docs/plugins/polar.html#customer-state)[Benefits, Orders & Subscriptions](https://www.better-auth.com/docs/plugins/polar.html#benefits-orders--subscriptions)[Benefits](https://www.better-auth.com/docs/plugins/polar.html#benefits)[Orders](https://www.better-auth.com/docs/plugins/polar.html#orders)[Subscriptions](https://www.better-auth.com/docs/plugins/polar.html#subscriptions)[Usage Plugin](https://www.better-auth.com/docs/plugins/polar.html#usage-plugin)[Event Ingestion](https://www.better-auth.com/docs/plugins/polar.html#event-ingestion)[Customer Meters](https://www.better-auth.com/docs/plugins/polar.html#customer-meters)[Webhooks Plugin](https://www.better-auth.com/docs/plugins/polar.html#webhooks-plugin)
