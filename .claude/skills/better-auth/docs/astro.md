...
source_url: "https://www.better-auth.com/docs/integrations/astro"
...
### [Mount the handler](https://www.better-auth.com/docs/integrations/astro.html#mount-the-handler)
...
## [Create a client](https://www.better-auth.com/docs/integrations/astro.html#create-a-client)
...
## [Auth Middleware](https://www.better-auth.com/docs/integrations/astro.html#auth-middleware)

### [Astro Locals types](https://www.better-auth.com/docs/integrations/astro.html#astro-locals-types)
...
### [Middleware](https://www.better-auth.com/docs/integrations/astro.html#middleware)
...
### [Getting session on the server inside `.astro` file](https://www.better-auth.com/docs/integrations/astro.html#getting-session-on-the-server-inside-astro-file)
...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/integrations/astro.mdx)

[Previous Page

Full Stack](https://www.better-auth.com/docs/integrations/astro.html)[Next Page

Remix](https://www.better-auth.com/docs/integrations/remix.html)

### On this page

[Mount the handler](https://www.better-auth.com/docs/integrations/astro.html#mount-the-handler)[Create a client](https://www.better-auth.com/docs/integrations/astro.html#create-a-client)[Auth Middleware](https://www.better-auth.com/docs/integrations/astro.html#auth-middleware)[Astro Locals types](https://www.better-auth.com/docs/integrations/astro.html#astro-locals-types)[Middleware](https://www.better-auth.com/docs/integrations/astro.html#middleware)[Getting session on the server inside `.astro` file](https://www.better-auth.com/docs/integrations/astro.html#getting-session-on-the-server-inside-astro-file)
