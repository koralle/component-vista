...
source_url: "https://www.better-auth.com/docs/adapters/other-relational-databases"
...
Any dialect supported by Kysely can be utilized with Better Auth, including capabilities for generating and migrating database schemas through the [CLI](https://www.better-auth.com/docs/concepts/cli.html).

## [Core Dialects](https://www.better-auth.com/docs/adapters/other-relational-databases.html#core-dialects)
...
## [Kysely Organization Dialects](https://www.better-auth.com/docs/adapters/other-relational-databases.html#kysely-organization-dialects)
...
## [Kysely Community dialects](https://www.better-auth.com/docs/adapters/other-relational-databases.html#kysely-community-dialects)
...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/adapters/other-relational-databases.mdx)

[Previous Page

MS SQL](https://www.better-auth.com/docs/adapters/mssql.html)[Next Page

Adapters](https://www.better-auth.com/docs/adapters/other-relational-databases.html)

### On this page

[Core Dialects](https://www.better-auth.com/docs/adapters/other-relational-databases.html#core-dialects)[Kysely Organization Dialects](https://www.better-auth.com/docs/adapters/other-relational-databases.html#kysely-organization-dialects)[Kysely Community dialects](https://www.better-auth.com/docs/adapters/other-relational-databases.html#kysely-community-dialects)
