...
source_url: "https://www.better-auth.com/docs/guides/supabase-migration-guide"
...
## [Before You Begin](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#before-you-begin)
...
### [Connect to your database](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#connect-to-your-database)
...
### [Enable Email and Password](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#enable-email-and-password)
...
### [Setup Social Providers (Optional)](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#setup-social-providers-optional)
...
### [Add admin, anonymous and phoneNumber plugins](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#add-admin-anonymous-and-phonenumber-plugins)

Add the [admin](https://www.better-auth.com/docs/plugins/admin.html), [anonymous](https://www.better-auth.com/docs/plugins/anonymous.html) and [phoneNumber](https://www.better-auth.com/docs/plugins/phone-number.html) plugins to your auth config. To minimize data loss from Supabase Auth during migration, these plugins must be included in the auth config.
...
### [Add the additional fields](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#add-the-additional-fields)
...
### [Run the migration](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#run-the-migration)
...
### [Copy the migration script](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#copy-the-migration-script)
...
### [Run the migration script](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#run-the-migration-script)
...
### [Change password hashing algorithm](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#change-password-hashing-algorithm)
...
### [Update your code](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#update-your-code)
...
* [Basic Usage](https://www.better-auth.com/docs/basic-usage.html): Learn how to use the auth client to sign up, sign in, and sign out.
...
* [Anonymous](https://www.better-auth.com/docs/plugins/anonymous.html): Learn how to add anonymous authentication to your project.
* [Admin](https://www.better-auth.com/docs/plugins/admin.html): Learn how to add admin authentication to your project.
...
* [Hooks](https://www.better-auth.com/docs/concepts/hooks.html): Learn how to use the hooks to listen for events.
* [Next.js](https://www.better-auth.com/docs/integrations/next.html): Learn how to use the auth client in a Next.js project.

### [Middleware](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#middleware)

To protect routes with middleware, refer to the [Next.js middleware guide](https://www.better-auth.com/docs/integrations/next.html#middleware) or your framework's documentation.

## [Wrapping Up](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#wrapping-up)
...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/guides/supabase-migration-guide.mdx)

[Previous Page

Clerk Migration Guide](https://www.better-auth.com/docs/guides/clerk-migration-guide.html)[Next Page

WorkOS Migration Guide](https://www.better-auth.com/docs/guides/workos-migration-guide.html)

### On this page

[Before You Begin](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#before-you-begin)[Connect to your database](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#connect-to-your-database)[Enable Email and Password](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#enable-email-and-password)[Setup Social Providers (Optional)](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#setup-social-providers-optional)[Add admin, anonymous and phoneNumber plugins](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#add-admin-anonymous-and-phonenumber-plugins)[Add the additional fields](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#add-the-additional-fields)[Run the migration](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#run-the-migration)[Copy the migration script](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#copy-the-migration-script)[Run the migration script](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#run-the-migration-script)[Change password hashing algorithm](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#change-password-hashing-algorithm)[Update your code](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#update-your-code)[Middleware](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#middleware)[Wrapping Up](https://www.better-auth.com/docs/guides/supabase-migration-guide.html#wrapping-up)
