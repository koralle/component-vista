...
source_url: "https://www.better-auth.com/docs/concepts/users-accounts"
...
The user table stores the authentication data of the user [Click here to view the schema](https://www.better-auth.com/docs/concepts/database.html#user).

The user table can be extended using [additional fields](https://www.better-auth.com/docs/concepts/database.html#extending-core-schema) or by plugins to store additional data.

## [Update User](https://www.better-auth.com/docs/concepts/users-accounts.html#update-user)

### [Update User Information](https://www.better-auth.com/docs/concepts/users-accounts.html#update-user-information)
...
### [Change Email](https://www.better-auth.com/docs/concepts/users-accounts.html#change-email)
...
#### [Confirming with Current Email](https://www.better-auth.com/docs/concepts/users-accounts.html#confirming-with-current-email)
...
#### [Updating Without Verification](https://www.better-auth.com/docs/concepts/users-accounts.html#updating-without-verification)
...
#### [Client Usage](https://www.better-auth.com/docs/concepts/users-accounts.html#client-usage)
...
### [Change Password](https://www.better-auth.com/docs/concepts/users-accounts.html#change-password)
...
### [Set Password](https://www.better-auth.com/docs/concepts/users-accounts.html#set-password)
...
## [Delete User](https://www.better-auth.com/docs/concepts/users-accounts.html#delete-user)
...
### [Adding Verification Before Deletion](https://www.better-auth.com/docs/concepts/users-accounts.html#adding-verification-before-deletion)
...
### [Authentication Requirements](https://www.better-auth.com/docs/concepts/users-accounts.html#authentication-requirements)
...
### [Callbacks](https://www.better-auth.com/docs/concepts/users-accounts.html#callbacks)
...
## [Accounts](https://www.better-auth.com/docs/concepts/users-accounts.html#accounts)
...
The account table stores the authentication data of the user [Click here to view the schema](https://www.better-auth.com/docs/concepts/database.html#account)

### [List User Accounts](https://www.better-auth.com/docs/concepts/users-accounts.html#list-user-accounts)
...
### [Token Encryption](https://www.better-auth.com/docs/concepts/users-accounts.html#token-encryption)
...
### [Account Linking](https://www.better-auth.com/docs/concepts/users-accounts.html#account-linking)
...
#### [Forced Linking](https://www.better-auth.com/docs/concepts/users-accounts.html#forced-linking)
...
#### [Manually Linking Accounts](https://www.better-auth.com/docs/concepts/users-accounts.html#manually-linking-accounts)
...
### [Account Unlinking](https://www.better-auth.com/docs/concepts/users-accounts.html#account-unlinking)
...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/concepts/users-accounts.mdx)

[Previous Page

TypeScript](https://www.better-auth.com/docs/concepts/typescript.html)[Next Page

Email & Password](https://www.better-auth.com/docs/authentication/email-password.html)

### On this page

[Update User](https://www.better-auth.com/docs/concepts/users-accounts.html#update-user)[Update User Information](https://www.better-auth.com/docs/concepts/users-accounts.html#update-user-information)[Change Email](https://www.better-auth.com/docs/concepts/users-accounts.html#change-email)[Confirming with Current Email](https://www.better-auth.com/docs/concepts/users-accounts.html#confirming-with-current-email)[Updating Without Verification](https://www.better-auth.com/docs/concepts/users-accounts.html#updating-without-verification)[Client Usage](https://www.better-auth.com/docs/concepts/users-accounts.html#client-usage)[Change Password](https://www.better-auth.com/docs/concepts/users-accounts.html#change-password)[Set Password](https://www.better-auth.com/docs/concepts/users-accounts.html#set-password)[Delete User](https://www.better-auth.com/docs/concepts/users-accounts.html#delete-user)[Adding Verification Before Deletion](https://www.better-auth.com/docs/concepts/users-accounts.html#adding-verification-before-deletion)[Authentication Requirements](https://www.better-auth.com/docs/concepts/users-accounts.html#authentication-requirements)[Callbacks](https://www.better-auth.com/docs/concepts/users-accounts.html#callbacks)[Accounts](https://www.better-auth.com/docs/concepts/users-accounts.html#accounts)[List User Accounts](https://www.better-auth.com/docs/concepts/users-accounts.html#list-user-accounts)[Token Encryption](https://www.better-auth.com/docs/concepts/users-accounts.html#token-encryption)[Account Linking](https://www.better-auth.com/docs/concepts/users-accounts.html#account-linking)[Forced Linking](https://www.better-auth.com/docs/concepts/users-accounts.html#forced-linking)[Manually Linking Accounts](https://www.better-auth.com/docs/concepts/users-accounts.html#manually-linking-accounts)[Account Unlinking](https://www.better-auth.com/docs/concepts/users-accounts.html#account-unlinking)
