---
title: "State not found | Better Auth"
source_url: "https://www.better-auth.com/docs/errors/state_not_found"
...
## [What is it?](https://www.better-auth.com/docs/errors/state_not_found.html#what-is-it)
...
## [Common Causes](https://www.better-auth.com/docs/errors/state_not_found.html#common-causes)
...
## [How to resolve](https://www.better-auth.com/docs/errors/state_not_found.html#how-to-resolve)

### [Start the flow via Better Auth APIs](https://www.better-auth.com/docs/errors/state_not_found.html#start-the-flow-via-better-auth-apis)
...
### [Verify the callback URL and method](https://www.better-auth.com/docs/errors/state_not_found.html#verify-the-callback-url-and-method)
...
### [Check proxies, rewrites, and middleware](https://www.better-auth.com/docs/errors/state_not_found.html#check-proxies-rewrites-and-middleware)
...
### [Debug locally](https://www.better-auth.com/docs/errors/state_not_found.html#debug-locally)
...
### [Edge cases to consider](https://www.better-auth.com/docs/errors/state_not_found.html#edge-cases-to-consider)
...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/canary/docs/content/docs/errors/state_not_found.mdx)

### On this page

[What is it?](https://www.better-auth.com/docs/errors/state_not_found.html#what-is-it)[Common Causes](https://www.better-auth.com/docs/errors/state_not_found.html#common-causes)[How to resolve](https://www.better-auth.com/docs/errors/state_not_found.html#how-to-resolve)[Start the flow via Better Auth APIs](https://www.better-auth.com/docs/errors/state_not_found.html#start-the-flow-via-better-auth-apis)[Verify the callback URL and method](https://www.better-auth.com/docs/errors/state_not_found.html#verify-the-callback-url-and-method)[Check proxies, rewrites, and middleware](https://www.better-auth.com/docs/errors/state_not_found.html#check-proxies-rewrites-and-middleware)[Debug locally](https://www.better-auth.com/docs/errors/state_not_found.html#debug-locally)[Edge cases to consider](https://www.better-auth.com/docs/errors/state_not_found.html#edge-cases-to-consider)
