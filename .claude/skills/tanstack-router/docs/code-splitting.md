...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting"
...
[## How does TanStack Router split code?](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#how-does-tanstack-router-split-code)
...
>
>   Knowing the disadvantages of splitting the loader, if you still want to go ahead with it, head over to the [Data Loader Splitting](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#data-loader-splitting) section.

[## Encapsulating a route's files into a directory](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#encapsulating-a-routes-files-into-a-directory)
...
[## Approaches to code splitting](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#approaches-to-code-splitting)

TanStack Router supports multiple approaches to code splitting. If you are using code-based routing, skip to the [Code-Based Splitting](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#code-based-splitting) section.

When you are using file-based routing, you can use the following approaches to code splitting:

* [Using automatic code-splitting ✨](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#using-automatic-code-splitting)
* [Using the .lazy.tsx suffix](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#using-the-lazytsx-suffix)
* [Using Virtual Routes](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#using-virtual-routes)
...
The automatic code-splitting feature is **ONLY** available when you are using file-based routing with one of our [supported bundlers](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html#getting-started-with-file-based-routing).
...
If you want more control over the code-splitting process, head over to the [Automatic Code Splitting](https://tanstack.com/router/latest/docs/framework/react/guide/automatic-code-splitting.html) guide to learn more about the options available.
...
[### Example code splitting with .lazy.tsx](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#example-code-splitting-with-lazytsx)
...
[## Code-Based Splitting](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#code-based-splitting)
...
[## Data Loader Splitting](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#data-loader-splitting)

**Be warned!!!** Splitting a route loader is a dangerous game.

It can be a powerful tool to reduce bundle size, but it comes with a cost as mentioned in the [How does TanStack Router split code?](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#how-does-tanstack-router-split-code) section.
...
If you are using file-based routing, you'll only be able to split your loader if you are using [Automatic Code Splitting](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#using-automatic-code-splitting) with customized bundling options.

[## Manually accessing Route APIs in other files with the getRouteApi helper](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#manually-accessing-route-apis-in-other-files-with-the-getrouteapi-helper)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/code-splitting.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[File Naming Conventions](https://tanstack.com/router/latest/docs/framework/react/routing/file-naming-conventions.html)

[Automatic Code Splitting](https://tanstack.com/router/latest/docs/framework/react/guide/automatic-code-splitting.html)
