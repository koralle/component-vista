---
title: "History Types | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/history-types"
...
[## Browser Routing](https://tanstack.com/router/latest/docs/framework/react/guide/history-types.html#browser-routing)

The createBrowserHistory is the default history type. It uses the browser's history API to manage the browser history.

[## Hash Routing](https://tanstack.com/router/latest/docs/framework/react/guide/history-types.html#hash-routing)
...
[## Memory Routing](https://tanstack.com/router/latest/docs/framework/react/guide/history-types.html#memory-routing)
...
Refer to the [SSR Guide](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html#server-history) for usage on the server for server-side rendering.

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/history-types.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Custom Search Param Serialization](https://tanstack.com/router/latest/docs/framework/react/guide/custom-search-param-serialization.html)
