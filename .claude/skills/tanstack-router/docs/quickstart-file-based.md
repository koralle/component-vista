---
title: "React TanStack Router Quickstart File Based Example | TanStack Router Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/examples/quickstart-file-based"
...
# React Example: Quickstart File Based [Deploy to Cloudflare](https://deploy.workers.cloudflare.com/?url=https://github.com/tanstack/router/tree/main/examples/react/quickstart-file-based)[Deploy with Netlify](https://app.netlify.com/start/deploy?repository=https://github.com/tanstack/router&create_from_path=examples/react/quickstart-file-based) [Github](https://github.com/tanstack/router/tree/main/examples/react/quickstart-file-based) [StackBlitz](https://stackblitz.com/github/tanstack/router/tree/main/examples/react/quickstart-file-based?embed=1&theme=dark&preset=node&file=src/routes/__root.tsx)
...
[Create Route Property Order](https://tanstack.com/router/latest/docs/eslint/create-route-property-order.html)

[Quickstart (code-based)](https://tanstack.com/router/latest/docs/framework/react/examples/quickstart.html)
