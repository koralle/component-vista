...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors"
...
> ⚠️ This page covers the newer notFound function and notFoundComponent API for handling not found errors. The NotFoundRoute route is deprecated and will be removed in a future release. See [Migrating from NotFoundRoute](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#migrating-from-notfoundroute) for more information.

[## Overview](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#overview)
...
[## The notFoundMode option](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#the-notfoundmode-option)
...
* ["fuzzy" mode](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#notfoundmode-fuzzy) (default): The router will intelligently find the closest matching suitable route and display the notFoundComponent.
* ["root" mode](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#notfoundmode-root): All not-found errors will be handled by the root route's notFoundComponent, regardless of the nearest matching route.

[### notFoundMode: 'fuzzy'](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#notfoundmode-fuzzy)
...
* \_\_root\_\_ (has a notFoundComponent configured)
...
[### notFoundMode: 'root'](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#notfoundmode-root)
...
The notFoundComponent of the \_\_root\_\_ route will be rendered because the notFoundMode is set to root.

[## Configuring a route's notFoundComponent](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#configuring-a-routes-notfoundcomponent)
...
[## Default Router-Wide Not Found Handling](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#default-router-wide-not-found-handling)
...
[## Throwing your own notFound errors](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#throwing-your-own-notfound-errors)
...
[## Specifying Which Routes Handle Not Found Errors](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#specifying-which-routes-handle-not-found-errors)
...
[### Manually targeting the root route](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#manually-targeting-the-root-route)
...
[### Throwing Not Found Errors in Components](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#throwing-not-found-errors-in-components)
...
[### Data Loading Inside notFoundComponent](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#data-loading-inside-notfoundcomponent)
...
[## Usage With SSR](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#usage-with-ssr)

See [SSR guide](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html) for more information.

[## Migrating from NotFoundRoute](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html#migrating-from-notfoundroute)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/not-found-errors.md)
