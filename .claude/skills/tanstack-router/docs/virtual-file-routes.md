...
source_url: "https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes"
...
[## Configuration](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html#configuration)
...
[## Configuration via the TanStackRouter Plugin](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html#configuration-via-the-tanstackrouter-plugin)
...
[## Creating Virtual File Routes](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html#creating-virtual-file-routes)
...
[## Virtual Root Route](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html#virtual-root-route)
...
[## Virtual Route](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html#virtual-route)
...
[## Virtual Index Route](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html#virtual-index-route)
...
[## Virtual Pathless Route](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html#virtual-pathless-route)
...
[## Physical Virtual Routes](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html#physical-virtual-routes)
...
[## Virtual Routes inside of TanStack Router File Based routing](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html#virtual-routes-inside-of-tanstack-router-file-based-routing)
...
Let's look at the bar directory which contains a special file named \_\_virtual.ts. This file instructs the generator to switch over to virtual file route configuration for this directory (and its child directories).

\_\_virtual.ts configures the virtual routes for that particular subtree of the route tree. It uses the same API as explained above, with the only difference being that no rootRoute is defined for that subtree:
...
[## Inception](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html#inception)
...
[## Configuration via the TanStack Router CLI](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html#configuration-via-the-tanstack-router-cli)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/routing/virtual-file-routes.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[File-Based Routing](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html)

[Code-Based Routing](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html)
