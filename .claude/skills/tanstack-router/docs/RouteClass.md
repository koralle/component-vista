---
title: "Route class | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/RouteClass"
...
Please use the [createRoute](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouteFunction.html) function instead.
...
[## Route constructor](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteClass.html#route-constructor)

The Route constructor accepts an object as its only argument.

[### Constructor options](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteClass.html#constructor-options)
...
[### Constructor returns](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteClass.html#constructor-returns)

A new [Route](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html) instance.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteClass.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/RouteClass.md)
