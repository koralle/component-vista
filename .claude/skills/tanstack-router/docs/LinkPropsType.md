---
title: "LinkProps type | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/LinkPropsType"
...
The LinkProps type extends the [ActiveLinkOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/ActiveLinkOptionsType.html) and React.AnchorHTMLAttributes<HTMLAnchorElement> types and contains additional props specific to the Link component.
...
[## LinkProps properties](https://tanstack.com/router/latest/docs/framework/react/api/router/LinkPropsType.html#linkprops-properties)

* All of the props from [ActiveLinkOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/ActiveLinkOptionsType.html)
* All of the props from React.AnchorHTMLAttributes<HTMLAnchorElement>

[#### children](https://tanstack.com/router/latest/docs/framework/react/api/router/LinkPropsType.html#children)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/LinkPropsType.md)
