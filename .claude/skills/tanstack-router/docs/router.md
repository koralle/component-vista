...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router"
fetched_at: "2025-12-17T16:34:45.839488+00:00"
---



[![](https://tanstack.com/images/logos/logo-color-100.png)![](https://tanstack.com/images/logos/logo-black.svg)![](https://tanstack.com/images/logos/logo-white.svg)

TanStack](https://tanstack.com/)

[Router v1v1](https://tanstack.com/router)
...
[Docs](https://tanstack.com/router/latest/docs.html)[Examples](https://tanstack.com/router/latest/docs/framework/react/examples/kitchen-sink-file-based.html)[GitHub](https://github.com/tanstack/router)[Contributors](https://tanstack.com/router/latest/docs/contributors.html)
...
[Docs](https://tanstack.com/ai/latest/docs)[Github](https://github.com/tanstack/ai)[Contributors](https://tanstack.com/ai/latest/docs/contributors)
...
[FeedBeta](https://tanstack.com/feed)[Maintainers](https://tanstack.com/maintainers)[Partners](https://tanstack.com/partners)[Blog](https://tanstack.com/blog)[LearnNEW](https://tanstack.com/learn)[Support](https://tanstack.com/support)[Stats](https://tanstack.com/stats/npm)[Discord](https://tlinz.com/discord)[Merch](https://tanstack.com/merch)[GitHub](https://github.com/tanstack)[Ethos](https://tanstack.com/ethos)[Tenets](https://tanstack.com/tenets)[Brand Guide](https://tanstack.com/brand-guide)
...
* [Home](https://tanstack.com/router/latest.html)
* [Frameworks](https://tanstack.com/router/latest/docs/framework.html)
* [Contributors](https://tanstack.com/router/latest/docs/contributors.html)
...
* [Overview
  ...
  react](https://tanstack.com/router/latest/docs.html)
* [Quick Start

  react](https://tanstack.com/router/latest/docs/framework/react/quick-start.html)
* [Devtools

  react](https://tanstack.com/router/latest/docs/framework/react/devtools.html)
* [Decisions on DX

  react](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html)
* [LLM Assistance Support

  react](https://tanstack.com/router/latest/docs/framework/react/llm-support.html)
* [Comparison

  react](https://tanstack.com/router/latest/docs/framework/react/comparison.html)
* [Frequently Asked Questions

  react](https://tanstack.com/router/latest/docs/framework/react/faq.html)

Installation Guides

* [Manual Setup

  react](https://tanstack.com/router/latest/docs/framework/react/installation/manual.html)
* [Vite

  react](https://tanstack.com/router/latest/docs/framework/react/installation/with-vite.html)
* [Rspack/Rsbuild

  react](https://tanstack.com/router/latest/docs/framework/react/installation/with-rspack.html)
* [Webpack

  react](https://tanstack.com/router/latest/docs/framework/react/installation/with-webpack.html)
* [Esbuild

  react](https://tanstack.com/router/latest/docs/framework/react/installation/with-esbuild.html)
* [Router CLI

  react](https://tanstack.com/router/latest/docs/framework/react/installation/with-router-cli.html)
* [Migrate from React Router

  react](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-router.html)
* [Migrate from React Location

  react](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html)

Routing

* [Routing Concepts

  react](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html)
* [Route Trees

  react](https://tanstack.com/router/latest/docs/framework/react/routing/route-trees.html)
* [Route Matching

  react](https://tanstack.com/router/latest/docs/framework/react/routing/route-matching.html)
* [File-Based Routing

  react](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html)
* [Virtual File Routes

  react](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html)
* [Code-Based Routing

  react](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html)
* [File Naming Conventions

  react](https://tanstack.com/router/latest/docs/framework/react/routing/file-naming-conventions.html)

Guides

* [Code Splitting

  react](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html)
* [Automatic Code Splitting

  react](https://tanstack.com/router/latest/docs/framework/react/guide/automatic-code-splitting.html)
* [Creating a Router

  react](https://tanstack.com/router/latest/docs/framework/react/guide/creating-a-router.html)
* [Outlets

  react](https://tanstack.com/router/latest/docs/framework/react/guide/outlets.html)
* [Navigation

  react](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html)
* [Path Params

  react](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html)
* [Search Params

  react](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html)
* [Link Options

  react](https://tanstack.com/router/latest/docs/framework/react/guide/link-options.html)
* [Custom Links

  react](https://tanstack.com/router/latest/docs/framework/react/guide/custom-link.html)
* [Data Loading

  react](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html)
* [Deferred Data Loading

  react](https://tanstack.com/router/latest/docs/framework/react/guide/deferred-data-loading.html)
* [External Data Loading

  react](https://tanstack.com/router/latest/docs/framework/react/guide/external-data-loading.html)
* [Data Mutations

  react](https://tanstack.com/router/latest/docs/framework/react/guide/data-mutations.html)
* [Type Safety

  react](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html)
* [Type Utilities

  react](https://tanstack.com/router/latest/docs/framework/react/guide/type-utilities.html)
* [Preloading

  react](https://tanstack.com/router/latest/docs/framework/react/guide/preloading.html)
* [Document Head Management

  react](https://tanstack.com/router/latest/docs/framework/react/guide/document-head-management.html)
* [Route Masking

  react](https://tanstack.com/router/latest/docs/framework/react/guide/route-masking.html)
* [Navigation Blocking

  react](https://tanstack.com/router/latest/docs/framework/react/guide/navigation-blocking.html)
* [Custom Search Param Serialization

  react](https://tanstack.com/router/latest/docs/framework/react/guide/custom-search-param-serialization.html)
* [History Types

  react](https://tanstack.com/router/latest/docs/framework/react/guide/history-types.html)
* [Router Context

  react](https://tanstack.com/router/latest/docs/framework/react/guide/router-context.html)
* [Not Found Errors

  react](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html)
* [Authenticated Routes

  react](https://tanstack.com/router/latest/docs/framework/react/guide/authenticated-routes.html)
* [Scroll Restoration

  react](https://tanstack.com/router/latest/docs/framework/react/guide/scroll-restoration.html)
* [Static Route Data

  react](https://tanstack.com/router/latest/docs/framework/react/guide/static-route-data.html)
* [SSR

  react](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html)
* [Render Optimizations

  react](https://tanstack.com/router/latest/docs/framework/react/guide/render-optimizations.html)

API

* [File-Based Routing

  core](https://tanstack.com/router/latest/docs/api/file-based-routing.html)
* [Router

  react](https://tanstack.com/router/latest/docs/framework/react/api/router.html)

Integrations

* [TanStack Query

  react](https://tanstack.com/router/latest/docs/integrations/query.html)

ESLint

* [ESLint Plugin Router

  core](https://tanstack.com/router/latest/docs/eslint/eslint-plugin-router.html)
* [Create Route Property Order

  core](https://tanstack.com/router/latest/docs/eslint/create-route-property-order.html)

Router Examples

* [Quickstart (file-based)

  react](https://tanstack.com/router/latest/docs/framework/react/examples/quickstart-file-based.html)
* [Quickstart (code-based)

  react](https://tanstack.com/router/latest/docs/framework/react/examples/quickstart.html)
* [Basic (file-based)

  react](https://tanstack.com/router/latest/docs/framework/react/examples/basic-file-based.html)
* [Basic (code-based)

  react](https://tanstack.com/router/latest/docs/framework/react/examples/basic.html)
* [Basic + React Query (file-based)

  react](https://tanstack.com/router/latest/docs/framework/react/examples/basic-react-query-file-based.html)
* [Basic + React Query (code-based)

  react](https://tanstack.com/router/latest/docs/framework/react/examples/basic-react-query.html)
* [Basic + SSR (file-based)

  react](https://tanstack.com/router/latest/docs/framework/react/examples/basic-ssr-file-based.html)
* [Basic + SSR Streaming (file-based)

  react](https://tanstack.com/router/latest/docs/framework/react/examples/basic-ssr-streaming-file-based.html)
* [Kitchen Sink (file-based)

  react](https://tanstack.com/router/latest/docs/framework/react/examples/kitchen-sink-file-based.html)
* [Kitchen Sink (code-based)

  react](https://tanstack.com/router/latest/docs/framework/react/examples/kitchen-sink.html)
* [Kitchen Sink + React Query (file-based)

  react](https://tanstack.com/router/latest/docs/framework/react/examples/kitchen-sink-react-query-file-based.html)
* [Kitchen Sink + React Query (code-based)

  react](https://tanstack.com/router/latest/docs/framework/react/examples/kitchen-sink-react-query.html)
* [Location Masking

  react](https://tanstack.com/router/latest/docs/framework/react/examples/location-masking.html)
* [Authenticated Routes

  react](https://tanstack.com/router/latest/docs/framework/react/examples/authenticated-routes.html)
* [Scroll Restoration

  react](https://tanstack.com/router/latest/docs/framework/react/examples/scroll-restoration.html)
* [Deferred Data

  react](https://tanstack.com/router/latest/docs/framework/react/examples/deferred-data.html)
* [Navigation Blocking

  react](https://tanstack.com/router/latest/docs/framework/react/examples/navigation-blocking.html)
* [View Transitions

  react](https://tanstack.com/router/latest/docs/framework/react/examples/view-transitions.html)
* [Framer Motion

  react](https://tanstack.com/router/latest/docs/framework/react/examples/with-framer-motion.html)
* [With tRPC

  react](https://tanstack.com/router/latest/docs/framework/react/examples/with-trpc.html)
* [With tRPC + React Query

  react](https://tanstack.com/router/latest/docs/framework/react/examples/with-trpc-react-query.html)
* [Monorepo basic

  react](https://tanstack.com/router/latest/docs/framework/react/examples/router-monorepo-simple.html)
* [Monorepo basic (with lazy loading)

  react](https://tanstack.com/router/latest/docs/framework/react/examples/router-monorepo-simple-lazy.html)
* [Monorepo with React Query

  react](https://tanstack.com/router/latest/docs/framework/react/examples/router-monorepo-react-query.html)
...
* Functions
  + [createFileRoute](https://tanstack.com/router/latest/docs/framework/react/api/router/createFileRouteFunction.html)
  + [createLazyFileRoute](https://tanstack.com/router/latest/docs/framework/react/api/router/createLazyFileRouteFunction.html)
  + [createRootRoute](https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteFunction.html)
  + [createRootRouteWithContext](https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteWithContextFunction.html)
  + [createRoute](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouteFunction.html)
  + [createLazyRoute](https://tanstack.com/router/latest/docs/framework/react/api/router/createLazyRouteFunction.html)
  + [createRouteMask](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouteMaskFunction.html)
  + [createRouter](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouterFunction.html)
  + [defer](https://tanstack.com/router/latest/docs/framework/react/api/router/deferFunction.html)
  + [getRouteApi](https://tanstack.com/router/latest/docs/framework/react/api/router/getRouteApiFunction.html)
  + [isNotFound](https://tanstack.com/router/latest/docs/framework/react/api/router/isNotFoundFunction.html)
  + [isRedirect](https://tanstack.com/router/latest/docs/framework/react/api/router/isRedirectFunction.html)
  + [lazyRouteComponent](https://tanstack.com/router/latest/docs/framework/react/api/router/lazyRouteComponentFunction.html)
  + [linkOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/linkOptions.html)
  + [notFound](https://tanstack.com/router/latest/docs/framework/react/api/router/notFoundFunction.html)
  + [redirect](https://tanstack.com/router/latest/docs/framework/react/api/router/redirectFunction.html)
  + [retainSearchParams](https://tanstack.com/router/latest/docs/framework/react/api/router/retainSearchParamsFunction.html)
  + [stripSearchParams](https://tanstack.com/router/latest/docs/framework/react/api/router/stripSearchParamsFunction.html)
* Components
  + [<Await>](https://tanstack.com/router/latest/docs/framework/react/api/router/awaitComponent.html)
  + [<CatchBoundary>](https://tanstack.com/router/latest/docs/framework/react/api/router/catchBoundaryComponent.html)
  + [<CatchNotFound>](https://tanstack.com/router/latest/docs/framework/react/api/router/catchNotFoundComponent.html)
  + [<ClientOnly>](https://tanstack.com/router/latest/docs/framework/react/api/router/clientOnlyComponent.html)
  + [<DefaultGlobalNotFound>](https://tanstack.com/router/latest/docs/framework/react/api/router/defaultGlobalNotFoundComponent.html)
  + [<ErrorComponent>](https://tanstack.com/router/latest/docs/framework/react/api/router/errorComponentComponent.html)
  + [<Link>](https://tanstack.com/router/latest/docs/framework/react/api/router/linkComponent.html)
  + [<MatchRoute>](https://tanstack.com/router/latest/docs/framework/react/api/router/matchRouteComponent.html)
  + [<Navigate>](https://tanstack.com/router/latest/docs/framework/react/api/router/navigateComponent.html)
  + [<NotFoundComponent>](https://tanstack.com/router/latest/docs/framework/react/api/router/notFoundComponentComponent.html)
  + [<Outlet>](https://tanstack.com/router/latest/docs/framework/react/api/router/outletComponent.html)
* Hooks
  + [useAwaited](https://tanstack.com/router/latest/docs/framework/react/api/router/useAwaitedHook.html)
  + [useBlocker](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html)
  + [useCanGoBack](https://tanstack.com/router/latest/docs/framework/react/api/router/useCanGoBack.html)
  + [useChildMatches](https://tanstack.com/router/latest/docs/framework/react/api/router/useChildMatchesHook.html)
  + [useLinkProps](https://tanstack.com/router/latest/docs/framework/react/api/router/useLinkPropsHook.html)
  + [useLoaderData](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDataHook.html)
  + [useLoaderDeps](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDepsHook.html)
  + [useLocation](https://tanstack.com/router/latest/docs/framework/react/api/router/useLocationHook.html)
  + [useMatch](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook.html)
  + [useMatchRoute](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchRouteHook.html)
  + [useMatches](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchesHook.html)
  + [useNavigate](https://tanstack.com/router/latest/docs/framework/react/api/router/useNavigateHook.html)
  + [useParentMatches](https://tanstack.com/router/latest/docs/framework/react/api/router/useParentMatchesHook.html)
  + [useParams](https://tanstack.com/router/latest/docs/framework/react/api/router/useParamsHook.html)
  + [useRouteContext](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouteContextHook.html)
  + [useRouter](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouterHook.html)
  + [useRouterState](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouterStateHook.html)
  + [useSearch](https://tanstack.com/router/latest/docs/framework/react/api/router/useSearchHook.html)
* Types
  + [ActiveLinkOptions Type](https://tanstack.com/router/latest/docs/framework/react/api/router/ActiveLinkOptionsType.html)
  + [AsyncRouteComponent Type](https://tanstack.com/router/latest/docs/framework/react/api/router/AsyncRouteComponentType.html)
  + [HistoryState Interface](https://tanstack.com/router/latest/docs/framework/react/api/router/historyStateInterface.html)
  + [LinkOptions Type](https://tanstack.com/router/latest/docs/framework/react/api/router/LinkOptionsType.html)
  + [LinkProps Type](https://tanstack.com/router/latest/docs/framework/react/api/router/LinkPropsType.html)
  + [MatchRouteOptions Type](https://tanstack.com/router/latest/docs/framework/react/api/router/MatchRouteOptionsType.html)
  + [NavigateOptions Type](https://tanstack.com/router/latest/docs/framework/react/api/router/NavigateOptionsType.html)
  + [NotFoundError Type](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundErrorType.html)
  + [ParsedHistoryState Type](https://tanstack.com/router/latest/docs/framework/react/api/router/ParsedHistoryStateType.html)
  + [ParsedLocation Type](https://tanstack.com/router/latest/docs/framework/react/api/router/ParsedLocationType.html)
  + [Redirect Type](https://tanstack.com/router/latest/docs/framework/react/api/router/RedirectType.html)
  + [Register Type](https://tanstack.com/router/latest/docs/framework/react/api/router/RegisterType.html)
  + [Route Type](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html)
  + [RouteApi Type](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiType.html)
  + [RouteMask Type](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMaskType.html)
  + [RouteMatch Type](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMatchType.html)
  + [RouteOptions Type](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html)
  + [Router Type](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html)
  + [RouterEvents Type](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterEventsType.html)
  + [RouterOptions Type](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterOptionsType.html)
  + [RouterState Type](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterStateType.html)
  + [ToMaskOptions Type](https://tanstack.com/router/latest/docs/framework/react/api/router/ToMaskOptionsType.html)
  + [ToOptions Type](https://tanstack.com/router/latest/docs/framework/react/api/router/ToOptionsType.html)
  + [UseMatchRouteOptions Type](https://tanstack.com/router/latest/docs/framework/react/api/router/UseMatchRouteOptionsType.html)
  + [ViewTransitionOptions Type](https://tanstack.com/router/latest/docs/framework/react/api/router/ViewTransitionOptionsType.html)
* ⚠️ Deprecated
  + [FileRoute Class](https://tanstack.com/router/latest/docs/framework/react/api/router/FileRouteClass.html)
  + [Route Class](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteClass.html)
  + [Router Class](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterClass.html)
  + [RouteApi Class](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiClass.html)
  + [RootRoute Class](https://tanstack.com/router/latest/docs/framework/react/api/router/RootRouteClass.html)
  + [NotFoundRoute Class](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundRouteClass.html)
  + [rootRouteWithContext Function](https://tanstack.com/router/latest/docs/framework/react/api/router/rootRouteWithContextFunction.html)

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[File-Based Routing](https://tanstack.com/router/latest/docs/api/file-based-routing.html)

[TanStack Query](https://tanstack.com/router/latest/docs/integrations/query.html)
