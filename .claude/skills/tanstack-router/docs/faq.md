...
source_url: "https://tanstack.com/router/latest/docs/framework/react/faq"
...
[## Why should you choose TanStack Router over another router?](https://tanstack.com/router/latest/docs/framework/react/faq.html#why-should-you-choose-tanstack-router-over-another-router)
...
[## Is TanStack Router a framework?](https://tanstack.com/router/latest/docs/framework/react/faq.html#is-tanstack-router-a-framework)
...
For a deeper dive on the history of TanStack Router, feel free to read [TanStack Router's History](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html#tanstack-routers-origin-story).

[## Should I commit my routeTree.gen.ts file into git?](https://tanstack.com/router/latest/docs/framework/react/faq.html#should-i-commit-my-routetreegents-file-into-git)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/faq.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Comparison](https://tanstack.com/router/latest/docs/framework/react/comparison.html)

[Manual Setup](https://tanstack.com/router/latest/docs/framework/react/installation/manual.html)
