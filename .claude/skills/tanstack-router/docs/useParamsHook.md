---
title: "useParams hook | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useParamsHook"
...
[## useParams options](https://tanstack.com/router/latest/docs/framework/react/api/router/useParamsHook.html#useparams-options)

The useParams hook accepts an optional options object.

[### opts.strict option](https://tanstack.com/router/latest/docs/framework/react/api/router/useParamsHook.html#optsstrict-option)
...
[### opts.shouldThrow option](https://tanstack.com/router/latest/docs/framework/react/api/router/useParamsHook.html#optsshouldthrow-option)
...
[### opts.select option](https://tanstack.com/router/latest/docs/framework/react/api/router/useParamsHook.html#optsselect-option)
...
[### opts.structuralSharing option](https://tanstack.com/router/latest/docs/framework/react/api/router/useParamsHook.html#optsstructuralsharing-option)
...
[## useParams returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useParamsHook.html#useparams-returns)

* An object of of the match's and parent match path params or TSelected if a select function is provided.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useParamsHook.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useParamsHook.md)
