...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDepsHook"
...
[## useLoaderDepsHook options](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDepsHook.html#useloaderdepshook-options)

The useLoaderDepsHook hook accepts an options object.

[### opts.from option](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDepsHook.html#optsfrom-option)

* Type: string
* Required
* The RouteID or path to get the loader dependencies from.

[### opts.select option](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDepsHook.html#optsselect-option)
...
[### opts.structuralSharing option](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDepsHook.html#optsstructuralsharing-option)
...
[## useLoaderDeps returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDepsHook.html#useloaderdeps-returns)

* An object of the loader dependencies or TSelected if a select function is provided.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDepsHook.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useLoaderDepsHook.md)
