...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/path-params"
...
[## Path Params can be used by child routes](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#path-params-can-be-used-by-child-routes)
...
[## Path Params in Loaders](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#path-params-in-loaders)
...
[## Path Params in Components](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#path-params-in-components)
...
> 🧠 Quick tip: If your component is code-split, you can use the [getRouteApi function](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#manually-accessing-route-apis-in-other-files-with-the-getrouteapi-helper) to avoid having to import the Route configuration to get access to the typed useParams() hook.

[## Path Params outside of Routes](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#path-params-outside-of-routes)
...
[## Navigating with Path Params](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#navigating-with-path-params)
...
[## Prefixes and Suffixes for Path Params](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#prefixes-and-suffixes-for-path-params)
...
[### Defining Prefixes](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#defining-prefixes)
...
[### Defining Suffixes](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#defining-suffixes)
...
[### Combining Prefixes and Suffixes](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#combining-prefixes-and-suffixes)
...
[## Optional Path Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#optional-path-parameters)
...
[### Defining Optional Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#defining-optional-parameters)
...
[### How Optional Parameters Work](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#how-optional-parameters-work)
...
[### Accessing Optional Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#accessing-optional-parameters)
...
[### Optional Parameters in Loaders](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#optional-parameters-in-loaders)
...
[### Optional Parameters in beforeLoad](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#optional-parameters-in-beforeload)
...
[### Advanced Optional Parameter Patterns](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#advanced-optional-parameter-patterns)
[#### With Prefix and Suffix](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#with-prefix-and-suffix)
...
[#### All Optional Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#all-optional-parameters)
...
[#### Optional Parameters with Wildcards](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#optional-parameters-with-wildcards)
...
[### Navigating with Optional Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#navigating-with-optional-parameters)
...
[### Type Safety with Optional Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#type-safety-with-optional-parameters)
...
[## Internationalization (i18n) with Optional Path Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#internationalization-i18n-with-optional-path-parameters)
...
[### Prefix-based i18n](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#prefix-based-i18n)
...
[### Complex i18n Patterns](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#complex-i18n-patterns)
...
[### Language Navigation](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#language-navigation)
...
[### Advanced i18n with Optional Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#advanced-i18n-with-optional-parameters)
...
[### SEO and Canonical URLs](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#seo-and-canonical-urls)
...
[### Type Safety for i18n](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#type-safety-for-i18n)
...
[## Allowed Characters](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html#allowed-characters)

By default, path params are escaped with encodeURIComponent. If you want to allow other valid URI characters (e.g. @ or +), you can specify that in your [RouterOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterOptionsType.html#pathparamsallowedcharacters-property).
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/path-params.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Navigation](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html)
