---
title: "Await component | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/awaitComponent"
...
[## Await props](https://tanstack.com/router/latest/docs/framework/react/api/router/awaitComponent.html#await-props)

The Await component accepts the following props:

[### props.promise prop](https://tanstack.com/router/latest/docs/framework/react/api/router/awaitComponent.html#propspromise-prop)

* Type: Promise<T>
* Required
* The promise to await.

[### props.children prop](https://tanstack.com/router/latest/docs/framework/react/api/router/awaitComponent.html#propschildren-prop)

* Type: (result: T) => React.ReactNode
* Required
* A function that will be called with the resolved value of the promise.

[## Await returns](https://tanstack.com/router/latest/docs/framework/react/api/router/awaitComponent.html#await-returns)
...
[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/awaitComponent.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/awaitComponent.md)
