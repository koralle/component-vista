...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiType"
...
[## RouteApi properties and methods](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiType.html#routeapi-properties-and-methods)

The RouteApi has the following properties and methods:

[### useMatch method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiType.html#usematch-method)
...
* A type-safe version of the [useMatch](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook.html) hook that is pre-bound to the route ID that the RouteApi instance was created with.
* Options
  + opts.select
    - Optional
...
[### useRouteContext method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiType.html#useroutecontext-method)
...
* A type-safe version of the [useRouteContext](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouteContextHook.html) hook that is pre-bound to the route ID that the RouteApi instance was created with.
* Options
  + opts.select
    - Optional
...
[### useSearch method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiType.html#usesearch-method)
...
* A type-safe version of the [useSearch](https://tanstack.com/router/latest/docs/framework/react/api/router/useSearchHook.html) hook that is pre-bound to the route ID that the RouteApi instance was created with.
* Options
  + opts.select
    - Optional
...
[### useParams method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiType.html#useparams-method)
...
* A type-safe version of the [useParams](https://tanstack.com/router/latest/docs/framework/react/api/router/useParamsHook.html) hook that is pre-bound to the route ID that the RouteApi instance was created with.
* Options
  + opts.select
    - Optional
...
[### useLoaderData method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiType.html#useloaderdata-method)
...
* A type-safe version of the [useLoaderData](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDataHook.html) hook that is pre-bound to the route ID that the RouteApi instance was created with.
* Options
  + opts.select
    - Optional
...
[### useLoaderDeps method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiType.html#useloaderdeps-method)
...
* A type-safe version of the [useLoaderDeps](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDepsHook.html) hook that is pre-bound to the route ID that the RouteApi instance was created with.
* Options
  + opts.select
    - Optional
...
[### useNavigate method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiType.html#usenavigate-method)
...
* A type-safe version of [useNavigate](https://tanstack.com/router/latest/docs/framework/react/api/router/useNavigateHook.html) that is pre-bound to the route ID that the RouteApi instance was created with.

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/RouteApiType.md)
