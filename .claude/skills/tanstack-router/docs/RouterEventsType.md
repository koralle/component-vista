...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/RouterEventsType"
...
[## RouterEvents properties](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterEventsType.html#routerevents-properties)

Once an event is emitted, the following properties will be present on the event payload.

[### type property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterEventsType.html#type-property)
...
[### fromLocation property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterEventsType.html#fromlocation-property)
...
[### toLocation property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterEventsType.html#tolocation-property)

* Type: [ParsedLocation](https://tanstack.com/router/latest/docs/framework/react/api/router/ParsedLocationType.html)
* The location that the router is transitioning to.

[### pathChanged property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterEventsType.html#pathchanged-property)

* Type: boolean
* true if the path has changed between the fromLocation and toLocation.

[### hrefChanged property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterEventsType.html#hrefchanged-property)

* Type: boolean
* true if the href has changed between the fromLocation and toLocation.

[## Example](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterEventsType.html#example)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/RouterEventsType.md)
