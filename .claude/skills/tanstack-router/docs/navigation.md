...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/navigation"
...
[## Everything is Relative](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#everything-is-relative)
...
[## Shared Navigation API](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#shared-navigation-api)
...
[### ToOptions Interface](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#tooptions-interface)
...
[### NavigateOptions Interface](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#navigateoptions-interface)
...
[### LinkOptions Interface](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#linkoptions-interface)
...
[## Navigation API](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#navigation-api)
...
[## <Link> Component](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#link-component)
...
In addition to the [LinkOptions](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#linkoptions-interface) interface, the Link component also supports the following props:
...
[### Absolute Links](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#absolute-links)
...
[### Dynamic Links](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#dynamic-links)
...
[### Relative Links](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#relative-links)
...
[### Special relative paths: "." and ".."](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#special-relative-paths--and-)
...
[### Search Param Links](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#search-param-links)
...
[### Search Param Type Safety](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#search-param-type-safety)
...
[### Hash Links](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#hash-links)
...
[### Navigating with Optional Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#navigating-with-optional-parameters)
...
[#### Parameter Inheritance vs Removal](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#parameter-inheritance-vs-removal)
...
[#### Basic Optional Parameter Navigation](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#basic-optional-parameter-navigation)
...
[#### Function-Style Parameter Updates](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#function-style-parameter-updates)
...
[#### Multiple Optional Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#multiple-optional-parameters)
...
[#### Mixed Required and Optional Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#mixed-required-and-optional-parameters)
...
[#### Advanced Optional Parameter Patterns](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#advanced-optional-parameter-patterns)
...
[#### Navigation with Search Params and Optional Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#navigation-with-search-params-and-optional-parameters)
...
[#### Imperative Navigation with Optional Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#imperative-navigation-with-optional-parameters)
...
[### Active & Inactive Props](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#active--inactive-props)
...
[### The data-status attribute](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#the-data-status-attribute)
...
[### Active Options](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#active-options)
...
[### Passing isActive to children](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#passing-isactive-to-children)
...
[### Link Preloading](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#link-preloading)
...
[### Link Preloading Delay](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#link-preloading-delay)
...
[## useNavigate](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#usenavigate)
...
[### navigate Options](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#navigate-options)

The navigate function returned by useNavigate accepts the [NavigateOptions interface](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#navigateoptions-interface)

[## Navigate Component](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#navigate-component)
...
[## router.navigate](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#routernavigate)

The router.navigate method is the same as the navigate function returned by useNavigate and accepts the same [NavigateOptions interface](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#navigateoptions-interface). Unlike the useNavigate hook, it is available anywhere your router instance is available and is thus a great way to navigate imperatively from anywhere in your application, including outside of your framework.

[## useMatchRoute and <MatchRoute>](https://tanstack.com/router/latest/docs/framework/react/guide/navigation.html#usematchroute-and-matchroute)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/navigation.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Outlets](https://tanstack.com/router/latest/docs/framework/react/guide/outlets.html)

[Path Params](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html)
