...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/external-data-loading"
...
This guide is geared towards external state management libraries and their integration with TanStack Router for data fetching, ssr, hydration/dehydration and streaming. If you haven't read the standard [Data Loading](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html) guide, please do so first.

[## To **Store** or to **Coordinate**?](https://tanstack.com/router/latest/docs/framework/react/guide/external-data-loading.html#to-store-or-to-coordinate)
...
[## What data fetching libraries are supported?](https://tanstack.com/router/latest/docs/framework/react/guide/external-data-loading.html#what-data-fetching-libraries-are-supported)
...
[## Using Loaders to ensure data is loaded](https://tanstack.com/router/latest/docs/framework/react/guide/external-data-loading.html#using-loaders-to-ensure-data-is-loaded)
...
[## A more realistic example using TanStack Query](https://tanstack.com/router/latest/docs/framework/react/guide/external-data-loading.html#a-more-realistic-example-using-tanstack-query)
...
[### Error handling with TanStack Query](https://tanstack.com/router/latest/docs/framework/react/guide/external-data-loading.html#error-handling-with-tanstack-query)
...
[## SSR Dehydration/Hydration](https://tanstack.com/router/latest/docs/framework/react/guide/external-data-loading.html#ssr-dehydrationhydration)
...
[## Critical Dehydration/Hydration](https://tanstack.com/router/latest/docs/framework/react/guide/external-data-loading.html#critical-dehydrationhydration)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/external-data-loading.md)
