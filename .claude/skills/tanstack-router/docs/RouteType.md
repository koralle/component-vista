...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType"
...
[## Route properties and methods](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html#route-properties-and-methods)

An instance of the Route has the following properties and methods:

[### .addChildren method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html#addchildren-method)
...
[### .update method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html#update-method)
...
[### .lazy method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html#lazy-method)
...
[### ...RouteApi methods](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html#routeapi-methods)

* All of the methods from [RouteApi](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiType.html) are available.

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/RouteType.md)
