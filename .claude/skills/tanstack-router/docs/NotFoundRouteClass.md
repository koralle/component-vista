---
title: "NotFoundRoute class | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundRouteClass"
...
See the [Not Found Errors guide](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html) for more information.
...
[## Constructor options](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundRouteClass.html#constructor-options)
...
[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundRouteClass.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/NotFoundRouteClass.md)
