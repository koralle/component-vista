...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useRouteContextHook"
...
[## useRouteContext options](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouteContextHook.html#useroutecontext-options)

The useRouteContext hook accepts an options object.

[### opts.from option](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouteContextHook.html#optsfrom-option)

* Type: string
* Required
* The RouteID to match the route context from.

[### opts.select option](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouteContextHook.html#optsselect-option)
...
[## useRouteContext returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouteContextHook.html#useroutecontext-returns)

* The current context for the current route or TSelected if a select function is provided.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouteContextHook.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useRouteContextHook.md)
