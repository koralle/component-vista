...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/linkOptions"
...
[## linkOptions props](https://tanstack.com/router/latest/docs/framework/react/api/router/linkOptions.html#linkoptions-props)

The linkOptions accepts the following option:

[### ...props](https://tanstack.com/router/latest/docs/framework/react/api/router/linkOptions.html#props)
...
[## linkOptions returns](https://tanstack.com/router/latest/docs/framework/react/api/router/linkOptions.html#linkoptions-returns)

An object literal with the exact type inferred from the input

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/linkOptions.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/linkOptions.md)
