---
title: "LinkOptions type | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/LinkOptionsType"
...
The LinkOptions type extends the [NavigateOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/NavigateOptionsType.html) type and contains additional options that can be used by TanStack Router when handling actual anchor element attributes.
...
[## LinkOptions properties](https://tanstack.com/router/latest/docs/framework/react/api/router/LinkOptionsType.html#linkoptions-properties)

The LinkOptions object accepts/contains the following properties:

[### target](https://tanstack.com/router/latest/docs/framework/react/api/router/LinkOptionsType.html#target)

* Type: HTMLAnchorElement['target']
* Optional
* The standard anchor tag target attribute

[### activeOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/LinkOptionsType.html#activeoptions)

* Type: ActiveOptions
* Optional
* The options that will be used to determine if the link is active

[### preload](https://tanstack.com/router/latest/docs/framework/react/api/router/LinkOptionsType.html#preload)

* Type: false | 'intent' | 'viewport' | 'render'
* Optional
* If set, the link's preloading strategy will be set to this value.
* See the [Preloading guide](https://tanstack.com/router/latest/docs/framework/react/guide/preloading.html) for more information.

[### preloadDelay](https://tanstack.com/router/latest/docs/framework/react/api/router/LinkOptionsType.html#preloaddelay)

* Type: number
* Optional
* Delay intent preloading by this many milliseconds. If the intent exits before this delay, the preload will be cancelled.

[### disabled](https://tanstack.com/router/latest/docs/framework/react/api/router/LinkOptionsType.html#disabled)

* Type: boolean
* Optional
* If true, will render the link without the href attribute

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/LinkOptionsType.md)
