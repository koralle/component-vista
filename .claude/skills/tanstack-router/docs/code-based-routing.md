...
source_url: "https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing"
...
Code-based routing is not recommended for most applications. It is recommended to use [File-Based Routing](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html) instead.

[## ⚠️ Before You Start](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html#️-before-you-start)

* If you're using [File-Based Routing](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html), **skip this guide**.
* If you still insist on using code-based routing, you must read the [Routing Concepts](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html) guide first, as it also covers core concepts of the router.

[## Route Trees](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html#route-trees)
...
Let's consider the same route tree from the [Route Trees & Nesting](https://tanstack.com/router/latest/docs/framework/react/routing/route-trees.html#route-trees) guide, and convert it to code-based routing:
...
[## Anatomy of a Route](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html#anatomy-of-a-route)
...
[## Manually building the route tree](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html#manually-building-the-route-tree)
...
[## Routing Concepts for Code-Based Routing](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html#routing-concepts-for-code-based-routing)
...
We're going to assume you've read the [Routing Concepts](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html) guide and are familiar with each of these main concepts:
...
[## The Root Route](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html#the-root-route)
...
To learn more about Context in TanStack Router, see the [Router Context](https://tanstack.com/router/latest/docs/framework/react/guide/router-context.html) guide.

[## Basic Routes](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html#basic-routes)
...
[## Index Routes](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html#index-routes)
...
[## Dynamic Route Segments](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html#dynamic-route-segments)
...
If your component is code-split, you can use the [getRouteApi function](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#manually-accessing-route-apis-in-other-files-with-the-getrouteapi-helper) to avoid having to import the postIdRoute configuration to get access to the typed useParams() hook.

[## Splat / Catch-All Routes](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html#splat--catch-all-routes)
...
[## Layout Routes](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html#layout-routes)
...
[## Pathless Layout Routes](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html#pathless-layout-routes)
...
[## Non-Nested Routes](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html#non-nested-routes)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/routing/code-based-routing.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Virtual File Routes](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html)

[File Naming Conventions](https://tanstack.com/router/latest/docs/framework/react/routing/file-naming-conventions.html)
