...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/catchBoundaryComponent"
...
[## CatchBoundary props](https://tanstack.com/router/latest/docs/framework/react/api/router/catchBoundaryComponent.html#catchboundary-props)

The CatchBoundary component accepts the following props:

[### props.getResetKey prop](https://tanstack.com/router/latest/docs/framework/react/api/router/catchBoundaryComponent.html#propsgetresetkey-prop)

* Type: () => string
* Required
* A function that returns a string that will be used to reset the component's state when the key changes.

[### props.children prop](https://tanstack.com/router/latest/docs/framework/react/api/router/catchBoundaryComponent.html#propschildren-prop)

* Type: React.ReactNode
* Required
* The component's children to render when there is no error

[### props.errorComponent prop](https://tanstack.com/router/latest/docs/framework/react/api/router/catchBoundaryComponent.html#propserrorcomponent-prop)

* Type: React.ReactNode
* Optional - [default: ErrorComponent](https://tanstack.com/router/latest/docs/framework/react/api/router/errorComponentComponent.html)
* The component to render when there is an error.

[### props.onCatch prop](https://tanstack.com/router/latest/docs/framework/react/api/router/catchBoundaryComponent.html#propsoncatch-prop)

* Type: (error: any) => void
* Optional
* A callback that will be called with the error that was thrown by the component's children.

[## CatchBoundary returns](https://tanstack.com/router/latest/docs/framework/react/api/router/catchBoundaryComponent.html#catchboundary-returns)

* Returns the component's children if there is no error.
* Returns the errorComponent if there is an error.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/catchBoundaryComponent.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/catchBoundaryComponent.md)
