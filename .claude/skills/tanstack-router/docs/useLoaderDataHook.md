...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDataHook"
...
The useLoaderData hook returns the loader data from the closest [RouteMatch](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMatchType.html) in the component tree.

[## useLoaderData options](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDataHook.html#useloaderdata-options)

The useLoaderData hook accepts an options object.

[### opts.from option](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDataHook.html#optsfrom-option)
...
[### opts.strict option](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDataHook.html#optsstrict-option)
...
[### opts.select option](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDataHook.html#optsselect-option)
...
[### opts.structuralSharing option](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDataHook.html#optsstructuralsharing-option)
...
[## useLoaderData returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDataHook.html#useloaderdata-returns)
...
[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useLoaderDataHook.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useLoaderDataHook.md)
