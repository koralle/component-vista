---
title: "createFileRoute function | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/createFileRouteFunction"
...
[## createFileRoute options](https://tanstack.com/router/latest/docs/framework/react/api/router/createFileRouteFunction.html#createfileroute-options)
...
[### path option](https://tanstack.com/router/latest/docs/framework/react/api/router/createFileRouteFunction.html#path-option)
...
[## createFileRoute returns](https://tanstack.com/router/latest/docs/framework/react/api/router/createFileRouteFunction.html#createfileroute-returns)

A new function that accepts a single argument of type [RouteOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html) that will be used to configure the file [Route](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html) instance.
...
[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/createFileRouteFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/createFileRouteFunction.md)
