...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/render-optimizations"
...
[## structural sharing](https://tanstack.com/router/latest/docs/framework/react/guide/render-optimizations.html#structural-sharing)
...
[## fine-grained selectors](https://tanstack.com/router/latest/docs/framework/react/guide/render-optimizations.html#fine-grained-selectors)
...
[### structural sharing with fine-grained selectors](https://tanstack.com/router/latest/docs/framework/react/guide/render-optimizations.html#structural-sharing-with-fine-grained-selectors)
...
[#### Enable it by default in the router options:](https://tanstack.com/router/latest/docs/framework/react/guide/render-optimizations.html#enable-it-by-default-in-the-router-options)
...
[#### Enable it per hook usage as shown here:](https://tanstack.com/router/latest/docs/framework/react/guide/render-optimizations.html#enable-it-per-hook-usage-as-shown-here)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/render-optimizations.md)
