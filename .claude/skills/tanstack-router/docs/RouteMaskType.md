...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMaskType"
...
The RouteMask type extends the [ToOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/ToOptionsType.html) type and has other the necessary properties to create a route mask.

[## RouteMask properties](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMaskType.html#routemask-properties)

The RouteMask type accepts an object with the following properties:

[### ...ToOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMaskType.html#tooptions)

* Type: [ToOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/ToOptionsType.html)
* Required
* The options that will be used to configure the route mask

[### options.routeTree](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMaskType.html#optionsroutetree)

* Type: TRouteTree
* Required
* The route tree that this route mask will support

[### options.unmaskOnReload](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMaskType.html#optionsunmaskonreload)

* Type: boolean
* Optional
* If true, the route mask will be removed when the page is reloaded

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/RouteMaskType.md)
