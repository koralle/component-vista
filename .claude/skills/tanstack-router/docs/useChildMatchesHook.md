...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useChildMatchesHook"
...
The useChildMatches hook returns all of the child [RouteMatch](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMatchType.html) objects from the closest match down to the leaf-most match. **It does not include the current match, which can be obtained using the useMatch hook.**
...
[## useChildMatches options](https://tanstack.com/router/latest/docs/framework/react/api/router/useChildMatchesHook.html#usechildmatches-options)

The useChildMatches hook accepts a single *optional* argument, an options object.

[### opts.select option](https://tanstack.com/router/latest/docs/framework/react/api/router/useChildMatchesHook.html#optsselect-option)
...
[### opts.structuralSharing option](https://tanstack.com/router/latest/docs/framework/react/api/router/useChildMatchesHook.html#optsstructuralsharing-option)
...
[## useChildMatches returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useChildMatchesHook.html#usechildmatches-returns)
...
[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useChildMatchesHook.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useChildMatchesHook.md)
