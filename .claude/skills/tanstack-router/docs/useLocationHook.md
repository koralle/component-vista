...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useLocationHook"
...
The useLocation method is a hook that returns the current [location](https://tanstack.com/router/latest/docs/framework/react/api/router/ParsedLocationType.html) object. This hook is useful for when you want to perform some side effect whenever the current location changes.

[## useLocation options](https://tanstack.com/router/latest/docs/framework/react/api/router/useLocationHook.html#uselocation-options)

The useLocation hook accepts an optional options object.

[### opts.select option](https://tanstack.com/router/latest/docs/framework/react/api/router/useLocationHook.html#optsselect-option)

* Type: (state: ParsedLocationType) => TSelected
* Optional
* If supplied, this function will be called with the [location](https://tanstack.com/router/latest/docs/framework/react/api/router/ParsedLocationType.html) object and the return value will be returned from useLocation.

[## useLocation returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useLocationHook.html#uselocation-returns)

* The current [location](https://tanstack.com/router/latest/docs/framework/react/api/router/ParsedLocationType.html) object or TSelected if a select function is provided.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useLocationHook.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useLocationHook.md)
