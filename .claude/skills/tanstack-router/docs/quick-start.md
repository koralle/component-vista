...
source_url: "https://tanstack.com/router/latest/docs/framework/react/quick-start"
...
[## Impatient?](https://tanstack.com/router/latest/docs/framework/react/quick-start.html#impatient)
...
[## Routing Options](https://tanstack.com/router/latest/docs/framework/react/quick-start.html#routing-options)
...
[### File-Based Route Generation](https://tanstack.com/router/latest/docs/framework/react/quick-start.html#file-based-route-generation)
...
[### Code-Based Route Configuration](https://tanstack.com/router/latest/docs/framework/react/quick-start.html#code-based-route-configuration)
...
[## Existing Project](https://tanstack.com/router/latest/docs/framework/react/quick-start.html#existing-project)

If you have an existing React project and want to add TanStack Router to it, you can install it manually.

[### Requirements](https://tanstack.com/router/latest/docs/framework/react/quick-start.html#requirements)
...
[### Installation](https://tanstack.com/router/latest/docs/framework/react/quick-start.html#installation)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/quick-start.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Overview](https://tanstack.com/router/latest/docs.html)
