...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/isRedirectFunction"
...
[## isRedirect options](https://tanstack.com/router/latest/docs/framework/react/api/router/isRedirectFunction.html#isredirect-options)

The isRedirect function accepts a single argument, an input.

[#### input](https://tanstack.com/router/latest/docs/framework/react/api/router/isRedirectFunction.html#input)

* Type: unknown
* Required
* An object to check if it is a redirect object

[## isRedirect returns](https://tanstack.com/router/latest/docs/framework/react/api/router/isRedirectFunction.html#isredirect-returns)

* Type: boolean
* true if the object is a redirect object
* false if the object is not a redirect object

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/isRedirectFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/isRedirectFunction.md)
