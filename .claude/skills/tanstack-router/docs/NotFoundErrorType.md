---
title: "NotFoundError | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundErrorType"
...
[## NotFoundError properties](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundErrorType.html#notfounderror-properties)

The NotFoundError object accepts/contains the following properties:

[### global property (⚠️ deprecated, use routeId: rootRouteId instead)](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundErrorType.html#global-property-️-deprecated-use-routeid-rootrouteid-instead)
...
[### data property](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundErrorType.html#data-property)

* Type: any
* Optional
* Custom data that is passed into to notFoundComponent when the not-found error is handled

[### throw property](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundErrorType.html#throw-property)
...
[### route property](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundErrorType.html#route-property)
...
[### headers property](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundErrorType.html#headers-property)

* Type: HeadersInit
* Optional
* HTTP headers to be included when the not-found error is handled on the server side.

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/NotFoundErrorType.md)
