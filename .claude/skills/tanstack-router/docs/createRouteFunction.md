...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/createRouteFunction"
...
The createRoute function implements returns a [Route](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html) instance. A route instance can then be passed to a root route's children to create a route tree, which is then passed to the router.

[## createRoute options](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouteFunction.html#createroute-options)

* Type: [RouteOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html)
* Required
* The options that will be used to configure the route instance

[## createRoute returns](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouteFunction.html#createroute-returns)

A new [Route](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html) instance.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouteFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/createRouteFunction.md)
