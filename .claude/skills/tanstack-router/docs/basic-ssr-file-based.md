---
title: "React TanStack Router Basic Ssr File Based Example | TanStack Router Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/examples/basic-ssr-file-based"
...
# React Example: Basic Ssr File Based [Deploy to Cloudflare](https://deploy.workers.cloudflare.com/?url=https://github.com/tanstack/router/tree/main/examples/react/basic-ssr-file-based)[Deploy with Netlify](https://app.netlify.com/start/deploy?repository=https://github.com/tanstack/router&create_from_path=examples/react/basic-ssr-file-based) [Github](https://github.com/tanstack/router/tree/main/examples/react/basic-ssr-file-based) [StackBlitz](https://stackblitz.com/github/tanstack/router/tree/main/examples/react/basic-ssr-file-based?embed=1&theme=dark&preset=node&file=src/routes/__root.tsx)
...
[Basic + React Query (code-based)](https://tanstack.com/router/latest/docs/framework/react/examples/basic-react-query.html)

[Basic + SSR Streaming (file-based)](https://tanstack.com/router/latest/docs/framework/react/examples/basic-ssr-streaming-file-based.html)
