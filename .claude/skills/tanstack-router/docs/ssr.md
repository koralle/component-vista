...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/ssr"
...
[## Non-Streaming SSR](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html#non-streaming-ssr)
...
[### Automatic Server History](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html#automatic-server-history)
...
[### Automatic Loader Dehydration/Hydration](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html#automatic-loader-dehydrationhydration)
...
⚠️ If you are using deferred data streaming, you will also need to ensure that you have implemented the [SSR Streaming & Stream Transform](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html#streaming-ssr) pattern near the end of this guide.

For more information on how to utilize data loading, see the [Data Loading](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html) guide.

[### Router Creation](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html#router-creation)
...
[### Rendering the Application on the Server](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html#rendering-the-application-on-the-server)
...
[## Rendering the Application on the Client](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html#rendering-the-application-on-the-client)
...
[## Streaming SSR](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html#streaming-ssr)
...
[## Streaming Dehydration/Hydration](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html#streaming-dehydrationhydration)
...
[## Data Serialization](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html#data-serialization)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/ssr.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Static Route Data](https://tanstack.com/router/latest/docs/framework/react/guide/static-route-data.html)
