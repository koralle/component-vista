...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook"
...
The useMatch hook returns a [RouteMatch](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMatchType.html) in the component tree. The raw route match contains all of the information about a route match in the router and also powers many other hooks under the hood like useParams, useLoaderData, useRouteContext, and useSearch.

[## useMatch options](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook.html#usematch-options)

The useMatch hook accepts a single argument, an options object.

[### opts.from option](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook.html#optsfrom-option)
...
* If opts.strict is false, from must not be set and TypeScript will provided loosened types for the returned [RouteMatch](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMatchType.html).

[### opts.strict option](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook.html#optsstrict-option)
...
[### opts.select option](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook.html#optsselect-option)
...
[### opts.structuralSharing option](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook.html#optsstructuralsharing-option)
...
[### opts.shouldThrow option](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook.html#optsshouldthrow-option)
...
[## useMatch returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook.html#usematch-returns)

* If a select function is provided, the return value of the select function.
* If no select function is provided, the [RouteMatch](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMatchType.html) object or a loosened version of the RouteMatch object if opts.strict is false.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook.html#examples)
[### Accessing a route match](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook.html#accessing-a-route-match)
...
[### Accessing the root route's match](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook.html#accessing-the-root-routes-match)
...
[### Checking if a specific route is currently rendered](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchHook.html#checking-if-a-specific-route-is-currently-rendered)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useMatchHook.md)
