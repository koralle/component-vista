---
title: "useRouter hook | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useRouterHook"
...
The useRouter method is a hook that returns the current instance of [Router](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html) from context. This hook is useful for accessing the router instance in a component.

[## useRouter returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouterHook.html#userouter-returns)

* The current [Router](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html) instance.
...
[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouterHook.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useRouterHook.md)
