...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/createLazyRouteFunction"
...
The createLazyRoute function is used for creating a partial code-based route route instance that is lazily loaded when matched. This route instance can only be used to configure the [non-critical properties](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#how-does-tanstack-router-split-code) of the route, such as component, pendingComponent, errorComponent, and the notFoundComponent.

[## createLazyRoute options](https://tanstack.com/router/latest/docs/framework/react/api/router/createLazyRouteFunction.html#createlazyroute-options)

The createLazyRoute function accepts a single argument of type string that represents the id of the route.

[### id](https://tanstack.com/router/latest/docs/framework/react/api/router/createLazyRouteFunction.html#id)

* Type: string
* Required
* The route id of the route.

[### createLazyRoute returns](https://tanstack.com/router/latest/docs/framework/react/api/router/createLazyRouteFunction.html#createlazyroute-returns)
...
[### Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/createLazyRouteFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/createLazyRouteFunction.md)
