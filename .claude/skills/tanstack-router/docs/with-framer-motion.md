---
title: "React TanStack Router With Framer Motion Example | TanStack Router Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/examples/with-framer-motion"
...
# React Example: With Framer Motion [Deploy to Cloudflare](https://deploy.workers.cloudflare.com/?url=https://github.com/tanstack/router/tree/main/examples/react/with-framer-motion)[Deploy with Netlify](https://app.netlify.com/start/deploy?repository=https://github.com/tanstack/router&create_from_path=examples/react/with-framer-motion) [Github](https://github.com/tanstack/router/tree/main/examples/react/with-framer-motion) [StackBlitz](https://stackblitz.com/github/tanstack/router/tree/main/examples/react/with-framer-motion?embed=1&theme=dark&preset=node&file=src/routes/__root.tsx)
