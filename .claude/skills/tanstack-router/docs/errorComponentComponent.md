---
title: "ErrorComponent component | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/errorComponentComponent"
...
[## ErrorComponent props](https://tanstack.com/router/latest/docs/framework/react/api/router/errorComponentComponent.html#errorcomponent-props)

The ErrorComponent component accepts the following props:

[### props.error prop](https://tanstack.com/router/latest/docs/framework/react/api/router/errorComponentComponent.html#propserror-prop)

* Type: TError (defaults to Error)
* The error that was thrown by the component's children

[### props.info prop](https://tanstack.com/router/latest/docs/framework/react/api/router/errorComponentComponent.html#propsinfo-prop)
...
[### props.reset prop](https://tanstack.com/router/latest/docs/framework/react/api/router/errorComponentComponent.html#propsreset-prop)

* Type: () => void
* A function to programmatically reset the error state

[## ErrorComponent returns](https://tanstack.com/router/latest/docs/framework/react/api/router/errorComponentComponent.html#errorcomponent-returns)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/errorComponentComponent.md)
