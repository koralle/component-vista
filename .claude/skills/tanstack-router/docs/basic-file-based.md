---
title: "React TanStack Router Basic File Based Example | TanStack Router Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/examples/basic-file-based"
...
# React Example: Basic File Based [Deploy to Cloudflare](https://deploy.workers.cloudflare.com/?url=https://github.com/tanstack/router/tree/main/examples/react/basic-file-based)[Deploy with Netlify](https://app.netlify.com/start/deploy?repository=https://github.com/tanstack/router&create_from_path=examples/react/basic-file-based) [Github](https://github.com/tanstack/router/tree/main/examples/react/basic-file-based) [StackBlitz](https://stackblitz.com/github/tanstack/router/tree/main/examples/react/basic-file-based?embed=1&theme=dark&preset=node&file=src/routes/__root.tsx)
