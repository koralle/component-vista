...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/createRouterFunction"
...
The createRouter function accepts a [RouterOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterOptionsType.html) object and creates a new [Router](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterClass.html) instance.

[## createRouter options](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouterFunction.html#createrouter-options)

* Type: [RouterOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterOptionsType.html)
* Required
* The options that will be used to configure the router instance.

[## createRouter returns](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouterFunction.html#createrouter-returns)

* An instance of the [Router](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html).

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouterFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/createRouterFunction.md)
