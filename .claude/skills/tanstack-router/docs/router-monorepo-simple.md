---
title: "React TanStack Router Router Monorepo Simple Example | TanStack Router Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/examples/router-monorepo-simple"
...
# React Example: Router Monorepo Simple [Deploy to Cloudflare](https://deploy.workers.cloudflare.com/?url=https://github.com/tanstack/router/tree/main/examples/react/router-monorepo-simple)[Deploy with Netlify](https://app.netlify.com/start/deploy?repository=https://github.com/tanstack/router&create_from_path=examples/react/router-monorepo-simple) [Github](https://github.com/tanstack/router/tree/main/examples/react/router-monorepo-simple) [StackBlitz](https://stackblitz.com/github/tanstack/router/tree/main/examples/react/router-monorepo-simple?embed=1&theme=dark&preset=node&file=src/routes/__root.tsx)
...
[Monorepo basic (with lazy loading)](https://tanstack.com/router/latest/docs/framework/react/examples/router-monorepo-simple-lazy.html)
