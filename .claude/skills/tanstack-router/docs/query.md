---
title: "TanStack Query Integration | TanStack Router Docs"
source_url: "https://tanstack.com/router/latest/docs/integrations/query"
...
This integration automates SSR dehydration/hydration and streaming between TanStack Router and TanStack Query. If you haven't read the standard [External Data Loading](https://tanstack.com/router/latest/docs/framework/react/guide/external-data-loading.html) guide, start there.

[## What you get](https://tanstack.com/router/latest/docs/integrations/query.html#what-you-get)
...
[## Installation](https://tanstack.com/router/latest/docs/integrations/query.html#installation)
...
[## Setup](https://tanstack.com/router/latest/docs/integrations/query.html#setup)
...
[## SSR behavior and streaming](https://tanstack.com/router/latest/docs/integrations/query.html#ssr-behavior-and-streaming)
...
[## Use in routes](https://tanstack.com/router/latest/docs/integrations/query.html#use-in-routes)
[### Using useSuspenseQuery vs useQuery](https://tanstack.com/router/latest/docs/integrations/query.html#using-usesuspensequery-vs-usequery)
...
[### Preload with a loader and read with a hook](https://tanstack.com/router/latest/docs/integrations/query.html#preload-with-a-loader-and-read-with-a-hook)
...
[### Prefetching and streaming](https://tanstack.com/router/latest/docs/integrations/query.html#prefetching-and-streaming)
...
[## Redirect handling](https://tanstack.com/router/latest/docs/integrations/query.html#redirect-handling)
...
[## Works with TanStack Start](https://tanstack.com/router/latest/docs/integrations/query.html#works-with-tanstack-start)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/integrations/query.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Router](https://tanstack.com/router/latest/docs/framework/react/api/router.html)

[ESLint Plugin Router](https://tanstack.com/router/latest/docs/eslint/eslint-plugin-router.html)
