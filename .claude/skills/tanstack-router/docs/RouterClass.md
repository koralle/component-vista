---
title: "Router Class | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/RouterClass"
...
Please use the [createRouter](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouterFunction.html) function instead.

The Router class is used to instantiate a new router instance.

[## Router constructor](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterClass.html#router-constructor)

The Router constructor accepts a single argument: the options that will be used to configure the router instance.

[### Constructor options](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterClass.html#constructor-options)
...
[### Constructor returns](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterClass.html#constructor-returns)

* An instance of the [Router](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html).

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterClass.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/RouterClass.md)
