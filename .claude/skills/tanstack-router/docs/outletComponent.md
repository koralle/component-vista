...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/outletComponent"
...
[## Outlet props](https://tanstack.com/router/latest/docs/framework/react/api/router/outletComponent.html#outlet-props)

The Outlet component does not accept any props.

[## Outlet returns](https://tanstack.com/router/latest/docs/framework/react/api/router/outletComponent.html#outlet-returns)

* If matched, the child route match's component/errorComponent/pendingComponent/notFoundComponent.
* If not matched, null.

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/outletComponent.md)
