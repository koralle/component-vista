...
source_url: "https://tanstack.com/router/latest/docs/framework/react/routing/route-trees"
...
[## Route Trees](https://tanstack.com/router/latest/docs/framework/react/routing/route-trees.html#route-trees)
...
[## Route Tree Configuration](https://tanstack.com/router/latest/docs/framework/react/routing/route-trees.html#route-tree-configuration)

Route trees can be configured using a few different ways:

* [Flat Routes](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html#flat-routes)
* [Directories](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html#directory-routes)
* [Mixed Flat Routes and Directories](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html#mixed-flat-and-directory-routes)
* [Virtual File Routes](https://tanstack.com/router/latest/docs/framework/react/routing/virtual-file-routes.html)
* [Code-Based Routes](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/routing/route-trees.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Routing Concepts](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html)

[Route Matching](https://tanstack.com/router/latest/docs/framework/react/routing/route-matching.html)
