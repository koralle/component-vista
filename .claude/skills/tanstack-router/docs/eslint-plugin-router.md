---
title: "ESLint Plugin Router | TanStack Router Docs"
source_url: "https://tanstack.com/router/latest/docs/eslint/eslint-plugin-router"
...
[## Installation](https://tanstack.com/router/latest/docs/eslint/eslint-plugin-router.html#installation)
...
[## Flat Config (eslint.config.js)](https://tanstack.com/router/latest/docs/eslint/eslint-plugin-router.html#flat-config-eslintconfigjs)
...
[### Recommended Flat Config setup](https://tanstack.com/router/latest/docs/eslint/eslint-plugin-router.html#recommended-flat-config-setup)
...
[### Custom Flat Config setup](https://tanstack.com/router/latest/docs/eslint/eslint-plugin-router.html#custom-flat-config-setup)
...
[## Legacy Config (.eslintrc)](https://tanstack.com/router/latest/docs/eslint/eslint-plugin-router.html#legacy-config-eslintrc)
...
[### Recommended Legacy Config setup](https://tanstack.com/router/latest/docs/eslint/eslint-plugin-router.html#recommended-legacy-config-setup)
...
[### Custom Legacy Config setup](https://tanstack.com/router/latest/docs/eslint/eslint-plugin-router.html#custom-legacy-config-setup)
...
[## Rules](https://tanstack.com/router/latest/docs/eslint/eslint-plugin-router.html#rules)

The following rules are available in the TanStack Router ESLint Plugin:

* [@tanstack/router/create-route-property-order](https://tanstack.com/router/latest/docs/eslint/create-route-property-order.html)

[## Conflicts with other ESLint plugins](https://tanstack.com/router/latest/docs/eslint/eslint-plugin-router.html#conflicts-with-other-eslint-plugins)
...
[### typescript-eslint](https://tanstack.com/router/latest/docs/eslint/eslint-plugin-router.html#typescript-eslint)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/eslint/eslint-plugin-router.md)
