...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/isNotFoundFunction"
...
The isNotFound function can be used to determine if an object is a [NotFoundError](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundErrorType.html) object.

[## isNotFound options](https://tanstack.com/router/latest/docs/framework/react/api/router/isNotFoundFunction.html#isnotfound-options)

The isNotFound function accepts a single argument, an input.

[### input option](https://tanstack.com/router/latest/docs/framework/react/api/router/isNotFoundFunction.html#input-option)

* Type: unknown
* Required
* An object to check if it is a [NotFoundError](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundErrorType.html).

[## isNotFound returns](https://tanstack.com/router/latest/docs/framework/react/api/router/isNotFoundFunction.html#isnotfound-returns)

* Type: boolean
* true if the object is a [NotFoundError](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundErrorType.html).
* false if the object is not a [NotFoundError](https://tanstack.com/router/latest/docs/framework/react/api/router/NotFoundErrorType.html).

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/isNotFoundFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/isNotFoundFunction.md)
