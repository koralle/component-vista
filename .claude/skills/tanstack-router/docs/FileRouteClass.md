...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/FileRouteClass"
...
Please use the [createFileRoute](https://tanstack.com/router/latest/docs/framework/react/api/router/createFileRouteFunction.html) function instead.
...
[## FileRoute constructor](https://tanstack.com/router/latest/docs/framework/react/api/router/FileRouteClass.html#fileroute-constructor)

The FileRoute constructor accepts a single argument: the path of the file that the route will be generated for.

[### Constructor options](https://tanstack.com/router/latest/docs/framework/react/api/router/FileRouteClass.html#constructor-options)
...
[### Constructor returns](https://tanstack.com/router/latest/docs/framework/react/api/router/FileRouteClass.html#constructor-returns)

* An instance of the FileRoute class that can be used to create a route.

[## FileRoute methods](https://tanstack.com/router/latest/docs/framework/react/api/router/FileRouteClass.html#fileroute-methods)

The FileRoute class implements the following method(s):

[### .createRoute method](https://tanstack.com/router/latest/docs/framework/react/api/router/FileRouteClass.html#createroute-method)
...
[#### .createRoute options](https://tanstack.com/router/latest/docs/framework/react/api/router/FileRouteClass.html#createroute-options)

* Type: Omit<RouteOptions, 'getParentRoute' | 'path' | 'id'>
* [RouteOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html)
* Optional
...
[#### .createRoute returns](https://tanstack.com/router/latest/docs/framework/react/api/router/FileRouteClass.html#createroute-returns)

A [Route](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html) instance that can be used to configure the route to be inserted into the route-tree.
...
[### Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/FileRouteClass.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/FileRouteClass.md)
