...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/router-context"
...
[## Typed Router Context](https://tanstack.com/router/latest/docs/framework/react/guide/router-context.html#typed-router-context)
...
[## Passing the initial Router Context](https://tanstack.com/router/latest/docs/framework/react/guide/router-context.html#passing-the-initial-router-context)
...
[### Invalidating the Router Context](https://tanstack.com/router/latest/docs/framework/react/guide/router-context.html#invalidating-the-router-context)
...
[## Using the Router Context](https://tanstack.com/router/latest/docs/framework/react/guide/router-context.html#using-the-router-context)
...
[### How about an external data fetching library?](https://tanstack.com/router/latest/docs/framework/react/guide/router-context.html#how-about-an-external-data-fetching-library)
...
[## How about using React Context/Hooks?](https://tanstack.com/router/latest/docs/framework/react/guide/router-context.html#how-about-using-react-contexthooks)
...
[## Modifying the Router Context](https://tanstack.com/router/latest/docs/framework/react/guide/router-context.html#modifying-the-router-context)
...
[## Processing Accumulated Route Context](https://tanstack.com/router/latest/docs/framework/react/guide/router-context.html#processing-accumulated-route-context)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/router-context.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[History Types](https://tanstack.com/router/latest/docs/framework/react/guide/history-types.html)

[Not Found Errors](https://tanstack.com/router/latest/docs/framework/react/guide/not-found-errors.html)
