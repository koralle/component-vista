...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook"
...
The useBlocker method is a hook that [blocks navigation](https://tanstack.com/router/latest/docs/framework/react/guide/navigation-blocking.html) when a condition is met.

> ⚠️ The following new useBlocker API is currently *experimental*.

[## useBlocker options](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#useblocker-options)

The useBlocker hook accepts a single *required* argument, an option object:

[### options.shouldBlockFn option](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#optionsshouldblockfn-option)
...
[### options.disabled option](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#optionsdisabled-option)

* Optional - defaults to false
* Type: boolean
* Specifies if the blocker should be entirely disabled or not

[### options.enableBeforeUnload option](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#optionsenablebeforeunload-option)

* Optional - defaults to true
* Type: boolean | (() => boolean)
* Tell the blocker to sometimes or always block the browser beforeUnload event or not

[### options.withResolver option](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#optionswithresolver-option)
...
[### options.blockerFn option (⚠️ deprecated)](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#optionsblockerfn-option-️-deprecated)

* Optional
* Type: BlockerFn
* The function that returns a boolean or Promise<boolean> indicating whether to allow navigation.

[### options.condition option (⚠️ deprecated)](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#optionscondition-option-️-deprecated)

* Optional - defaults to true
* Type: boolean
* A navigation attempt is blocked when this condition is true.

[## useBlocker returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#useblocker-returns)
...
[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#examples)

Two common use cases for the useBlocker hook are:

[### Basic usage](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#basic-usage)
...
[### Custom UI](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#custom-ui)
...
[### Conditional blocking](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#conditional-blocking)
...
[### Without resolver](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#without-resolver)
...
[### Type narrowing](https://tanstack.com/router/latest/docs/framework/react/api/router/useBlockerHook.html#type-narrowing)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useBlockerHook.md)
