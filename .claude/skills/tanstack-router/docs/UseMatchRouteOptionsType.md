...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/UseMatchRouteOptionsType"
...
The UseMatchRouteOptions type extends the [ToOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/ToOptionsType.html) type and describes additional options available when using the [useMatchRoute](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchRouteHook.html) hook.
...
* [MatchRouteOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/MatchRouteOptionsType.html)

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/UseMatchRouteOptionsType.md)
