...
source_url: "https://tanstack.com/router/latest/docs/framework/react/installation/with-router-cli"
...
You shouldn't forget to *ignore* the generated route tree file. Head over to the [Ignoring the generated route tree file](https://tanstack.com/router/latest/docs/framework/react/installation/with-router-cli.html#ignoring-the-generated-route-tree-file) section to learn more.

With the CLI installed, the following commands are made available via the tsr command

[## Using the generate command](https://tanstack.com/router/latest/docs/framework/react/installation/with-router-cli.html#using-the-generate-command)
...
[## Using the watch command](https://tanstack.com/router/latest/docs/framework/react/installation/with-router-cli.html#using-the-watch-command)
...
[## Ignoring the generated route tree file](https://tanstack.com/router/latest/docs/framework/react/installation/with-router-cli.html#ignoring-the-generated-route-tree-file)
...
[## Configuration](https://tanstack.com/router/latest/docs/framework/react/installation/with-router-cli.html#configuration)
...
You can find all the available configuration options in the [File-based Routing API Reference](https://tanstack.com/router/latest/docs/api/file-based-routing.html).

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/installation/with-router-cli.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Esbuild](https://tanstack.com/router/latest/docs/framework/react/installation/with-esbuild.html)
