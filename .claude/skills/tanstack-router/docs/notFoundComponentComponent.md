---
title: "NotFoundComponent component | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/notFoundComponentComponent"
...
[## NotFoundComponent props](https://tanstack.com/router/latest/docs/framework/react/api/router/notFoundComponentComponent.html#notfoundcomponent-props)

The NotFoundComponent component accepts the following props:

[### props.data prop](https://tanstack.com/router/latest/docs/framework/react/api/router/notFoundComponentComponent.html#propsdata-prop)
...
[### props.isNotFound prop](https://tanstack.com/router/latest/docs/framework/react/api/router/notFoundComponentComponent.html#propsisnotfound-prop)
...
[### props.routeId prop](https://tanstack.com/router/latest/docs/framework/react/api/router/notFoundComponentComponent.html#propsrouteid-prop)
...
[## NotFoundComponent returns](https://tanstack.com/router/latest/docs/framework/react/api/router/notFoundComponentComponent.html#notfoundcomponent-returns)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/notFoundComponentComponent.md)
