...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/route-masking"
...
Each of these scenarios can be achieved with route masking and even extended to support more advanced patterns like [parallel routes](https://tanstack.com/router/latest/docs/framework/react/guide/parallel-routes.html).

[## How does route masking work?](https://tanstack.com/router/latest/docs/framework/react/guide/route-masking.html#how-does-route-masking-work)

Important

You **do not** need to understand how route masking works in order to use it. This section is for those who are curious about how it works under the hood. Skip to [How do I use route masking?](https://tanstack.com/router/latest/docs/framework/react/guide/route-masking.html#how-do-i-use-route-masking) to learn how to use it!.
...
[## How do I use route masking?](https://tanstack.com/router/latest/docs/framework/react/guide/route-masking.html#how-do-i-use-route-masking)
...
[### Imperative route masking](https://tanstack.com/router/latest/docs/framework/react/guide/route-masking.html#imperative-route-masking)
...
[### Declarative route masking](https://tanstack.com/router/latest/docs/framework/react/guide/route-masking.html#declarative-route-masking)
...
[## Unmasking when sharing the URL](https://tanstack.com/router/latest/docs/framework/react/guide/route-masking.html#unmasking-when-sharing-the-url)
...
[## Local Unmasking Defaults](https://tanstack.com/router/latest/docs/framework/react/guide/route-masking.html#local-unmasking-defaults)
...
[## Unmasking on page reload](https://tanstack.com/router/latest/docs/framework/react/guide/route-masking.html#unmasking-on-page-reload)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/route-masking.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Document Head Management](https://tanstack.com/router/latest/docs/framework/react/guide/document-head-management.html)

[Navigation Blocking](https://tanstack.com/router/latest/docs/framework/react/guide/navigation-blocking.html)
