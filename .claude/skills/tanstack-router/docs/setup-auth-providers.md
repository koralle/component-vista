---
title: "How to Set Up Authentication Providers | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers"
...
[## Quick Start](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#quick-start)
...
[## Auth0 Integration](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#auth0-integration)
[### 1. Install Auth0](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#1-install-auth0)
...
[### 2. Set Up Environment Variables](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#2-set-up-environment-variables)
...
[### 3. Create Auth0 Wrapper](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#3-create-auth0-wrapper)
...
[### 4. Update App Configuration](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#4-update-app-configuration)
...
[### 5. Create Protected Routes](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#5-create-protected-routes)
...
[## Clerk Integration](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#clerk-integration)
[### 1. Install Clerk](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#1-install-clerk)
...
[### 2. Set Up Environment Variables](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#2-set-up-environment-variables-1)
...
[### 3. Create Clerk Wrapper](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#3-create-clerk-wrapper)
...
[### 4. Create Clerk Auth Routes](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#4-create-clerk-auth-routes)
...
[### 5. Update App Configuration](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#5-update-app-configuration)
...
[### 6. Create Protected Routes](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#6-create-protected-routes)
...
[## Supabase Integration](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#supabase-integration)
[### 1. Install Supabase](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#1-install-supabase)
...
[### 2. Set Up Environment Variables](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#2-set-up-environment-variables-2)
...
[### 3. Create Supabase Client](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#3-create-supabase-client)
...
[### 4. Create Login Component](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#4-create-login-component)
...
[### 5. Update App Configuration](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#5-update-app-configuration-1)
...
[## Provider Comparison](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#provider-comparison)
...
[### When to Choose Each:](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#when-to-choose-each)
...
[## Common Problems](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#common-problems)
[### Provider Context Not Available](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#provider-context-not-available)
...
[### Infinite Loading States](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#infinite-loading-states)
...
[### Redirect Loops with Auth0](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#redirect-loops-with-auth0)
...
[## Common Next Steps](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#common-next-steps)

After integrating authentication providers, you might want to:

* [How to Set Up Role-Based Access Control](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html) - Add permission-based routing
* [How to Set Up Basic Authentication](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html) - Custom auth implementation

[## Related Resources](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html#related-resources)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/how-to/setup-auth-providers.md)
