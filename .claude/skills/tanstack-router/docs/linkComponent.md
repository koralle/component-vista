---
title: "Link component | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/linkComponent"
...
[## Link props](https://tanstack.com/router/latest/docs/framework/react/api/router/linkComponent.html#link-props)

The Link component accepts the following props:

[### ...props](https://tanstack.com/router/latest/docs/framework/react/api/router/linkComponent.html#props)

* Type: LinkProps & React.RefAttributes<HTMLAnchorElement>
* [LinkProps](https://tanstack.com/router/latest/docs/framework/react/api/router/LinkPropsType.html)

[## Link returns](https://tanstack.com/router/latest/docs/framework/react/api/router/linkComponent.html#link-returns)

An anchor element that can be used to navigate to a new location.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/linkComponent.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/linkComponent.md)
