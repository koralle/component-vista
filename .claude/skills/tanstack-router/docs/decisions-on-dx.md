...
source_url: "https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx"
...
[## TanStack Router's origin story](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html#tanstack-routers-origin-story)

It's important to remember that TanStack Router's origins stem from [Nozzle.io](https://nozzle.io)'s need for a client-side routing solution that offered a first-in-class *URL Search Parameters* experience without compromising on the ***type-safety*** that was required to power its complex dashboards.
...
[## How does TanStack Router achieve this?](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html#how-does-tanstack-router-achieve-this)
...
1. [**Route configuration boilerplate?**](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html#why-is-the-routers-configuration-done-this-way): You have to define your routes in a way that allows TypeScript to infer the types of your routes as much as possible.
2. [**TypeScript module declaration for the router?**](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html#declaring-the-router-instance-for-type-inference): You have to pass the Router instance to the rest of your application using TypeScript's module declaration.
3. [**Why push for file-based routing over code-based?**](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html#why-is-file-based-routing-the-preferred-way-to-define-routes): We push for file-based routing as the preferred way to define your routes.
...
[## Why is the Router's configuration done this way?](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html#why-is-the-routers-configuration-done-this-way)
...
You can read more about [code-based routing](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html) to see how to define your routes in this way.

Tip

Finding Code-based routing to be a bit too cumbersome? See why [file-based routing](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html#why-is-file-based-routing-the-preferred-way-to-define-routes) is the preferred way to define your routes.

[## Declaring the Router instance for type inference](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html#declaring-the-router-instance-for-type-inference)
...
[## Why is file-based routing the preferred way to define routes?](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html#why-is-file-based-routing-the-preferred-way-to-define-routes)
...
Before you continue, it's important you have a good understanding of [code-based routing](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html) and [file-based routing](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html).
...
Check out the guides for [file-based routing](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html) and [code-splitting](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html) for a more in-depth explanation of how they work in TanStack Router.

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/decisions-on-dx.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Devtools](https://tanstack.com/router/latest/docs/framework/react/devtools.html)

[LLM Assistance Support](https://tanstack.com/router/latest/docs/framework/react/llm-support.html)
