...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchesHook"
...
The useMatches hook returns all of the [RouteMatch](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMatchType.html) objects from the router **regardless of its callers position in the React component tree**.

Tip

If you only want the parent or child matches, then you can use the [useParentMatches](https://tanstack.com/router/latest/docs/framework/react/api/router/useParentMatchesHook.html) or the [useChildMatches](https://tanstack.com/router/latest/docs/framework/react/api/router/useChildMatchesHook.html) based on the selection you need.

[## useMatches options](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchesHook.html#usematches-options)

The useMatches hook accepts a single *optional* argument, an options object.

[### opts.select option](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchesHook.html#optsselect-option)
...
[### opts.structuralSharing option](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchesHook.html#optsstructuralsharing-option)
...
[## useMatches returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchesHook.html#usematches-returns)

* If a select function is provided, the return value of the select function.
* If no select function is provided, an array of [RouteMatch](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMatchType.html) objects.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchesHook.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useMatchesHook.md)
