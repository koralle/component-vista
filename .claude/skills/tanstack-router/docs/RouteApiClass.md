---
title: "RouteApi class | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiClass"
...
Please use the [getRouteApi](https://tanstack.com/router/latest/docs/framework/react/api/router/getRouteApiFunction.html) function instead.
...
[## Constructor options](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiClass.html#constructor-options)

The RouteApi constructor accepts a single argument: the options that will be used to configure the RouteApi instance.

[### opts.routeId option](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiClass.html#optsrouteid-option)

* Type: string
* Required
* The route ID to which the RouteApi instance will be bound

[## Constructor returns](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiClass.html#constructor-returns)

* An instance of the [RouteApi](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiType.html) that is pre-bound to the route ID that it was called with.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiClass.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/RouteApiClass.md)
