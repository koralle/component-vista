...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType"
...
[## Router properties and methods](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#router-properties-and-methods)

An instance of the Router has the following properties and methods:

[### .update method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#update-method)

* Type: (newOptions: RouterOptions) => void
* Updates the router instance with new options.

[### state property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#state-property)

* Type: [RouterState](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterStateType.html)
* The current state of the router.

> ⚠️⚠️⚠️ **router.state is always up to date, but NOT REACTIVE. If you use router.state in a component, the component will not re-render when the router state changes. To get a reactive version of the router state, use the [useRouterState](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouterStateHook.html) hook.**

[### .subscribe method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#subscribe-method)

* Type: (eventType: TType, fn: ListenerFn<RouterEvents[TType]>) => (event: RouterEvent) => void
* Subscribes to a [RouterEvent](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterEventsType.html).
* Returns a function that can be used to unsubscribe from the event.
* The callback provided to the returned function will be called with the event that was emitted.

[### .matchRoutes method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#matchroutes-method)
...
[### .cancelMatch method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#cancelmatch-method)

* Type: (matchId: string) => void
* Cancels a route match that is currently pending by calling match.abortController.abort().

[### .cancelMatches method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#cancelmatches-method)

* Type: () => void
* Cancels all route matches that are currently pending by calling match.abortController.abort() on each one.

[### .buildLocation method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#buildlocation-method)
...
[### .commitLocation method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#commitlocation-method)
...
* Properties
  + location
    - Type: [ParsedLocation](https://tanstack.com/router/latest/docs/framework/react/api/router/ParsedLocationType.html)
    - Required
...
[### .navigate method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#navigate-method)
...
[### .invalidate method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#invalidate-method)
...
[### .clearCache method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#clearcache-method)
...
[### .load method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#load-method)
...
[### .preloadRoute method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#preloadroute-method)
...
[### .loadRouteChunk method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#loadroutechunk-method)

Loads the JS chunk of the route.

* Type: (route: AnyRoute) => Promise<void>

[### .matchRoute method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#matchroute-method)
...
[### .dehydrate method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#dehydrate-method)
...
[### .hydrate method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterType.html#hydrate-method)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/RouterType.md)
