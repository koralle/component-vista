---
title: "NavigateOptions type | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/NavigateOptionsType"
...
[## NavigateOptions properties](https://tanstack.com/router/latest/docs/framework/react/api/router/NavigateOptionsType.html#navigateoptions-properties)

The NavigateOptions object accepts the following properties:

[### replace](https://tanstack.com/router/latest/docs/framework/react/api/router/NavigateOptionsType.html#replace)
...
[### resetScroll](https://tanstack.com/router/latest/docs/framework/react/api/router/NavigateOptionsType.html#resetscroll)
...
[### hashScrollIntoView](https://tanstack.com/router/latest/docs/framework/react/api/router/NavigateOptionsType.html#hashscrollintoview)
...
[### ignoreBlocker](https://tanstack.com/router/latest/docs/framework/react/api/router/NavigateOptionsType.html#ignoreblocker)
...
[### reloadDocument](https://tanstack.com/router/latest/docs/framework/react/api/router/NavigateOptionsType.html#reloaddocument)
...
[### href](https://tanstack.com/router/latest/docs/framework/react/api/router/NavigateOptionsType.html#href)

* Type: string
* Optional
* This can be used instead of to to navigate to a fully built href, e.g. pointing to an external target.
* [ToOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/ToOptionsType.html)

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/NavigateOptionsType.md)
