...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/creating-a-router"
...
[## The Router Class](https://tanstack.com/router/latest/docs/framework/react/guide/creating-a-router.html#the-router-class)
...
[## Route Tree](https://tanstack.com/router/latest/docs/framework/react/guide/creating-a-router.html#route-tree)
...
Whether you used [file-based routing](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html) or [code-based routing](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html), you'll need to pass your route tree to the createRouter function:

[### Filesystem Route Tree](https://tanstack.com/router/latest/docs/framework/react/guide/creating-a-router.html#filesystem-route-tree)
...
[### Code-Based Route Tree](https://tanstack.com/router/latest/docs/framework/react/guide/creating-a-router.html#code-based-route-tree)
...
[## Router Type Safety](https://tanstack.com/router/latest/docs/framework/react/guide/creating-a-router.html#router-type-safety)
...
[## 404 Not Found Route](https://tanstack.com/router/latest/docs/framework/react/guide/creating-a-router.html#404-not-found-route)
...
[## Other Options](https://tanstack.com/router/latest/docs/framework/react/guide/creating-a-router.html#other-options)

There are many other options that can be passed to the Router constructor. You can find a full list of them in the [API Reference](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterOptionsType.html).

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/creating-a-router.md)
