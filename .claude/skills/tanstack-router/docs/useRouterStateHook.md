...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useRouterStateHook"
...
If you want to access the current location or the current matches, you should try out the [useLocation](https://tanstack.com/router/latest/docs/framework/react/api/router/useLocationHook.html) and [useMatches](https://tanstack.com/router/latest/docs/framework/react/api/router/useMatchesHook.html) hooks first. These hooks are designed to be more ergonomic and easier to use than accessing the router state directly.

[## useRouterState options](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouterStateHook.html#userouterstate-options)

The useRouterState hook accepts an optional options object.

[### opts.select option](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouterStateHook.html#optsselect-option)

* Type: (state: RouterState) => TSelected
* Optional
* If supplied, this function will be called with the [RouterState](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterStateType.html) object and the return value will be returned from useRouterState.

[### opts.structuralSharing option](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouterStateHook.html#optsstructuralsharing-option)
...
[## useRouterState returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouterStateHook.html#userouterstate-returns)

* The current [RouterState](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterStateType.html) object or TSelected if a select function is provided.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useRouterStateHook.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useRouterStateHook.md)
