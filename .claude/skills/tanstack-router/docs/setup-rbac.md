---
title: "How to Set Up Role-Based Access Control | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac"
...
[## Quick Start](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#quick-start)
...
[## Extend Authentication Context](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#extend-authentication-context)
[### 1. Add Roles to User Type](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#1-add-roles-to-user-type)
...
[### 2. Update Router Context Types](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#2-update-router-context-types)

Update src/routes/\_\_root.tsx:
...
[## Create Role-Protected Routes](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#create-role-protected-routes)
[### 1. Admin-Only Routes](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#1-admin-only-routes)
...
[### 2. Multiple Role Access](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#2-multiple-role-access)
...
[### 3. Permission-Based Routes](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#3-permission-based-routes)
...
[## Create Specific Protected Pages](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#create-specific-protected-pages)
[### 1. Admin Dashboard](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#1-admin-dashboard)
...
[### 2. User Management Page](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#2-user-management-page)
...
[## Create Unauthorized Page](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#create-unauthorized-page)
...
[## Component-Level Permission Checks](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#component-level-permission-checks)
[### 1. Conditional Rendering Hook](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#1-conditional-rendering-hook)
...
[### 2. Permission Guard Component](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#2-permission-guard-component)
...
[### 3. Using Permission Guards](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#3-using-permission-guards)
...
[## Advanced Permission Patterns](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#advanced-permission-patterns)
[### 1. Resource-Based Permissions](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#1-resource-based-permissions)
...
[### 2. Time-Based Permissions](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#2-time-based-permissions)
...
[## Common Problems](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#common-problems)
[### Role/Permission Data Not Loading](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#rolepermission-data-not-loading)
...
[### Permission Checks Too Restrictive](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#permission-checks-too-restrictive)
...
[### Performance Issues with Many Permission Checks](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#performance-issues-with-many-permission-checks)
...
[## Common Next Steps](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#common-next-steps)

After setting up RBAC, you might want to:

* [How to Set Up Basic Authentication](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html) - Core auth implementation
* [How to Integrate Authentication Providers](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html) - Use external auth services

[## Related Resources](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-rbac.html#related-resources)

* [Authenticated Routes Guide](https://tanstack.com/router/latest/docs/framework/react/guide/authenticated-routes.html) - Core authentication concepts
* [Router Context Guide](https://tanstack.com/router/latest/docs/framework/react/guide/router-context.html) - Understanding router context
* [RBAC Best Practices](https://auth0.com/docs/manage-users/access-control/rbac) - General RBAC principles

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/how-to/setup-rbac.md)
