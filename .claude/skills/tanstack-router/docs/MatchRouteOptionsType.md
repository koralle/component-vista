---
title: "MatchRouteOptions type | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/MatchRouteOptionsType"
...
[## MatchRouteOptions properties](https://tanstack.com/router/latest/docs/framework/react/api/router/MatchRouteOptionsType.html#matchrouteoptions-properties)

The MatchRouteOptions type has the following properties:

[### pending property](https://tanstack.com/router/latest/docs/framework/react/api/router/MatchRouteOptionsType.html#pending-property)

* Type: boolean
* Optional
* If true, will match against pending location instead of the current location

[### ~~caseSensitive~~ property (deprecated)](https://tanstack.com/router/latest/docs/framework/react/api/router/MatchRouteOptionsType.html#casesensitive-property-deprecated)
...
[### includeSearch property](https://tanstack.com/router/latest/docs/framework/react/api/router/MatchRouteOptionsType.html#includesearch-property)

* Type: boolean
* Optional
* If true, will match against the current location's search params using a deep inclusive check. e.g. { a: 1 } will match for a current location of { a: 1, b: 2 }

[### fuzzy property](https://tanstack.com/router/latest/docs/framework/react/api/router/MatchRouteOptionsType.html#fuzzy-property)

* Type: boolean
* Optional
* If true, will match against the current location using a fuzzy match. e.g. /posts will match for a current location of /posts/123

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/MatchRouteOptionsType.md)
