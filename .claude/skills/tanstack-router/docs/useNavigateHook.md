...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useNavigateHook"
...
[## useNavigate options](https://tanstack.com/router/latest/docs/framework/react/api/router/useNavigateHook.html#usenavigate-options)

The useNavigate hook accepts a single argument, an options object.

[### opts.from option](https://tanstack.com/router/latest/docs/framework/react/api/router/useNavigateHook.html#optsfrom-option)
...
[## useNavigate returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useNavigateHook.html#usenavigate-returns)

* A navigate function that can be used to navigate to a new location.

[## navigate function](https://tanstack.com/router/latest/docs/framework/react/api/router/useNavigateHook.html#navigate-function)

The navigate function is a function that can be used to navigate to a new location.

[### navigate function options](https://tanstack.com/router/latest/docs/framework/react/api/router/useNavigateHook.html#navigate-function-options)

The navigate function accepts a single argument, an options object.

* Type: [NavigateOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/NavigateOptionsType.html)

[### navigate function returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useNavigateHook.html#navigate-function-returns)

* A Promise that resolves when the navigation is complete

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useNavigateHook.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useNavigateHook.md)
