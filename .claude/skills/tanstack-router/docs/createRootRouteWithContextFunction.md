...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteWithContextFunction"
...
[## createRootRouteWithContext generics](https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteWithContextFunction.html#createrootroutewithcontext-generics)

The createRootRouteWithContext function accepts a single generic argument:

[### TRouterContext generic](https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteWithContextFunction.html#troutercontext-generic)

* Type: TRouterContext
* Optional, **but recommended**.
* The context type that will be required to be fulfilled when the router is created

[## createRootRouteWithContext returns](https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteWithContextFunction.html#createrootroutewithcontext-returns)
...
[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteWithContextFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/createRootRouteWithContextFunction.md)
