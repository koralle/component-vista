---
title: "rootRouteWithContext function | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/rootRouteWithContextFunction"
...
Please use the [createRootRouteWithContext](https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteWithContextFunction.html) function instead.
...
[## rootRouteWithContext generics](https://tanstack.com/router/latest/docs/framework/react/api/router/rootRouteWithContextFunction.html#rootroutewithcontext-generics)

The rootRouteWithContext function accepts a single generic argument:

[### TRouterContext generic](https://tanstack.com/router/latest/docs/framework/react/api/router/rootRouteWithContextFunction.html#troutercontext-generic)

* Type: TRouterContext
* Optional, **but recommended**.
* The context type that will be required to be fulfilled when the router is created

[## rootRouteWithContext returns](https://tanstack.com/router/latest/docs/framework/react/api/router/rootRouteWithContextFunction.html#rootroutewithcontext-returns)

* A factory function that can be used to create a new [createRootRoute](https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteFunction.html) instance.
* It accepts a single argument, the same as the [createRootRoute](https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteFunction.html) function.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/rootRouteWithContextFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/rootRouteWithContextFunction.md)
