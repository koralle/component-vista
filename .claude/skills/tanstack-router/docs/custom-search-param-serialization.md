---
title: "Custom Search Param Serialization | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/custom-search-param-serialization"
...
[## Using Base64](https://tanstack.com/router/latest/docs/framework/react/guide/custom-search-param-serialization.html#using-base64)
...
> [⚠️ Why does this snippet not use atob/btoa?](https://tanstack.com/router/latest/docs/framework/react/guide/custom-search-param-serialization.html#safe-binary-encodingdecoding)
...
[## Using the query-string library](https://tanstack.com/router/latest/docs/framework/react/guide/custom-search-param-serialization.html#using-the-query-string-library)
...
[## Using the JSURL2 library](https://tanstack.com/router/latest/docs/framework/react/guide/custom-search-param-serialization.html#using-the-jsurl2-library)
...
[## Using the Zipson library](https://tanstack.com/router/latest/docs/framework/react/guide/custom-search-param-serialization.html#using-the-zipson-library)
...
[### Safe Binary Encoding/Decoding](https://tanstack.com/router/latest/docs/framework/react/guide/custom-search-param-serialization.html#safe-binary-encodingdecoding)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/custom-search-param-serialization.md)
