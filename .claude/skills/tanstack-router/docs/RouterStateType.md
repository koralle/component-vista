...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/RouterStateType"
...
[## RouterState properties](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterStateType.html#routerstate-properties)

The RouterState type contains all of the properties that are available on the router state.

[### status property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterStateType.html#status-property)
...
[### isLoading property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterStateType.html#isloading-property)

* Type: boolean
* true if the router is currently loading a route or waiting for a route to finish loading.

[### isTransitioning property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterStateType.html#istransitioning-property)

* Type: boolean
* true if the router is currently transitioning to a new route.

[### matches property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterStateType.html#matches-property)

* Type: [Array<RouteMatch>](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMatchType.html)
* An array of all of the route matches that have been resolved and are currently active.

[### pendingMatches property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterStateType.html#pendingmatches-property)

* Type: [Array<RouteMatch>](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMatchType.html)
* An array of all of the route matches that are currently pending.

[### location property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterStateType.html#location-property)
...
[### resolvedLocation property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouterStateType.html#resolvedlocation-property)

* Type: [ParsedLocation](https://tanstack.com/router/latest/docs/framework/react/api/router/ParsedLocationType.html)
* The location that the router has resolved and loaded.

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/RouterStateType.md)
