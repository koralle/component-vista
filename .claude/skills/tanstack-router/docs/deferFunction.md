...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/deferFunction"
...
The defer function wraps a promise with a deferred state object that can be used to inspect the promise's state. This deferred promise can then be passed to the [useAwaited](https://tanstack.com/router/latest/docs/framework/react/api/router/useAwaitedHook.html) hook or the [<Await>](https://tanstack.com/router/latest/docs/framework/react/api/router/awaitComponent.html) component for suspending until the promise is resolved or rejected.

The defer function accepts a single argument, the promise to wrap with a deferred state object.

[## defer options](https://tanstack.com/router/latest/docs/framework/react/api/router/deferFunction.html#defer-options)

* Type: Promise<T>
* Required
* The promise to wrap with a deferred state object.

[## defer returns](https://tanstack.com/router/latest/docs/framework/react/api/router/deferFunction.html#defer-returns)

* A promise that can be passed to the [useAwaited](https://tanstack.com/router/latest/docs/framework/react/api/router/useAwaitedHook.html) hook or the [<Await>](https://tanstack.com/router/latest/docs/framework/react/api/router/awaitComponent.html) component.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/deferFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/deferFunction.md)
