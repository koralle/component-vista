...
source_url: "https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts"
...
[## Anatomy of a Route](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#anatomy-of-a-route)

All other routes, other than the [Root Route](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#the-root-route), are configured using the createFileRoute function, which provides type safety when using file-based routing:
...
[## The Root Route](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#the-root-route)
...
[## Basic Routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#basic-routes)
...
[## Index Routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#index-routes)
...
[## Dynamic Route Segments](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#dynamic-route-segments)
...
[## Splat / Catch-All Routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#splat--catch-all-routes)
...
[## Optional Path Parameters](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#optional-path-parameters)
...
[## Layout Routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#layout-routes)
...
Like [Layout Routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#layout-routes), Pathless Layout Routes are used to wrap child routes with additional components and logic. However, pathless layout routes do not require a matching path in the URL and are used to wrap child routes with additional components and logic without requiring a matching path in the URL.
...
However, unlike Layout Routes, since Pathless Layout Routes do match based on URL path segments, this means that these routes do not support [Dynamic Route Segments](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#dynamic-route-segments) as part of their path and therefore cannot be matched in the URL.
...
[## Non-Nested Routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#non-nested-routes)
...
* The posts\_.$postId.edit.tsx route **does not share** the same posts prefix as the other routes and therefore will be treated as if it is a top-level route and will render <PostEditor>.
...
[## Excluding Files and Folders from Routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#excluding-files-and-folders-from-routes)
...
[## Pathless Route Group Directories](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#pathless-route-group-directories)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/routing/routing-concepts.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Migrate from React Location](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html)

[Route Trees](https://tanstack.com/router/latest/docs/framework/react/routing/route-trees.html)
