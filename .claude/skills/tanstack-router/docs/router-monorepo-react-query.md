---
title: "React TanStack Router Router Monorepo React Query Example | TanStack Router Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/examples/router-monorepo-react-query"
...
# React Example: Router Monorepo React Query [Deploy to Cloudflare](https://deploy.workers.cloudflare.com/?url=https://github.com/tanstack/router/tree/main/examples/react/router-monorepo-react-query)[Deploy with Netlify](https://app.netlify.com/start/deploy?repository=https://github.com/tanstack/router&create_from_path=examples/react/router-monorepo-react-query) [Github](https://github.com/tanstack/router/tree/main/examples/react/router-monorepo-react-query) [StackBlitz](https://stackblitz.com/github/tanstack/router/tree/main/examples/react/router-monorepo-react-query?embed=1&theme=dark&preset=node&file=src/routes/__root.tsx)
