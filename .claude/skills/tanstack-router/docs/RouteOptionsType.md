...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType"
...
[## RouteOptions properties](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#routeoptions-properties)

The RouteOptions type accepts an object with the following properties:

[### getParentRoute method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#getparentroute-method)
...
[### path property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#path-property)
...
[### id property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#id-property)
...
[### component property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#component-property)

* Type: RouteComponent or LazyRouteComponent
* Optional - Defaults to <Outlet />
* The content to be rendered when the route is matched.

[### errorComponent property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#errorcomponent-property)

* Type: RouteComponent or LazyRouteComponent
* Optional - Defaults to routerOptions.defaultErrorComponent
* The content to be rendered when the route encounters an error.

[### pendingComponent property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#pendingcomponent-property)
...
[### notFoundComponent property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#notfoundcomponent-property)
...
[### validateSearch method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#validatesearch-method)
...
[### search.middlewares property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#searchmiddlewares-property)
...
[### parseParams method (⚠️ deprecated, use params.parse instead)](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#parseparams-method-️-deprecated-use-paramsparse-instead)
...
[### stringifyParams method (⚠️ deprecated, use params.stringify instead)](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#stringifyparams-method-️-deprecated-use-paramsstringify-instead)
...
[### params.parse method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#paramsparse-method)

* Type: (rawParams: Record<string, string>) => TParams
* Optional
* A function that will be called when this route is matched and passed the raw params from the current location and return valid parsed params. If this function throws, the route will be put into an error state and the error will be thrown during render. If this function does not throw, its return value will be used as the route's params and the return type will be inferred into the rest of the router.

[### params.stringify method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#paramsstringify-method)

* Type: (params: TParams) => Record<string, string>
* A function that will be called when this route's parsed params are being used to build a location. This function should return a valid object of Record<string, string> mapping.

[### beforeLoad method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#beforeload-method)
...
* Optional
* [ParsedLocation](https://tanstack.com/router/latest/docs/framework/react/api/router/ParsedLocationType.html)
...
> 🚧 opts.navigate has been deprecated and will be removed in the next major release. Use throw redirect({ to: '/somewhere' }) instead. Read more about the redirect function [here](https://tanstack.com/router/latest/docs/framework/react/api/router/redirectFunction.html).

[### loader method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#loader-method)
...
[### loaderDeps method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#loaderdeps-method)
...
[### staleTime property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#staletime-property)
...
[### preloadStaleTime property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#preloadstaletime-property)

* Type: number
* Optional
* Defaults to routerOptions.defaultPreloadStaleTime, which defaults to 30\_000 ms (30 seconds)
...
[### gcTime property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#gctime-property)
...
[### shouldReload property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#shouldreload-property)
...
[### caseSensitive property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#casesensitive-property)

* Type: boolean
* Optional
* If true, this route will be matched as case-sensitive.

[### wrapInSuspense property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#wrapinsuspense-property)
...
[### pendingMs property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#pendingms-property)
...
[### pendingMinMs property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#pendingminms-property)
...
[### preloadMaxAge property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#preloadmaxage-property)
...
[### preSearchFilters property (⚠️ deprecated, use search.middlewares instead)](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#presearchfilters-property-️-deprecated-use-searchmiddlewares-instead)
...
[### postSearchFilters property (⚠️ deprecated, use search.middlewares instead)](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#postsearchfilters-property-️-deprecated-use-searchmiddlewares-instead)
...
[### onError property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#onerror-property)

* Type: (error: any) => void
* Optional
* A function that will be called when an error is thrown during a navigation or preload event.
* If this function throws a [redirect](https://tanstack.com/router/latest/docs/framework/react/api/router/redirectFunction.html), then the router will process and apply the redirect immediately.

[### onEnter property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#onenter-property)
...
[### onStay property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#onstay-property)

* Type: (match: RouteMatch) => void
* Optional
* A function that will be called when a route is matched and loaded after being matched in the previous location.

[### onLeave property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#onleave-property)

* Type: (match: RouteMatch) => void
* Optional
* A function that will be called when a route is no longer matched after being matched in the previous location.

[### onCatch property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#oncatch-property)
...
[### remountDeps method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#remountdeps-method)
...
[### headers method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#headers-method)
...
[### head method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#head-method)
...
[### scripts method](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#scripts-method)
...
[### codeSplitGroupings property](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html#codesplitgroupings-property)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/RouteOptionsType.md)
