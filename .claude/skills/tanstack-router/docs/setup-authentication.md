---
title: "How to Set Up Basic Authentication and Protected Routes | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication"
...
[## Quick Start](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#quick-start)
...
[## Create Authentication Context](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#create-authentication-context)
...
[## Configure Router Context](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#configure-router-context)
[### 1. Set Up Router Context](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#1-set-up-router-context)
...
[### 2. Configure Router](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#2-configure-router)
...
[### 3. Connect App with Authentication](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#3-connect-app-with-authentication)
...
[## Create Protected Routes](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#create-protected-routes)
[### 1. Create Authentication Layout Route](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#1-create-authentication-layout-route)
...
[### 2. Create Login Route](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#2-create-login-route)
...
[### 3. Create Protected Dashboard](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#3-create-protected-dashboard)
...
[## Add Authentication Persistence](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#add-authentication-persistence)
...
[## Production Checklist](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#production-checklist)
...
[## Common Problems](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#common-problems)
[### Authentication Context Not Available](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#authentication-context-not-available)
...
[### User Logged Out on Page Refresh](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#user-logged-out-on-page-refresh)
...
[### Protected Route Flashing Before Redirect](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#protected-route-flashing-before-redirect)
...
[## Common Next Steps](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#common-next-steps)

After setting up basic authentication, you might want to:

* [How to Integrate Authentication Providers](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-auth-providers.html) - Use Auth0, Clerk, or Supabase
...
[## Related Resources](https://tanstack.com/router/latest/docs/framework/react/how-to/setup-authentication.html#related-resources)

* [Authenticated Routes Guide](https://tanstack.com/router/latest/docs/framework/react/guide/authenticated-routes.html) - Detailed conceptual guide
* [Router Context Guide](https://tanstack.com/router/latest/docs/framework/react/guide/router-context.html) - Understanding context in TanStack Router
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/how-to/setup-authentication.md)
