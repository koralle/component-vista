...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMatchType"
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/RouteMatchType.md)
