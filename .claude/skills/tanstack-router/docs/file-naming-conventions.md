...
source_url: "https://tanstack.com/router/latest/docs/framework/react/routing/file-naming-conventions"
...
File-based routing requires that you follow a few simple file naming conventions to ensure that your routes are generated correctly. The concepts these conventions enable are covered in detail in the [Route Trees & Nesting](https://tanstack.com/router/latest/docs/framework/react/routing/route-trees.html) guide.
...
| **index Token** | Route segments ending with the index token (before any file extensions) will match the parent route when the URL pathname matches the parent route exactly. This can be configured via the indexToken configuration option, see [options](https://tanstack.com/router/latest/docs/api/file-based-routing.html#indextoken). |
| **.route.tsx File Type** | When using directories to organise routes, the route suffix can be used to create a route file at the directory's path. For example, blog.post.route.tsx or blog/post/route.tsx can be used as the route file for the /blog/post route. This can be configured via the routeToken configuration option, see [options](https://tanstack.com/router/latest/docs/api/file-based-routing.html#routetoken). |

> **💡 Remember:** The file-naming conventions for your project could be affected by what [options](https://tanstack.com/router/latest/docs/api/file-based-routing.html) are configured.

Note

To escape a trailing underscore, for example /posts[\_].tsx, usage of the upgraded [Non-Nested Routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#non-nested-routes) is required.

[## Dynamic Path Params](https://tanstack.com/router/latest/docs/framework/react/routing/file-naming-conventions.html#dynamic-path-params)
...
We'll learn more about dynamic path params in the [Path Params](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html) guide.

[## Pathless Routes](https://tanstack.com/router/latest/docs/framework/react/routing/file-naming-conventions.html#pathless-routes)
...
To learn more about pathless routes, see the [Routing Concepts - Pathless Routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#pathless-layout-routes) guide.

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/routing/file-naming-conventions.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Code-Based Routing](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html)

[Code Splitting](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html)
