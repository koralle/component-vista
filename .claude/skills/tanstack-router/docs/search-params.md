...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/search-params"
...
[## Why not just use URLSearchParams?](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#why-not-just-use-urlsearchparams)
...
[## Search Params, the "OG" State Manager](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#search-params-the-og-state-manager)
...
[## JSON-first Search Params](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#json-first-search-params)
...
[## Validating and Typing Search Params](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#validating-and-typing-search-params)
...
[### Enter Validation + TypeScript!](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#enter-validation--typescript)
...
[### Validating Search Params](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#validating-search-params)
...
[#### Adapters](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#adapters)
...
[### Zod](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#zod)
...
[### Valibot](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#valibot)
...
[### Arktype](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#arktype)
...
[### Effect/Schema](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#effectschema)
...
[## Reading Search Params](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#reading-search-params)
...
[### Using Search Params in Loaders](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#using-search-params-in-loaders)

Please read the [Search Params in Loaders](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#using-loaderdeps-to-access-search-params) section for more information about how to read search params in loaders with the loaderDeps option.

[### Search Params are inherited from Parent Routes](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#search-params-are-inherited-from-parent-routes)
...
[### Search Params in Components](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#search-params-in-components)
...
If your component is code-split, you can use the [getRouteApi function](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#manually-accessing-route-apis-in-other-files-with-the-getrouteapi-helper) to avoid having to import the Route configuration to get access to the typed useSearch() hook.

[### Search Params outside of Route Components](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#search-params-outside-of-route-components)
...
[## Writing Search Params](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#writing-search-params)
...
[### <Link search />](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#link-search-)
...
[### useNavigate(), navigate({ search })](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#usenavigate-navigate-search-)
...
[### router.navigate({ search })](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#routernavigate-search-)

The router.navigate function works exactly the same way as the useNavigate/navigate hook/function above.

[### <Navigate search />](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#navigate-search-)
...
[## Transforming search with search middlewares](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html#transforming-search-with-search-middlewares)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/search-params.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Path Params](https://tanstack.com/router/latest/docs/framework/react/guide/path-params.html)

[Link Options](https://tanstack.com/router/latest/docs/framework/react/guide/link-options.html)
