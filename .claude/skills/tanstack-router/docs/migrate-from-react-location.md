...
source_url: "https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location"
...
Before you begin your journey in migrating from React Location, it's important that you have a good understanding of the [Routing Concepts](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html) and [Design Decisions](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html) used by TanStack Router.

[## Differences between React Location and TanStack Router](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#differences-between-react-location-and-tanstack-router)
...
* Route configuration in React Location is done using a single array of route definitions, while in TanStack Router, route configuration is done using a tree of route definitions starting with the [root route](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#the-root-route).
* [File-based routing](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html) is the recommended way to define routes in TanStack Router, while React Location only allows you to define routes in a single file using a code-based approach.
  + TanStack Router does support a [code-based approach](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html) to defining routes, but it is not recommended for most use cases. You can read more about why, over here: [why is file-based routing the preferred way to define routes?](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html#why-is-file-based-routing-the-preferred-way-to-define-routes)

[## Migration guide](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#migration-guide)
...
To use a code-based approach for defining your routes, you can read the [code-based Routing](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing.html) guide.

[### Step 1: Swap over to TanStack Router's dependencies](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#step-1-swap-over-to-tanstack-routers-dependencies)

First, we need to install the dependencies for TanStack Router. For detailed installation instructions, see our [How to Install TanStack Router](https://tanstack.com/router/latest/docs/framework/react/how-to/install.html) guide.
...
[### Step 2: Use the file-based routing watcher](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#step-2-use-the-file-based-routing-watcher)
...
However, if your application does not use Vite, you use one of our other [supported bundlers](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html#getting-started-with-file-based-routing), or you can use the @tanstack/router-cli package to watch for changes in your routes files and automatically update the routes configuration.

[### Step 3: Add the file-based configuration file to your project](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#step-3-add-the-file-based-configuration-file-to-your-project)
...
You can find the full list of options for the tsr.config.json file [here](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing.html).

[### Step 4: Create the routes directory](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#step-4-create-the-routes-directory)
...
[### Step 5: Create the root route file](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#step-5-create-the-root-route-file)
...
[### Step 6: Create the index route file](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#step-6-create-the-index-route-file)
...
[### Step 7: Create the posts route file](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#step-7-create-the-posts-route-file)
...
[### Step 8: Create the posts index route file](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#step-8-create-the-posts-index-route-file)
...
[### Step 9: Create the posts id route file](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#step-9-create-the-posts-id-route-file)
...
[### Step 10: Generate the route tree](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#step-10-generate-the-route-tree)
...
[### Step 11: Update the main entry file to render the Router](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#step-11-update-the-main-entry-file-to-render-the-router)
...
[### Finished!](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-location.html#finished)
...
* [Search params](https://tanstack.com/router/latest/docs/framework/react/guide/search-params.html)
* [Data loading](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html)
* [History types](https://tanstack.com/router/latest/docs/framework/react/guide/history-types.html)
* [Wildcard / Splat / Catch-all routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#splat--catch-all-routes)
* [Authenticated routes](https://tanstack.com/router/latest/docs/framework/react/guide/authenticated-routes.html)

TanStack Router also has a few more features that you might want to explore:

* [Router Context](https://tanstack.com/router/latest/docs/framework/react/guide/router-context.html)
* [Preloading](https://tanstack.com/router/latest/docs/framework/react/guide/preloading.html)
* [Pathless Layout Routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html#pathless-layout-routes)
* [Route masking](https://tanstack.com/router/latest/docs/framework/react/guide/route-masking.html)
* [SSR](https://tanstack.com/router/latest/docs/framework/react/guide/ssr.html)
* ... and more!

If you are facing any issues or have any questions, feel free to ask for help in the TanStack Discord.

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/installation/migrate-from-react-location.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Migrate from React Router](https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-router.html)

[Routing Concepts](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts.html)
