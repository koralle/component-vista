...
source_url: "https://tanstack.com/router/latest/docs/framework/react/overview"
...
[## "A Fork in the Route"](https://tanstack.com/router/latest/docs.html#a-fork-in-the-route)
...
[## Why TanStack Router?](https://tanstack.com/router/latest/docs.html#why-tanstack-router)
...
[## 100% Inferred TypeScript Support](https://tanstack.com/router/latest/docs.html#100-inferred-typescript-support)
...
[## 1st Class Search Parameters](https://tanstack.com/router/latest/docs.html#1st-class-search-parameters)
...
[## Built-In Caching and Friendly Data Loading](https://tanstack.com/router/latest/docs.html#built-in-caching-and-friendly-data-loading)
...
[### Built-in Cache](https://tanstack.com/router/latest/docs.html#built-in-cache)
...
[### Flexible & Powerful Data Lifecycle APIs](https://tanstack.com/router/latest/docs.html#flexible--powerful-data-lifecycle-apis)
...
[## Inherited Route Context](https://tanstack.com/router/latest/docs.html#inherited-route-context)
...
[## File-based and/or Code-Based Routing](https://tanstack.com/router/latest/docs.html#file-based-andor-code-based-routing)
...
[## Acknowledgements](https://tanstack.com/router/latest/docs.html#acknowledgements)
...
[## Let's go!](https://tanstack.com/router/latest/docs.html#lets-go)

Enough overview, there's so much more to do with TanStack Router. Hit that next button and let's get started!

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/overview.md)
