---
title: "ClientOnly Component | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/clientOnlyComponent"
...
[## Props](https://tanstack.com/router/latest/docs/framework/react/api/router/clientOnlyComponent.html#props)

The ClientOnly component accepts the following props:

[### props.fallback prop](https://tanstack.com/router/latest/docs/framework/react/api/router/clientOnlyComponent.html#propsfallback-prop)

The fallback component to render if the JS is not yet loaded in the client.

[### props.children prop](https://tanstack.com/router/latest/docs/framework/react/api/router/clientOnlyComponent.html#propschildren-prop)

The component to render if the JS is loaded in the client.

[## Returns](https://tanstack.com/router/latest/docs/framework/react/api/router/clientOnlyComponent.html#returns)
...
[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/clientOnlyComponent.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/clientOnlyComponent.md)
