...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/redirectFunction"
...
[## redirect options](https://tanstack.com/router/latest/docs/framework/react/api/router/redirectFunction.html#redirect-options)

The redirect function accepts a single argument, the options to determine the redirect behavior.

* Type: [Redirect](https://tanstack.com/router/latest/docs/framework/react/api/router/RedirectType.html)
* Required

[## redirect returns](https://tanstack.com/router/latest/docs/framework/react/api/router/redirectFunction.html#redirect-returns)
...
[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/redirectFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/redirectFunction.md)
