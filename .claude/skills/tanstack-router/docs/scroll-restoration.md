---
title: "React TanStack Router Scroll Restoration Example | TanStack Router Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/examples/scroll-restoration"
...
# React Example: Scroll Restoration [Deploy to Cloudflare](https://deploy.workers.cloudflare.com/?url=https://github.com/tanstack/router/tree/main/examples/react/scroll-restoration)[Deploy with Netlify](https://app.netlify.com/start/deploy?repository=https://github.com/tanstack/router&create_from_path=examples/react/scroll-restoration) [Github](https://github.com/tanstack/router/tree/main/examples/react/scroll-restoration) [StackBlitz](https://stackblitz.com/github/tanstack/router/tree/main/examples/react/scroll-restoration?embed=1&theme=dark&preset=node&file=src/routes/__root.tsx)
