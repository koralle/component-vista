...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/type-safety"
...
[## Route Definitions](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#route-definitions)
[### File-based Routing](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#file-based-routing)
...
[### Code-based Routing](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#code-based-routing)
...
[## Exported Hooks, Components, and Utilities](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#exported-hooks-components-and-utilities)
...
[## Fixing the Component Context Problem](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#fixing-the-component-context-problem)
...
> 🧠 Quick tip: If your component is code-split, you can use the [getRouteApi function](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#manually-accessing-route-apis-in-other-files-with-the-getrouteapi-helper) to avoid having to pass in the Route.fullPath to get access to the typed useParams() and useSearch() hooks.

[### What if I don't know the route? What if it's a shared component?](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#what-if-i-dont-know-the-route-what-if-its-a-shared-component)
...
[### What if I pass the wrong from path?](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#what-if-i-pass-the-wrong-from-path)
...
[### What if I don't know the route, or it's a shared component, and I can't pass from?](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#what-if-i-dont-know-the-route-or-its-a-shared-component-and-i-cant-pass-from)
...
[## Router Context](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#router-context)
...
[## Performance Recommendations](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#performance-recommendations)
...
[### Only infer types you need](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#only-infer-types-you-need)
...
[### Narrow to relevant routes as much as you possibly can](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#narrow-to-relevant-routes-as-much-as-you-possibly-can)
...
[### Consider using the object syntax of addChildren](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#consider-using-the-object-syntax-of-addchildren)
...
[### Avoid internal types without narrowing](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html#avoid-internal-types-without-narrowing)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/type-safety.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Data Mutations](https://tanstack.com/router/latest/docs/framework/react/guide/data-mutations.html)

[Type Utilities](https://tanstack.com/router/latest/docs/framework/react/guide/type-utilities.html)
