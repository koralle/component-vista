---
title: "CatchNotFound Component | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/catchNotFoundComponent"
...
[## CatchNotFound props](https://tanstack.com/router/latest/docs/framework/react/api/router/catchNotFoundComponent.html#catchnotfound-props)

The CatchNotFound component accepts the following props:

[### props.children prop](https://tanstack.com/router/latest/docs/framework/react/api/router/catchNotFoundComponent.html#propschildren-prop)

* Type: React.ReactNode
* Required
* The component's children to render when there is no error

[### props.fallback prop](https://tanstack.com/router/latest/docs/framework/react/api/router/catchNotFoundComponent.html#propsfallback-prop)

* Type: (error: NotFoundError) => React.ReactElement
* Optional
* The component to render when there is an error

[### props.onCatch prop](https://tanstack.com/router/latest/docs/framework/react/api/router/catchNotFoundComponent.html#propsoncatch-prop)

* Type: (error: any) => void
* Optional
* A callback that will be called with the error that was thrown by the component's children

[## CatchNotFound returns](https://tanstack.com/router/latest/docs/framework/react/api/router/catchNotFoundComponent.html#catchnotfound-returns)

* Returns the component's children if there is no error.
* Returns the fallback if there is an error.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/catchNotFoundComponent.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/catchNotFoundComponent.md)
