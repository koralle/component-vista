...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/ToMaskOptionsType"
...
The ToMaskOptions type extends the [ToOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/ToOptionsType.html) type and describes additional options available when using route masks.
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/ToMaskOptionsType.md)
