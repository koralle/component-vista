---
title: "Manual Setup | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/installation/manual"
...
[## Using File-Based Route Generation](https://tanstack.com/router/latest/docs/framework/react/installation/manual.html#using-file-based-route-generation)
[#### Install TanStack Router, Vite Plugin, and the Router Devtools](https://tanstack.com/router/latest/docs/framework/react/installation/manual.html#install-tanstack-router-vite-plugin-and-the-router-devtools)
...
[#### Configure the Vite Plugin](https://tanstack.com/router/latest/docs/framework/react/installation/manual.html#configure-the-vite-plugin)
...
If you are not using Vite, or any of the supported bundlers, you can check out the [TanStack Router CLI](https://tanstack.com/router/latest/docs/framework/react/installation/with-router-cli.html) guide for more info.
...
[#### src/routes/\_\_root.tsx](https://tanstack.com/router/latest/docs/framework/react/installation/manual.html#srcroutes__roottsx)
...
[#### src/routes/index.tsx](https://tanstack.com/router/latest/docs/framework/react/installation/manual.html#srcroutesindextsx)
...
[#### src/routes/about.tsx](https://tanstack.com/router/latest/docs/framework/react/installation/manual.html#srcroutesabouttsx)
...
[#### src/main.tsx](https://tanstack.com/router/latest/docs/framework/react/installation/manual.html#srcmaintsx)
...
[## Using Code-Based Route Configuration](https://tanstack.com/router/latest/docs/framework/react/installation/manual.html#using-code-based-route-configuration)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/installation/manual.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Frequently Asked Questions](https://tanstack.com/router/latest/docs/framework/react/faq.html)

[Vite](https://tanstack.com/router/latest/docs/framework/react/installation/with-vite.html)
