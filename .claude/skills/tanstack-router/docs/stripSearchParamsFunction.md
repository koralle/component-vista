...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/stripSearchParamsFunction"
...
[## stripSearchParams props](https://tanstack.com/router/latest/docs/framework/react/api/router/stripSearchParamsFunction.html#stripsearchparams-props)
...
[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/stripSearchParamsFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/stripSearchParamsFunction.md)
