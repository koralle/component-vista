...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/createRouteMaskFunction"
...
[## createRouteMask options](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouteMaskFunction.html#createroutemask-options)

* Type: [RouteMask](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMaskType.html)
* Required
* The options that will be used to configure the route mask

[## createRouteMask returns](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouteMaskFunction.html#createroutemask-returns)

* A object with the type signature of [RouteMask](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMaskType.html) that can be passed to the RouterOptions.routeMasks option.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/createRouteMaskFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/createRouteMaskFunction.md)
