...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/data-loading"
...
[## The route loading lifecycle](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#the-route-loading-lifecycle)
...
[## To Router Cache or not to Router Cache?](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#to-router-cache-or-not-to-router-cache)
...
If you know right away that you'd like to or need to use something more robust like TanStack Query, skip to the [External Data Loading](https://tanstack.com/router/latest/docs/framework/react/guide/external-data-loading.html) guide.

[## Using the Router Cache](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#using-the-router-cache)

The router cache is built-in and is as easy as returning data from any route's loader function. Let's learn how!

[## Route loaders](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#route-loaders)
...
[## loader Parameters](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#loader-parameters)
...
[## Consuming data from loaders](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#consuming-data-from-loaders)
...
[## Dependency-based Stale-While-Revalidate Caching](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#dependency-based-stale-while-revalidate-caching)
...
[### Key options](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#key-options)
...
[### ⚠️ Some Important Defaults](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#️-some-important-defaults)
...
[### Using loaderDeps to access search params](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#using-loaderdeps-to-access-search-params)
...
[### Using staleTime to control how long data is considered fresh](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#using-staletime-to-control-how-long-data-is-considered-fresh)
...
By passing 10\_000 to the staleTime option, we are telling the router to consider the route's data fresh for 10 seconds. This means that if the user navigates to /posts from /about within 10 seconds of the last loader result, the route's data will not be reloaded. If the user then navigates to /posts from /about after 10 seconds, the route's data will be reloaded **in the background**.

[## Turning off stale-while-revalidate caching](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#turning-off-stale-while-revalidate-caching)
...
[## Using shouldReload and gcTime to opt-out of caching](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#using-shouldreload-and-gctime-to-opt-out-of-caching)
...
[### Opting out of caching while still preloading](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#opting-out-of-caching-while-still-preloading)
...
[## Passing all loader events to an external cache](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#passing-all-loader-events-to-an-external-cache)

We break down this use case in the [External Data Loading](https://tanstack.com/router/latest/docs/framework/react/guide/external-data-loading.html) page, but if you'd like to use an external cache like TanStack Query, you can do so by passing all loader events to your external cache. As long as you are using the defaults, the only change you'll need to make is to set the defaultPreloadStaleTime option on the router to 0:
...
[## Using Router Context](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#using-router-context)
...
[## Using Path Params](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#using-path-params)
...
[## Using Route Context](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#using-route-context)
...
[## Using Search Params in Loaders](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#using-search-params-in-loaders)
...
[### Accessing Search Params via routeOptions.loaderDeps](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#accessing-search-params-via-routeoptionsloaderdeps)
...
[## Using the Abort Signal](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#using-the-abort-signal)
...
[## Using the preload flag](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#using-the-preload-flag)
...
[## Handling Slow Loaders](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#handling-slow-loaders)
...
* Split up your fast and slow data into separate promises and defer the slow data until after the fast data is loaded (see the [Deferred Data Loading](https://tanstack.com/router/latest/docs/framework/react/guide/deferred-data-loading.html) guide).
* Show a pending component after an optimistic suspense threshold until all of the data is ready (See below).

[## Showing a pending component](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#showing-a-pending-component)
...
[## Avoiding Pending Component Flash](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#avoiding-pending-component-flash)
...
[## Handling Errors](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#handling-errors)
...
[### Handling Errors with routeOptions.onError](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#handling-errors-with-routeoptionsonerror)
...
[### Handling Errors with routeOptions.onCatch](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#handling-errors-with-routeoptionsoncatch)
...
[### Handling Errors with routeOptions.errorComponent](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#handling-errors-with-routeoptionserrorcomponent)
...
[### Using the default ErrorComponent](https://tanstack.com/router/latest/docs/framework/react/guide/data-loading.html#using-the-default-errorcomponent)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/data-loading.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Custom Links](https://tanstack.com/router/latest/docs/framework/react/guide/custom-link.html)

[Deferred Data Loading](https://tanstack.com/router/latest/docs/framework/react/guide/deferred-data-loading.html)
