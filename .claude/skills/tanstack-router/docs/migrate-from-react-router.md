...
source_url: "https://tanstack.com/router/latest/docs/framework/react/installation/migrate-from-react-router"
...
* Install Router - npm i @tanstack/react-router (see [detailed installation guide](https://tanstack.com/router/latest/docs/framework/react/how-to/install.html))
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/installation/migrate-from-react-router.md)
