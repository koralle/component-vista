---
title: "React TanStack Router Kitchen Sink File Based Example | TanStack Router Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/examples/kitchen-sink-file-based"
...
# React Example: Kitchen Sink File Based [Deploy to Cloudflare](https://deploy.workers.cloudflare.com/?url=https://github.com/tanstack/router/tree/main/examples/react/kitchen-sink-file-based)[Deploy with Netlify](https://app.netlify.com/start/deploy?repository=https://github.com/tanstack/router&create_from_path=examples/react/kitchen-sink-file-based) [Github](https://github.com/tanstack/router/tree/main/examples/react/kitchen-sink-file-based) [StackBlitz](https://stackblitz.com/github/tanstack/router/tree/main/examples/react/kitchen-sink-file-based?embed=1&theme=dark&preset=node&file=src/routes/__root.tsx)
