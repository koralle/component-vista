...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/getRouteApiFunction"
...
[## getRouteApi options](https://tanstack.com/router/latest/docs/framework/react/api/router/getRouteApiFunction.html#getrouteapi-options)

The getRouteApi function accepts a single argument, a routeId string literal.

[### routeId option](https://tanstack.com/router/latest/docs/framework/react/api/router/getRouteApiFunction.html#routeid-option)

* Type: string
* Required
* The route ID to which the [RouteApi](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiClass.html) instance will be bound

[## getRouteApi returns](https://tanstack.com/router/latest/docs/framework/react/api/router/getRouteApiFunction.html#getrouteapi-returns)

* An instance of the [RouteApi](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteApiType.html) that is pre-bound to the route ID that the getRouteApi function was called with.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/getRouteApiFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/getRouteApiFunction.md)
