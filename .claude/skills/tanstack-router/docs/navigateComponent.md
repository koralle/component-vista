...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/navigateComponent"
...
[## Navigate props](https://tanstack.com/router/latest/docs/framework/react/api/router/navigateComponent.html#navigate-props)

The Navigate component accepts the following props:

[### ...options](https://tanstack.com/router/latest/docs/framework/react/api/router/navigateComponent.html#options)

* Type: [NavigateOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/NavigateOptionsType.html)

[## Navigate returns](https://tanstack.com/router/latest/docs/framework/react/api/router/navigateComponent.html#navigate-returns)

* null

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/navigateComponent.md)
