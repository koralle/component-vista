---
title: "File-Based Routing API Reference | TanStack Router Docs"
source_url: "https://tanstack.com/router/latest/docs/api/file-based-routing"
...
# File-Based Routing API Reference

Copy Markdown

TanStack Router's file-based routing is quite flexible and can be configured to suit your project's needs.

[## Configuration options](https://tanstack.com/router/latest/docs/api/file-based-routing.html#configuration-options)

The following options are available for configuring the file-based routing:

* [routesDirectory (required)](https://tanstack.com/router/latest/docs/api/file-based-routing.html#routesdirectory-required)
* [generatedRouteTree (required)](https://tanstack.com/router/latest/docs/api/file-based-routing.html#generatedroutetree-required)
* [virtualRouteConfig](https://tanstack.com/router/latest/docs/api/file-based-routing.html#virtualrouteconfig)
* [routeFilePrefix](https://tanstack.com/router/latest/docs/api/file-based-routing.html#routefileprefix)
* [routeFileIgnorePrefix](https://tanstack.com/router/latest/docs/api/file-based-routing.html#routefileignoreprefix)
* [routeFileIgnorePattern](https://tanstack.com/router/latest/docs/api/file-based-routing.html#routefileignorepattern)
* [indexToken](https://tanstack.com/router/latest/docs/api/file-based-routing.html#indextoken)
* [routeToken](https://tanstack.com/router/latest/docs/api/file-based-routing.html#routetoken)
* [quoteStyle](https://tanstack.com/router/latest/docs/api/file-based-routing.html#quotestyle)
* [semicolons](https://tanstack.com/router/latest/docs/api/file-based-routing.html#semicolons)
* [autoCodeSplitting](https://tanstack.com/router/latest/docs/api/file-based-routing.html#autocodesplitting)
* [disableTypes](https://tanstack.com/router/latest/docs/api/file-based-routing.html#disabletypes)
* [addExtensions](https://tanstack.com/router/latest/docs/api/file-based-routing.html#addextensions)
* [disableLogging](https://tanstack.com/router/latest/docs/api/file-based-routing.html#disablelogging)
* [routeTreeFileHeader](https://tanstack.com/router/latest/docs/api/file-based-routing.html#routetreefileheader)
* [routeTreeFileFooter](https://tanstack.com/router/latest/docs/api/file-based-routing.html#routetreefilefooter)
* [enableRouteTreeFormatting](https://tanstack.com/router/latest/docs/api/file-based-routing.html#enableroutetreeformatting)
* [tmpDir](https://tanstack.com/router/latest/docs/api/file-based-routing.html#tmpdir)
...
If the [disableTypes](https://tanstack.com/router/latest/docs/api/file-based-routing.html#disabletypes) is set to true, the generated route tree will be saved with the .js extension instead of .ts.
...
If this value is not set, process.env.TSR\_TMP\_DIR will be used.
If process.env.TSR\_TMP\_DIR is not set, it will default to .tanstack/tmp relative to the current working directory.

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/api/file-based-routing.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Render Optimizations](https://tanstack.com/router/latest/docs/framework/react/guide/render-optimizations.html)

[Router](https://tanstack.com/router/latest/docs/framework/react/api/router.html)
