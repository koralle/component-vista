...
source_url: "https://tanstack.com/router/latest/docs/framework/react/devtools"
...
[## Installation](https://tanstack.com/router/latest/docs/framework/react/devtools.html#installation)
...
[## Import the Devtools](https://tanstack.com/router/latest/docs/framework/react/devtools.html#import-the-devtools)
...
[## Using Devtools in production](https://tanstack.com/router/latest/docs/framework/react/devtools.html#using-devtools-in-production)
...
[## Using inside of the RouterProvider](https://tanstack.com/router/latest/docs/framework/react/devtools.html#using-inside-of-the-routerprovider)
...
[## Manually passing the Router Instance](https://tanstack.com/router/latest/docs/framework/react/devtools.html#manually-passing-the-router-instance)
...
[## Floating Mode](https://tanstack.com/router/latest/docs/framework/react/devtools.html#floating-mode)
...
[### Devtools Options](https://tanstack.com/router/latest/docs/framework/react/devtools.html#devtools-options)
...
[## Fixed Mode](https://tanstack.com/router/latest/docs/framework/react/devtools.html#fixed-mode)
...
Click [here](https://tanstack.com/router/latest/docs/framework/react/examples/basic-devtools-panel.html) to see a live example of this in StackBlitz.

[## Embedded Mode](https://tanstack.com/router/latest/docs/framework/react/devtools.html#embedded-mode)
...
[### DevtoolsPanel Options](https://tanstack.com/router/latest/docs/framework/react/devtools.html#devtoolspanel-options)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/devtools.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Quick Start](https://tanstack.com/router/latest/docs/framework/react/quick-start.html)

[Decisions on DX](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx.html)
