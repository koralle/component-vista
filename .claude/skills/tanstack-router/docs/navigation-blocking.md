---
title: "React TanStack Router Navigation Blocking Example | TanStack Router Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/examples/navigation-blocking"
...
# React Example: Navigation Blocking [Deploy to Cloudflare](https://deploy.workers.cloudflare.com/?url=https://github.com/tanstack/router/tree/main/examples/react/navigation-blocking)[Deploy with Netlify](https://app.netlify.com/start/deploy?repository=https://github.com/tanstack/router&create_from_path=examples/react/navigation-blocking) [Github](https://github.com/tanstack/router/tree/main/examples/react/navigation-blocking) [StackBlitz](https://stackblitz.com/github/tanstack/router/tree/main/examples/react/navigation-blocking?embed=1&theme=dark&preset=node&file=src/routes/__root.tsx)
...
[Deferred Data](https://tanstack.com/router/latest/docs/framework/react/examples/deferred-data.html)

[View Transitions](https://tanstack.com/router/latest/docs/framework/react/examples/view-transitions.html)
