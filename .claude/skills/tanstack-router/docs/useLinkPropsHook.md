...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useLinkPropsHook"
...
[## useLinkProps options](https://tanstack.com/router/latest/docs/framework/react/api/router/useLinkPropsHook.html#uselinkprops-options)
...
* [ActiveLinkOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/ActiveLinkOptionsType.html)
* The useLinkProps options are used to build a [LinkProps](https://tanstack.com/router/latest/docs/framework/react/api/router/LinkPropsType.html) object.
* It also extends the React.AnchorHTMLAttributes<HTMLAnchorElement> type, so that any additional props that are passed to the useLinkProps hook will be merged with the [LinkProps](https://tanstack.com/router/latest/docs/framework/react/api/router/LinkPropsType.html) object.

[## useLinkProps returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useLinkPropsHook.html#uselinkprops-returns)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useLinkPropsHook.md)
