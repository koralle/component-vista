---
title: "Ensure correct order of inference sensitive properties for createRoute functions | TanStack Router Docs"
source_url: "https://tanstack.com/router/latest/docs/eslint/create-route-property-order"
...
[## Rule Details](https://tanstack.com/router/latest/docs/eslint/create-route-property-order.html#rule-details)
...
[## Attributes](https://tanstack.com/router/latest/docs/eslint/create-route-property-order.html#attributes)

* ✅ Recommended
* 🔧 Fixable

[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/eslint/create-route-property-order.md)
