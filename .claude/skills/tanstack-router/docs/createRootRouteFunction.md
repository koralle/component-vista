...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteFunction"
...
[## createRootRoute options](https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteFunction.html#createrootroute-options)
...
[## createRootRoute returns](https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteFunction.html#createrootroute-returns)

A new [Route](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html) instance.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/createRootRouteFunction.md)
