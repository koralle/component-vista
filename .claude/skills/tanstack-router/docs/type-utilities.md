...
source_url: "https://tanstack.com/router/latest/docs/framework/react/guide/type-utilities"
...
[## Type checking Link options with ValidateLinkOptions](https://tanstack.com/router/latest/docs/framework/react/guide/type-utilities.html#type-checking-link-options-with-validatelinkoptions)
...
[## Type checking an array of Link options with ValidateLinkOptionsArray](https://tanstack.com/router/latest/docs/framework/react/guide/type-utilities.html#type-checking-an-array-of-link-options-with-validatelinkoptionsarray)
...
[## Type checking redirect options with ValidateRedirectOptions](https://tanstack.com/router/latest/docs/framework/react/guide/type-utilities.html#type-checking-redirect-options-with-validateredirectoptions)
...
[## Type checking navigate options with ValidateNavigateOptions](https://tanstack.com/router/latest/docs/framework/react/guide/type-utilities.html#type-checking-navigate-options-with-validatenavigateoptions)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/guide/type-utilities.md)

[Learn about TanStack Ads](https://tanstack.com/ads)[Hide Ads](https://tanstack.com/ads#hide-ads)

[Type Safety](https://tanstack.com/router/latest/docs/framework/react/guide/type-safety.html)
