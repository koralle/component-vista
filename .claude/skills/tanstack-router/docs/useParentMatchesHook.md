...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useParentMatchesHook"
...
The useParentMatches hook returns all of the parent [RouteMatch](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteMatchType.html) objects from the root down to the immediate parent of the current match in context. **It does not include the current match, which can be obtained using the useMatch hook.**
...
[## useParentMatches options](https://tanstack.com/router/latest/docs/framework/react/api/router/useParentMatchesHook.html#useparentmatches-options)

The useParentMatches hook accepts an optional options object.

[### opts.select option](https://tanstack.com/router/latest/docs/framework/react/api/router/useParentMatchesHook.html#optsselect-option)
...
[### opts.structuralSharing option](https://tanstack.com/router/latest/docs/framework/react/api/router/useParentMatchesHook.html#optsstructuralsharing-option)
...
[## useParentMatches returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useParentMatchesHook.html#useparentmatches-returns)
...
[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useParentMatchesHook.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useParentMatchesHook.md)
