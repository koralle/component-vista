...
source_url: "https://tanstack.com/router/latest/docs/framework/react/comparison"
...
|  | TanStack Router / Start | React Router DOM [*(Website)*](https://github.com/remix-run/react-router) | Next.JS [*(Website)*](https://nextjs.org/docs/routing/introduction) |
| --- | --- | --- | --- |
| Github Repo / Stars |  |  |  |
| Bundle Size |  |  | ❓ |
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/comparison.md)
