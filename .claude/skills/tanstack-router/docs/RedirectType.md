...
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/RedirectType"
...
* [NavigateOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/NavigateOptionsType.html)

[## Redirect properties](https://tanstack.com/router/latest/docs/framework/react/api/router/RedirectType.html#redirect-properties)

The Redirect object accepts/contains the following properties:

[### statusCode property](https://tanstack.com/router/latest/docs/framework/react/api/router/RedirectType.html#statuscode-property)

* Type: number
* Optional
* The HTTP status code to use when redirecting

[### throw property](https://tanstack.com/router/latest/docs/framework/react/api/router/RedirectType.html#throw-property)

* Type: any
* Optional
* If provided, will throw the redirect object instead of returning it. This can be useful in places where throwing in a function might cause it to have a return type of never. In that case, you can use redirect({ throw: true }) to throw the redirect object instead of returning it.

[### headers property](https://tanstack.com/router/latest/docs/framework/react/api/router/RedirectType.html#headers-property)

* Type: HeadersInit
* Optional
* The HTTP headers to use when redirecting.

[### Navigation Properties](https://tanstack.com/router/latest/docs/framework/react/api/router/RedirectType.html#navigation-properties)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/RedirectType.md)
