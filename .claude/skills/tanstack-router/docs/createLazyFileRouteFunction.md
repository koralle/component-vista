---
title: "createLazyFileRoute function | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/createLazyFileRouteFunction"
...
The createLazyFileRoute function is used for creating a partial file-based route route instance that is lazily loaded when matched. This route instance can only be used to configure the [non-critical properties](https://tanstack.com/router/latest/docs/framework/react/guide/code-splitting.html#how-does-tanstack-router-split-code) of the route, such as component, pendingComponent, errorComponent, and the notFoundComponent.

[## createLazyFileRoute options](https://tanstack.com/router/latest/docs/framework/react/api/router/createLazyFileRouteFunction.html#createlazyfileroute-options)
...
[### path](https://tanstack.com/router/latest/docs/framework/react/api/router/createLazyFileRouteFunction.html#path)
...
[### createLazyFileRoute returns](https://tanstack.com/router/latest/docs/framework/react/api/router/createLazyFileRouteFunction.html#createlazyfileroute-returns)

A new function that accepts a single argument of partial of the type [RouteOptions](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteOptionsType.html) that will be used to configure the file [Route](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html) instance.
...
[### Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/createLazyFileRouteFunction.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/createLazyFileRouteFunction.md)
