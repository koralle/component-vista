---
title: "RootRoute class | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/RootRouteClass"
...
Please use the [createRootRoute](https://tanstack.com/router/latest/docs/framework/react/api/router/createRootRouteFunction.html) function instead.
...
[## RootRoute constructor](https://tanstack.com/router/latest/docs/framework/react/api/router/RootRouteClass.html#rootroute-constructor)

The RootRoute constructor accepts an object as its only argument.

[### Constructor options](https://tanstack.com/router/latest/docs/framework/react/api/router/RootRouteClass.html#constructor-options)
...
[## Constructor returns](https://tanstack.com/router/latest/docs/framework/react/api/router/RootRouteClass.html#constructor-returns)

A new [Route](https://tanstack.com/router/latest/docs/framework/react/api/router/RouteType.html) instance.

[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/RootRouteClass.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/RootRouteClass.md)
