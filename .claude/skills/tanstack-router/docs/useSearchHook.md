---
title: "useSearch hook | TanStack Router React Docs"
source_url: "https://tanstack.com/router/latest/docs/framework/react/api/router/useSearchHook"
...
[## useSearch options](https://tanstack.com/router/latest/docs/framework/react/api/router/useSearchHook.html#usesearch-options)

The useSearch hook accepts an options object.

[### opts.from option](https://tanstack.com/router/latest/docs/framework/react/api/router/useSearchHook.html#optsfrom-option)

* Type: string
* Required
* The RouteID to match the search query parameters from.

[### opts.shouldThrow option](https://tanstack.com/router/latest/docs/framework/react/api/router/useSearchHook.html#optsshouldthrow-option)
...
[### opts.select option](https://tanstack.com/router/latest/docs/framework/react/api/router/useSearchHook.html#optsselect-option)
...
[### opts.structuralSharing option](https://tanstack.com/router/latest/docs/framework/react/api/router/useSearchHook.html#optsstructuralsharing-option)
...
[### opts.strict option](https://tanstack.com/router/latest/docs/framework/react/api/router/useSearchHook.html#optsstrict-option)
...
[## useSearch returns](https://tanstack.com/router/latest/docs/framework/react/api/router/useSearchHook.html#usesearch-returns)
...
[## Examples](https://tanstack.com/router/latest/docs/framework/react/api/router/useSearchHook.html#examples)
...
[Edit on GitHub](https://github.com/tanstack/router/edit/main/docs/router/framework/react/api/router/useSearchHook.md)
